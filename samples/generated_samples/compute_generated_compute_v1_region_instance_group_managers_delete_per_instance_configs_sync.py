...
# [START compute_generated_compute_v1_RegionInstanceGroupManagers_DeletePerInstanceConfigs_sync]
...
# [END compute_generated_compute_v1_RegionInstanceGroupManagers_DeletePerInstanceConfigs_sync]
