...
# [START compute_generated_compute_v1_RegionInstanceGroupManagers_UpdatePerInstanceConfigs_sync]
...
# [END compute_generated_compute_v1_RegionInstanceGroupManagers_UpdatePerInstanceConfigs_sync]
