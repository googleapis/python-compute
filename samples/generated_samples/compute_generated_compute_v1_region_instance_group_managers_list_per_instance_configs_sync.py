...
# [START compute_generated_compute_v1_RegionInstanceGroupManagers_ListPerInstanceConfigs_sync]
...
# [END compute_generated_compute_v1_RegionInstanceGroupManagers_ListPerInstanceConfigs_sync]
