...
from google.cloud.compute_v1.services.target_instances.transports.base import (
...
@pytest.mark.parametrize("client_class", [TargetInstancesClient,])
def test_target_instances_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_target_instances_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
def test_aggregated_list_rest(
    transport: str = "rest", request_type=compute.AggregatedListTargetInstancesRequest
):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.TargetInstanceAggregatedList(
            id="id_value",
            items={
                "key_value": compute.TargetInstancesScopedList(
                    target_instances=[
    ...
    assert response.items == {
        "key_value": compute.TargetInstancesScopedList(
            target_instances=[
                compute.TargetInstance(creation_timestamp="creation_timestamp_value")
            ]
        )
    }
...
def test_aggregated_list_rest_flattened():
    client = TargetInstancesClient(credentials=ga_credentials.AnonymousCredentials(),)
...
def test_aggregated_list_rest_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.aggregated_list(
            compute.AggregatedListTargetInstancesRequest(), project="project_value",
        )
...
def test_aggregated_list_pager():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.TargetInstanceAggregatedList(items={}, next_page_token="def",),
            compute.TargetInstanceAggregatedList(
                items={"g": compute.TargetInstancesScopedList(),},
                next_page_token="ghi",
            ),
            compute.TargetInstanceAggregatedList(
                items={
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert "target_instance_value" in http_call[1] + str(body)
...
def test_get_rest(
    transport: str = "rest", request_type=compute.GetTargetInstanceRequest
):
    client = TargetInstancesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.insert(
            project="project_value",
            zone="zone_value",
            target_instance_resource=target_instance_resource,
        )
        ...
        assert "project_value" in http_call[1] + str(body)
        assert "zone_value" in http_call[1] + str(body)
        assert compute.TargetInstance.to_json(
...
def test_list_rest(
    transport: str = "rest", request_type=compute.ListTargetInstancesRequest
):
    client = TargetInstancesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_list_pager():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.TargetInstanceList(items=[], next_page_token="def",),
            compute.TargetInstanceList(
                items=[compute.TargetInstance(),], next_page_token="ghi",
            ),
            compute.TargetInstanceList(
...
def test_target_instances_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.target_instances.transports.TargetInstancesTransport.__init__"
    ) as Transport:
...
def test_target_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.target_instances.transports.TargetInstancesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
