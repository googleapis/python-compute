...
from google.cloud.compute_v1.services.target_instances.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.target_instances.transports.base import _GOOGLE_AUTH_VERSION
...
def test_target_instances_client_from_service_account_info(client_class):
...
def test_target_instances_client_from_service_account_file(client_class):
    creds = credentials.AnonymousCredentials()
...
def test_target_instances_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListTargetInstancesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetInstanceAggregatedList(
            id='id_value',
            items={'key_value': compute.TargetInstancesScopedList(target_instances=[compute.TargetInstance(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.TargetInstancesScopedList(target_instances=[compute.TargetInstance(creation_timestamp='creation_timestamp_value')])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',zone='zone_value',target_instance='target_instance_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',zone='zone_value',target_instance_resource=target_instance_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert compute.TargetInstance.to_json(target_instance_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListTargetInstancesRequest):
    client = TargetInstancesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetInstanceList(
            id='id_value',
            items=[compute.TargetInstance(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.TargetInstance(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_target_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_instances.transports.TargetInstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_instances_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_instances.transports.TargetInstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_target_instances_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.target_instances.transports.TargetInstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.TargetInstancesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_target_instances_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        TargetInstancesClient()
...
def test_target_instances_host_no_port():
    client = TargetInstancesClient(
        credentials=credentials.AnonymousCredentials(),
...
def test_target_instances_host_with_port():
    client = TargetInstancesClient(
        credentials=credentials.AnonymousCredentials(),
