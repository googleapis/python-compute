...
def test_aggregated_list_rest(request_type, transport: str = "rest"):
    ...
    request = compute.AggregatedListTargetInstancesRequest({"project": "sample1"})
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/targetInstances"
...
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteTargetInstanceRequest(
        {"project": "sample1", "zone": "sample2", "target_instance": "sample3"}
    )
...
def test_delete_unary_rest_required_fields(
    ...
    # verify fields with default values are dropped
    assert "project" not in jsonified_request
    assert "targetInstance" not in jsonified_request
    ...
    assert jsonified_request["targetInstance"] == request_init["target_instance"]
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/targetInstances/{target_instance}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/targetInstances"
            % client.transport._host,
            args[1],
        )
