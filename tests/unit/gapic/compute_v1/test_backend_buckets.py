...
from google.cloud.compute_v1.services.backend_buckets.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.backend_buckets.transports.base import _GOOGLE_AUTH_VERSION
...
def test_backend_buckets_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_add_signed_url_key_rest(transport: str = 'rest', request_type=compute.AddSignedUrlKeyBackendBucketRequest):
...
project='project_value',backend_bucket='backend_bucket_value',signed_url_key_resource=signed_url_key_resource,        )
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_signed_url_key_rest(transport: str = 'rest', request_type=compute.DeleteSignedUrlKeyBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',backend_bucket='backend_bucket_value',key_name='key_name_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetBackendBucketRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.BackendBucket(
            ...
            cdn_policy=compute.BackendBucketCdnPolicy(cache_mode=compute.BackendBucketCdnPolicy.CacheMode.CACHE_ALL_STATIC),
            creation_timestamp='creation_timestamp_value',
    ...
    assert response.cdn_policy == compute.BackendBucketCdnPolicy(cache_mode=compute.BackendBucketCdnPolicy.CacheMode.CACHE_ALL_STATIC)
    assert response.creation_timestamp == 'creation_timestamp_value'
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',backend_bucket_resource=backend_bucket_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.BackendBucket.to_json(backend_bucket_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        backend_bucket_resource = compute.BackendBucket(bucket_name='bucket_name_value')
        client.patch(
project='project_value',backend_bucket='backend_bucket_value',backend_bucket_resource=backend_bucket_resource,        )
...
def test_update_rest(transport: str = 'rest', request_type=compute.UpdateBackendBucketRequest):
    client = BackendBucketsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_backend_buckets_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.backend_buckets.transports.BackendBucketsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_backend_buckets_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.backend_buckets.transports.BackendBucketsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.BackendBucketsTransport()
        adc.assert_called_once()
