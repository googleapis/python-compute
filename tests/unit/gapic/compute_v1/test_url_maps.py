...
def test_aggregated_list_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/urlMaps"
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteUrlMapRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("project", "")("url_map", "")]
            actual_params = req.call_args.kwargs["params"]
            assert expected_params == actual_params
...
def test_delete_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/urlMaps/{url_map}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest(
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["url_map_resource"] = compute.UrlMap(
        creation_timestamp="creation_timestamp_value"
    )
    request = request_type(request_init)
...
def test_insert_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/urlMaps"
            % client.transport._host,
            args[1],
        )
...
def test_invalidate_cache_unary_rest(
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "url_map": "sample2"}
    request_init["cache_invalidation_rule_resource"] = compute.CacheInvalidationRule(
        host="host_value"
    )
    request = request_type(request_init)
...
def test_invalidate_cache_unary_rest_required_fields(
    ...
    unset_fields = transport_class._invalidate_cache_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_invalidate_cache_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/urlMaps/{url_map}/invalidateCache"
            % client.transport._host,
            args[1],
        )
...
def test_validate_rest(
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "url_map": "sample2"}
    request_init["url_maps_validate_request_resource"] = compute.UrlMapsValidateRequest(
...
def test_validate_rest_required_fields(request_type=compute.ValidateUrlMapRequest):
    ...
    unset_fields = transport_class._validate_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_validate_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/urlMaps/{url_map}/validate"
            % client.transport._host,
            args[1],
        )
