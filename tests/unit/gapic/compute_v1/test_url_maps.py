...
from google.cloud.compute_v1.services.url_maps.transports.base import _GOOGLE_AUTH_VERSION
...
def test_url_maps_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListUrlMapsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.UrlMapsAggregatedList(
            id='id_value',
            items={'key_value': compute.UrlMapsScopedList(url_maps=[compute.UrlMap(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.UrlMapsScopedList(url_maps=[compute.UrlMap(creation_timestamp='creation_timestamp_value')])}
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',url_map='url_map_value',        )
...
def test_invalidate_cache_rest(transport: str = 'rest', request_type=compute.InvalidateCacheUrlMapRequest):
    client = UrlMapsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',url_map='url_map_value',cache_invalidation_rule_resource=cache_invalidation_rule_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'url_map_value'
 in http_call[1] + str(body)
        assert compute.CacheInvalidationRule.to_json(cache_invalidation_rule_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        url_map_resource = compute.UrlMap(creation_timestamp='creation_timestamp_value')
        client.patch(
project='project_value',url_map='url_map_value',url_map_resource=url_map_resource,        )
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.validate(
project='project_value',url_map='url_map_value',url_maps_validate_request_resource=url_maps_validate_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'url_map_value'
 in http_call[1] + str(body)
        assert compute.UrlMapsValidateRequest.to_json(url_maps_validate_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_url_maps_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.UrlMapsTransport()
        adc.assert_called_once()
