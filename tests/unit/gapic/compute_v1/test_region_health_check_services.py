...
from google.cloud.compute_v1.services.region_health_check_services.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_health_check_services.transports.base import _GOOGLE_AUTH_VERSION
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.delete(
project='project_value',region='region_value',health_check_service='health_check_service_value',        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert 'health_check_service_value'
 in http_call[1] + str(body)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',health_check_service_resource=health_check_service_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert compute.HealthCheckService.to_json(health_check_service_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionHealthCheckServicesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.HealthCheckServicesList(
            id='id_value',
            items=[compute.HealthCheckService(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.HealthCheckService(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        health_check_service_resource = compute.HealthCheckService(creation_timestamp='creation_timestamp_value')
        client.patch(
project='project_value',region='region_value',health_check_service='health_check_service_value',health_check_service_resource=health_check_service_resource,        )
...
def test_region_health_check_services_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_health_check_services.transports.RegionHealthCheckServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_health_check_services_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_health_check_services.transports.RegionHealthCheckServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_region_health_check_services_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_health_check_services.transports.RegionHealthCheckServicesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionHealthCheckServicesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_region_health_check_services_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        RegionHealthCheckServicesClient()
