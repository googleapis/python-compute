...
def test_delete_unary_rest_required_fields(
    ...
    assert (
        jsonified_request["healthCheckService"] == request_init["health_check_service"]
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [
                ("health_check_service", "")("project", "")("region", "")
            ]
...
def test_delete_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/healthCheckServices/{health_check_service}"
...
def test_insert_unary_rest(
    ...
    request_init["health_check_service_resource"] = compute.HealthCheckService(
        creation_timestamp="creation_timestamp_value"
    )
    request = request_type(request_init)
...
def test_insert_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/healthCheckServices"
            % client.transport._host,
            args[1],
        )
