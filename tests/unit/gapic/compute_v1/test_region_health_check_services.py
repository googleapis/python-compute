...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pb_message = compute.DeleteRegionHealthCheckServiceRequest.pb(
            compute.DeleteRegionHealthCheckServiceRequest()
        )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.GetRegionHealthCheckServiceRequest.pb(
            compute.GetRegionHealthCheckServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_insert_rest(request_type):
    ...
    request_init["health_check_service_resource"] = {
        ...
        "network_endpoint_groups": [
            "network_endpoint_groups_value1",
            "network_endpoint_groups_value2",
        ],
        "notification_endpoints": [
            "notification_endpoints_value1",
            "notification_endpoints_value2",
        ],
        "region": "region_value",
        "self_link": "self_link_value",
    }
    ...
    test_field = compute.InsertRegionHealthCheckServiceRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["health_check_service_resource"][field])
                ):
                    del request_init["health_check_service_resource"][field][i][
                        subfield
                    ]
            else:
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.InsertRegionHealthCheckServiceRequest.pb(
            compute.InsertRegionHealthCheckServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.ListRegionHealthCheckServicesRequest.pb(
            compute.ListRegionHealthCheckServicesRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_patch_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchRegionHealthCheckServiceRequest.meta.fields[
        "health_check_service_resource"
    ]
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.PatchRegionHealthCheckServiceRequest.pb(
            compute.PatchRegionHealthCheckServiceRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_region_health_check_services_client_transport_session_collision(
    transport_name,
):
