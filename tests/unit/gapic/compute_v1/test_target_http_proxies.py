...
from google.cloud.compute_v1.services.target_http_proxies.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.target_http_proxies.transports.base import _GOOGLE_AUTH_VERSION
...
def test_target_http_proxies_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListTargetHttpProxiesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetHttpProxyAggregatedList(
            id='id_value',
            items={'key_value': compute.TargetHttpProxiesScopedList(target_http_proxies=[compute.TargetHttpProxy(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.TargetHttpProxiesScopedList(target_http_proxies=[compute.TargetHttpProxy(creation_timestamp='creation_timestamp_value')])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',target_http_proxy='target_http_proxy_value',        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert 'target_http_proxy_value'
 in http_call[1] + str(body)
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',target_http_proxy_resource=target_http_proxy_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.TargetHttpProxy.to_json(target_http_proxy_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListTargetHttpProxiesRequest):
    client = TargetHttpProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetHttpProxyList(
            id='id_value',
            items=[compute.TargetHttpProxy(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.TargetHttpProxy(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
...
def test_list_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.TargetHttpProxy)
                   for i in results)
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        target_http_proxy_resource = compute.TargetHttpProxy(creation_timestamp='creation_timestamp_value')
        client.patch(
project='project_value',target_http_proxy='target_http_proxy_value',target_http_proxy_resource=target_http_proxy_resource,        )
...
def test_set_url_map_rest(transport: str = 'rest', request_type=compute.SetUrlMapTargetHttpProxyRequest):
    client = TargetHttpProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_url_map(
project='project_value',target_http_proxy='target_http_proxy_value',url_map_reference_resource=url_map_reference_resource,        )
...
def test_target_http_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_http_proxies.transports.TargetHttpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_http_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.target_http_proxies.transports.TargetHttpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.TargetHttpProxiesTransport()
        adc.assert_called_once()
