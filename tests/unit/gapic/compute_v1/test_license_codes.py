...
from google.cloud.compute_v1.services.license_codes.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.license_codes.transports.base import _GOOGLE_AUTH_VERSION
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetLicenseCodeRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.LicenseCode(
            ...
            id='id_value',
            kind='kind_value',
            license_alias=[compute.LicenseCodeLicenseAlias(description='description_value')],
            name='name_value',
    ...
    assert response.license_alias == [compute.LicenseCodeLicenseAlias(description='description_value')]
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.get(
project='project_value',license_code='license_code_value',        )
...
def test_license_codes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.license_codes.transports.LicenseCodesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_license_codes_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.license_codes.transports.LicenseCodesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_license_codes_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.license_codes.transports.LicenseCodesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.LicenseCodesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_license_codes_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        LicenseCodesClient()
