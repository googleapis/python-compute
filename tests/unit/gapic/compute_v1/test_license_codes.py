...
from google.cloud.compute_v1.services.license_codes import (
    LicenseCodesClient,
    transports,
)
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        LicenseCodesClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        LicenseCodesClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        LicenseCodesClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        LicenseCodesClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
def test_license_codes_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_get_rest_interceptors(null_interceptor):
    transport = transports.LicenseCodesRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.LicenseCodesRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        transports.LicenseCodesRestInterceptor, "post_get"
    ) as post, mock.patch.object(
        transports.LicenseCodesRestInterceptor, "pre_get"
    ) as pre:
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/licenseCodes/{license_code}"
...
def test_test_iam_permissions_rest(request_type):
    ...
    test_field = compute.TestIamPermissionsLicenseCodeRequest.meta.fields[
...
def test_test_iam_permissions_rest_required_fields(
    request_type=compute.TestIamPermissionsLicenseCodeRequest,
):
    transport_class = transports.LicenseCodesRestTransport
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.LicenseCodesRestInterceptor, "post_test_iam_permissions"
    ) as post, mock.patch.object(
        transports.LicenseCodesRestInterceptor, "pre_test_iam_permissions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.TestIamPermissionsLicenseCodeRequest.pb(
            compute.TestIamPermissionsLicenseCodeRequest()
        )
        transcode.return_value = {
            "method": "post",
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/global/licenseCodes/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
...
def test_license_codes_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.license_codes.transports.LicenseCodesTransport.__init__"
    ) as Transport:
...
def test_license_codes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.license_codes.transports.LicenseCodesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_license_codes_client_transport_session_collision(transport_name):
    ...
    client1 = LicenseCodesClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = LicenseCodesClient(
        credentials=creds2,
        transport=transport_name,
    )
