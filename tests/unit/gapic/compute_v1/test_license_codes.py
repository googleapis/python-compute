...
from google.cloud.compute_v1.services.license_codes.transports.base import (
...
@pytest.mark.parametrize("client_class", [LicenseCodesClient,])
def test_license_codes_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_license_codes_client_service_account_always_use_jwt_true(
...
def test_get_rest_flattened():
    client = LicenseCodesClient(credentials=ga_credentials.AnonymousCredentials(),)
