...
from google.cloud.compute_v1.services.forwarding_rules.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.forwarding_rules.transports.base import _GOOGLE_AUTH_VERSION
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListForwardingRulesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ForwardingRuleAggregatedList(
            id='id_value',
            items={'key_value': compute.ForwardingRulesScopedList(forwarding_rules=[compute.ForwardingRule(all_ports=True)])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.ForwardingRulesScopedList(forwarding_rules=[compute.ForwardingRule(all_ports=True)])}
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',region='region_value',forwarding_rule='forwarding_rule_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetForwardingRuleRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ForwardingRule(
            ...
            metadata_filters=[compute.MetadataFilter(filter_labels=[compute.MetadataFilterLabelMatch(name='name_value')])],
            name='name_value',
    ...
    assert response.metadata_filters == [compute.MetadataFilter(filter_labels=[compute.MetadataFilterLabelMatch(name='name_value')])]
    assert response.name == 'name_value'
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',forwarding_rule_resource=forwarding_rule_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert compute.ForwardingRule.to_json(forwarding_rule_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        forwarding_rule_resource = compute.ForwardingRule(all_ports=True)
        client.patch(
project='project_value',region='region_value',forwarding_rule='forwarding_rule_value',forwarding_rule_resource=forwarding_rule_resource,        )
...
def test_set_target_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_target(
project='project_value',region='region_value',forwarding_rule='forwarding_rule_value',target_reference_resource=target_reference_resource,        )
...
def test_forwarding_rules_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.forwarding_rules.transports.ForwardingRulesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_forwarding_rules_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.forwarding_rules.transports.ForwardingRulesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_forwarding_rules_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.forwarding_rules.transports.ForwardingRulesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ForwardingRulesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_forwarding_rules_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        ForwardingRulesClient()
