...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/nodeTypes"
...
def test_get_rest(request_type, transport: str = "rest"):
    ...
    request = compute.GetNodeTypeRequest(
        {"project": "sample1", "zone": "sample2", "node_type": "sample3"}
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/nodeTypes/{node_type}"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/nodeTypes"
            % client.transport._host,
            args[1],
        )
