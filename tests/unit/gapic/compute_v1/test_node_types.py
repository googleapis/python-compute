...
from google.cloud.compute_v1.services.node_types.transports.base import (
...
@pytest.mark.parametrize("client_class", [NodeTypesClient,])
def test_node_types_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_node_types_client_service_account_always_use_jwt_true(
...
def test_aggregated_list_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.NodeTypeAggregatedList(
            id="id_value",
            items={
                "key_value": compute.NodeTypesScopedList(
...
def test_aggregated_list_rest_flattened():
    client = NodeTypesClient(credentials=ga_credentials.AnonymousCredentials(),)
