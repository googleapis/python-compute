...
from google.cloud.compute_v1.services.region_operations.transports.base import (
...
@pytest.mark.parametrize("client_class", [RegionOperationsClient,])
def test_region_operations_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_region_operations_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
def test_delete_rest_flattened():
    client = RegionOperationsClient(credentials=ga_credentials.AnonymousCredentials(),)
