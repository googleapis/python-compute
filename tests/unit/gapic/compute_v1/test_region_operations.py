...
def test_delete_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteRegionOperationRequest(
        {"project": "sample1", "region": "sample2", "operation": "sample3"}
    )
...
def test_delete_rest_required_fields(request_type=compute.DeleteRegionOperationRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response_value = Response()
            response_value.status_code = 200
            json_return_value = compute.DeleteRegionOperationResponse.to_json(
                return_value
            )
            response_value._content = json_return_value.encode("UTF-8")
            req.return_value = response_value
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/operations/{operation}"
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/operations"
            % client.transport._host,
            args[1],
        )
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/operations/{operation}/wait"
            % client.transport._host,
            args[1],
        )
