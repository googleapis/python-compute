...
from google.cloud.compute_v1.services.target_ssl_proxies.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.target_ssl_proxies.transports.base import _GOOGLE_AUTH_VERSION
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (TargetSslProxiesClient, transports.TargetSslProxiesRestTransport, "rest", "true"),
    (TargetSslProxiesClient, transports.TargetSslProxiesRestTransport, "rest", "false"),
])
@mock.patch.object(TargetSslProxiesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TargetSslProxiesClient))
...
def test_target_ssl_proxies_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteTargetSslProxyRequest):
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        target_ssl_proxy_resource = compute.TargetSslProxy(creation_timestamp='creation_timestamp_value')
        client.insert(
project='project_value',target_ssl_proxy_resource=target_ssl_proxy_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.TargetSslProxy.to_json(target_ssl_proxy_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListTargetSslProxiesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetSslProxyList(
            id='id_value',
            items=[compute.TargetSslProxy(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.TargetSslProxy(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
...
def test_set_backend_service_rest(transport: str = 'rest', request_type=compute.SetBackendServiceTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        target_ssl_proxies_set_backend_service_request_resource = compute.TargetSslProxiesSetBackendServiceRequest(service='service_value')
        client.set_backend_service(
project='project_value',target_ssl_proxy='target_ssl_proxy_value',target_ssl_proxies_set_backend_service_request_resource=target_ssl_proxies_set_backend_service_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_ssl_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetSslProxiesSetBackendServiceRequest.to_json(target_ssl_proxies_set_backend_service_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_proxy_header_rest(transport: str = 'rest', request_type=compute.SetProxyHeaderTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',target_ssl_proxy='target_ssl_proxy_value',target_ssl_proxies_set_proxy_header_request_resource=target_ssl_proxies_set_proxy_header_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_ssl_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetSslProxiesSetProxyHeaderRequest.to_json(target_ssl_proxies_set_proxy_header_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_ssl_certificates_rest(transport: str = 'rest', request_type=compute.SetSslCertificatesTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        target_ssl_proxies_set_ssl_certificates_request_resource = compute.TargetSslProxiesSetSslCertificatesRequest(ssl_certificates=['ssl_certificates_value'])
        client.set_ssl_certificates(
project='project_value',target_ssl_proxy='target_ssl_proxy_value',target_ssl_proxies_set_ssl_certificates_request_resource=target_ssl_proxies_set_ssl_certificates_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_ssl_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetSslProxiesSetSslCertificatesRequest.to_json(target_ssl_proxies_set_ssl_certificates_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_ssl_policy_rest(transport: str = 'rest', request_type=compute.SetSslPolicyTargetSslProxyRequest):
    client = TargetSslProxiesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',target_ssl_proxy='target_ssl_proxy_value',ssl_policy_reference_resource=ssl_policy_reference_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_ssl_proxy_value'
 in http_call[1] + str(body)
        assert compute.SslPolicyReference.to_json(ssl_policy_reference_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_target_ssl_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_ssl_proxies.transports.TargetSslProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_ssl_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.target_ssl_proxies.transports.TargetSslProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.TargetSslProxiesTransport()
        adc.assert_called_once()
