...
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        pb_return_value = compute.PublicDelegatedPrefixAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = compute.PublicDelegatedPrefixAggregatedList.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = compute.PublicDelegatedPrefixAggregatedList.to_json(
