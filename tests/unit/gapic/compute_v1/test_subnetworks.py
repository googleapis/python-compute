...
def test_delete_unary_rest_required_fields(
    ...
    assert jsonified_request["subnetwork"] == request_init["subnetwork"]
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("project", "")("region", "")("subnetwork", "")]
            actual_params = req.call_args.kwargs["params"]
            assert expected_params == actual_params
...
def test_expand_ip_cidr_range_unary_rest_required_fields(
    ...
    unset_fields = transport_class._expand_ip_cidr_range_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_usable_rest_required_fields(
    ...
    unset_fields = transport_class._list_usable_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_private_ip_google_access_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_private_ip_google_access_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
