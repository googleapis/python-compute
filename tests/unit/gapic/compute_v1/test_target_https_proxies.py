...
def test_delete_unary_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("project", "")("target_https_proxy", "")]
            actual_params = req.call_args.kwargs["params"]
            assert expected_params == actual_params
...
def test_insert_unary_rest(
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1"}
    request_init["target_https_proxy_resource"] = compute.TargetHttpsProxy(
        authorization_policy="authorization_policy_value"
    )
    request = request_type(request_init)
...
def test_set_quic_override_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_quic_override_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_ssl_certificates_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_ssl_certificates_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_ssl_policy_unary_rest(
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_https_proxy": "sample2"}
    request_init["ssl_policy_reference_resource"] = compute.SslPolicyReference(
        ssl_policy="ssl_policy_value"
    )
    request = request_type(request_init)
...
def test_set_ssl_policy_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_ssl_policy_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_url_map_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_url_map_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
