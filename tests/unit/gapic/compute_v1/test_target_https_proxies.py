...
from google.cloud.compute_v1.services.target_https_proxies.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.target_https_proxies.transports.base import _GOOGLE_AUTH_VERSION
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListTargetHttpsProxiesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetHttpsProxyAggregatedList(
            id='id_value',
            items={'key_value': compute.TargetHttpsProxiesScopedList(target_https_proxies=[compute.TargetHttpsProxy(authorization_policy='authorization_policy_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.TargetHttpsProxiesScopedList(target_https_proxies=[compute.TargetHttpsProxy(authorization_policy='authorization_policy_value')])}
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',target_https_proxy_resource=target_https_proxy_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.TargetHttpsProxy.to_json(target_https_proxy_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListTargetHttpsProxiesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetHttpsProxyList(
            id='id_value',
            items=[compute.TargetHttpsProxy(authorization_policy='authorization_policy_value')],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.TargetHttpsProxy(authorization_policy='authorization_policy_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
project='project_value',target_https_proxy='target_https_proxy_value',target_https_proxies_set_quic_override_request_resource=target_https_proxies_set_quic_override_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_https_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetHttpsProxiesSetQuicOverrideRequest.to_json(target_https_proxies_set_quic_override_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',target_https_proxy='target_https_proxy_value',target_https_proxies_set_ssl_certificates_request_resource=target_https_proxies_set_ssl_certificates_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_https_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetHttpsProxiesSetSslCertificatesRequest.to_json(target_https_proxies_set_ssl_certificates_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',target_https_proxy='target_https_proxy_value',ssl_policy_reference_resource=ssl_policy_reference_resource,        )
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_url_map(
project='project_value',target_https_proxy='target_https_proxy_value',url_map_reference_resource=url_map_reference_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_https_proxy_value'
 in http_call[1] + str(body)
        assert compute.UrlMapReference.to_json(url_map_reference_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_target_https_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_https_proxies.transports.TargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_https_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.target_https_proxies.transports.TargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.TargetHttpsProxiesTransport()
        adc.assert_called_once()
