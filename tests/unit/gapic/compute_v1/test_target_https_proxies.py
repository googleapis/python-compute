...
@pytest.mark.parametrize(
    "request_type", [compute.AggregatedListTargetHttpsProxiesRequest, dict,]
)
def test_aggregated_list_rest(request_type, transport: str = "rest"):
    ...
    request = compute.AggregatedListTargetHttpsProxiesRequest({"project": "sample1"})
...
def test_aggregated_list_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response_value = Response()
            response_value.status_code = 200
            json_return_value = compute.TargetHttpsProxyAggregatedList.to_json(
                return_value
            )
            response_value._content = json_return_value.encode("UTF-8")
            req.return_value = response_value
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/targetHttpsProxies"
...
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteTargetHttpsProxyRequest(
        {"project": "sample1", "target_https_proxy": "sample2"}
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/targetHttpsProxies/{target_https_proxy}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertTargetHttpsProxyRequest({"project": "sample1"})
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/targetHttpsProxies"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListTargetHttpsProxiesRequest({"project": "sample1"})
...
@pytest.mark.parametrize(
    "request_type", [compute.SetQuicOverrideTargetHttpsProxyRequest, dict,]
)
def test_set_quic_override_unary_rest(request_type, transport: str = "rest"):
    client = TargetHttpsProxiesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest",
    )
    # Send a request that will satisfy transcoding
...
def test_set_quic_override_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/targetHttpsProxies/{target_https_proxy}/setQuicOverride"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetSslCertificatesTargetHttpsProxyRequest, dict,]
)
...
def test_set_ssl_certificates_unary_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "target_https_proxy": "sample2"}
    request_init["target_https_proxies_set_ssl_certificates_request_resource"] = {
        "ssl_certificates": ["ssl_certificates_value_1", "ssl_certificates_value_2"]
    }
    request = request_type(request_init)
...
def test_set_ssl_certificates_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/targetHttpsProxies/{target_https_proxy}/setSslCertificates"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetSslPolicyTargetHttpsProxyRequest, dict,]
)
...
def test_set_ssl_policy_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/targetHttpsProxies/{target_https_proxy}/setSslPolicy"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetUrlMapTargetHttpsProxyRequest, dict,]
)
...
def test_set_url_map_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/targetHttpsProxies/{target_https_proxy}/setUrlMap"
            % client.transport._host,
            args[1],
        )
