...
def test_node_templates_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = NodeTemplatesClient.from_service_account_info(info)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert "node_template_value" in http_call[1] + str(body)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert compute.NodeTemplate.to_json(
            node_template_resource, including_default_value_fields=False
