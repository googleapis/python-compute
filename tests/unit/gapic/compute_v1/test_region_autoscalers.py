...
from google.cloud.compute_v1.services.region_autoscalers.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_autoscalers.transports.base import _GOOGLE_AUTH_VERSION
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.delete(
project='project_value',region='region_value',autoscaler='autoscaler_value',        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',autoscaler_resource=autoscaler_resource,        )
...
def test_region_autoscalers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_autoscalers.transports.RegionAutoscalersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_autoscalers_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_autoscalers.transports.RegionAutoscalersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionAutoscalersTransport()
        adc.assert_called_once()
