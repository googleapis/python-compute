...
def test_delete_unary_rest_required_fields(
    ...
    assert (
        jsonified_request["publicAdvertisedPrefix"]
        == request_init["public_advertised_prefix"]
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("project", "")("public_advertised_prefix", "")]
...
def test_delete_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/publicAdvertisedPrefixes/{public_advertised_prefix}"
...
def test_insert_unary_rest(
    ...
    request_init["public_advertised_prefix_resource"] = compute.PublicAdvertisedPrefix(
        creation_timestamp="creation_timestamp_value"
    )
    request = request_type(request_init)
...
def test_insert_unary_rest_flattened(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/publicAdvertisedPrefixes"
            % client.transport._host,
            args[1],
        )
