...
from google.cloud.compute_v1.services.region_target_https_proxies.transports.base import (
...
def test_region_target_https_proxies_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
