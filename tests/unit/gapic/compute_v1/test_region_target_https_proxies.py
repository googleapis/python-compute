...
from google.cloud.compute_v1.services.region_target_https_proxies.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_target_https_proxies.transports.base import _GOOGLE_AUTH_VERSION
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.delete(
project='project_value',region='region_value',target_https_proxy='target_https_proxy_value',        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',target_https_proxy_resource=target_https_proxy_resource,        )
...
project='project_value',region='region_value',target_https_proxy='target_https_proxy_value',region_target_https_proxies_set_ssl_certificates_request_resource=region_target_https_proxies_set_ssl_certificates_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_https_proxy_value'
 in http_call[1] + str(body)
        assert compute.RegionTargetHttpsProxiesSetSslCertificatesRequest.to_json(region_target_https_proxies_set_ssl_certificates_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_url_map(
project='project_value',region='region_value',target_https_proxy='target_https_proxy_value',url_map_reference_resource=url_map_reference_resource,        )
...
def test_region_target_https_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_target_https_proxies.transports.RegionTargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_target_https_proxies_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_target_https_proxies.transports.RegionTargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_region_target_https_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_target_https_proxies.transports.RegionTargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionTargetHttpsProxiesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_region_target_https_proxies_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        RegionTargetHttpsProxiesClient()
