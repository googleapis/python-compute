...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = compute.ServiceAttachmentAggregatedList.to_json(
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/aggregated/serviceAttachments"
...
def test_insert_rest(request_type):
    ...
    test_field = compute.InsertServiceAttachmentRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["service_attachment_resource"][field])
                ):
...
def test_patch_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.PatchServiceAttachmentRequest.meta.fields[
        "service_attachment_resource"
    ]
...
def test_set_iam_policy_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyServiceAttachmentRequest.meta.fields[
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments/{resource}/setIamPolicy"
            % client.transport._host,
            args[1],
        )
...
def test_test_iam_permissions_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsServiceAttachmentRequest.meta.fields[
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/compute/v1/projects/{project}/regions/{region}/serviceAttachments/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
