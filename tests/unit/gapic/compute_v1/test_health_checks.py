...
from google.cloud.compute_v1.services.health_checks.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.health_checks.transports.base import _GOOGLE_AUTH_VERSION
...
def test_health_checks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListHealthChecksRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.HealthChecksAggregatedList(
            id='id_value',
            items={'key_value': compute.HealthChecksScopedList(health_checks=[compute.HealthCheck(check_interval_sec=1884)])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.HealthChecksScopedList(health_checks=[compute.HealthCheck(check_interval_sec=1884)])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteHealthCheckRequest):
    client = HealthChecksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetHealthCheckRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.HealthCheck(
            ...
            creation_timestamp='creation_timestamp_value',
            description='description_value',
            grpc_health_check=compute.GRPCHealthCheck(grpc_service_name='grpc_service_name_value'),
    ...
    assert response.creation_timestamp == 'creation_timestamp_value'
    assert response.description == 'description_value'
    assert response.grpc_health_check == compute.GRPCHealthCheck(grpc_service_name='grpc_service_name_value')
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertHealthCheckRequest):
    client = HealthChecksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',health_check_resource=health_check_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.HealthCheck.to_json(health_check_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListHealthChecksRequest):
    client = HealthChecksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchHealthCheckRequest):
    client = HealthChecksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        health_check_resource = compute.HealthCheck(check_interval_sec=1884)
        client.patch(
project='project_value',health_check='health_check_value',health_check_resource=health_check_resource,        )
...
def test_update_rest(transport: str = 'rest', request_type=compute.UpdateHealthCheckRequest):
    client = HealthChecksClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_health_checks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.health_checks.transports.HealthChecksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_health_checks_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.health_checks.transports.HealthChecksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.HealthChecksTransport()
        adc.assert_called_once()
