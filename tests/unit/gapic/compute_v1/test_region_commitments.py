...
@pytest.mark.parametrize(
    "request_type", [compute.AggregatedListRegionCommitmentsRequest, dict,]
)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/commitments"
...
def test_get_rest(request_type, transport: str = "rest"):
    ...
    request = compute.GetRegionCommitmentRequest(
        {"project": "sample1", "region": "sample2", "commitment": "sample3"}
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/commitments/{commitment}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/commitments"
            % client.transport._host,
            args[1],
        )
