...
@pytest.mark.parametrize(
    "request_type", [compute.GetInterconnectLocationRequest, dict,]
)
def test_get_rest(request_type, transport: str = "rest"):
    ...
    request = compute.GetInterconnectLocationRequest(
        {"project": "sample1", "interconnect_location": "sample2"}
    )
...
def test_get_rest_required_fields(request_type=compute.GetInterconnectLocationRequest):
    ...
    assert "interconnectLocation" not in jsonified_request
    ...
    assert (
        jsonified_request["interconnectLocation"]
        == request_init["interconnect_location"]
    )
...
def test_get_rest_bad_request(
    transport: str = "rest", request_type=compute.GetInterconnectLocationRequest
):
    client = InterconnectLocationsClient(
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/interconnectLocations/{interconnect_location}"
...
@pytest.mark.parametrize(
    "request_type", [compute.ListInterconnectLocationsRequest, dict,]
)
def test_list_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListInterconnectLocationsRequest({"project": "sample1"})
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListInterconnectLocationsRequest
):
    client = InterconnectLocationsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/interconnectLocations"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListInterconnectLocationsRequest(), project="project_value",
        )
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.InterconnectLocationList(items=[], next_page_token="def",),
            compute.InterconnectLocationList(
                items=[compute.InterconnectLocation(),], next_page_token="ghi",
            ),
            compute.InterconnectLocationList(
                items=[compute.InterconnectLocation(), compute.InterconnectLocation(),],
            ),
        )
