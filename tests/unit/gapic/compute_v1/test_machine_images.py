...
@pytest.mark.parametrize(
    "transport_class,transport_name", [(transports.MachineImagesRestTransport, "rest"),]
)
...
def test_delete_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",)) & set(("machineImage", "project",))
    )
...
@pytest.mark.parametrize(
    "request_type", [compute.GetIamPolicyMachineImageRequest, dict,]
)
...
def test_insert_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId", "sourceInstance",))
        & set(("machineImageResource", "project",))
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.MachineImageList.to_json(
...
def test_list_rest_bad_request(
    transport: str = "rest", request_type=compute.ListMachineImagesRequest
):
    client = MachineImagesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListMachineImagesRequest(), project="project_value",
        )
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.MachineImageList(items=[], next_page_token="def",),
            compute.MachineImageList(
                items=[compute.MachineImage(),], next_page_token="ghi",
            ),
            compute.MachineImageList(
...
@pytest.mark.parametrize(
    "request_type", [compute.SetIamPolicyMachineImageRequest, dict,]
)
...
def test_set_iam_policy_rest_bad_request(
    transport: str = "rest", request_type=compute.SetIamPolicyMachineImageRequest
):
    client = MachineImagesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
@pytest.mark.parametrize(
    "request_type", [compute.TestIamPermissionsMachineImageRequest, dict,]
)
...
def test_test_iam_permissions_rest_bad_request(
    transport: str = "rest", request_type=compute.TestIamPermissionsMachineImageRequest
):
    client = MachineImagesClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
