...
@pytest.mark.parametrize("client_class", [VpnGatewaysClient,])
def test_vpn_gateways_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_vpn_gateways_client_service_account_always_use_jwt_true(
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert "vpn_gateway_value" in http_call[1] + str(body)
