...
from google.cloud.compute_v1.services.vpn_gateways.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.vpn_gateways.transports.base import _GOOGLE_AUTH_VERSION
...
def test_vpn_gateways_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListVpnGatewaysRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.VpnGatewayAggregatedList(
            id='id_value',
            items={'key_value': compute.VpnGatewaysScopedList(vpn_gateways=[compute.VpnGateway(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.VpnGatewaysScopedList(vpn_gateways=[compute.VpnGateway(creation_timestamp='creation_timestamp_value')])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteVpnGatewayRequest):
    client = VpnGatewaysClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',region='region_value',vpn_gateway='vpn_gateway_value',        )
...
def test_get_status_rest(transport: str = 'rest', request_type=compute.GetStatusVpnGatewayRequest):
    client = VpnGatewaysClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.VpnGatewaysGetStatusResponse(
            result=compute.VpnGatewayStatus(vpn_connections=[compute.VpnGatewayStatusVpnConnection(peer_external_gateway='peer_external_gateway_value')]),
        )
    ...
    assert response.result == compute.VpnGatewayStatus(vpn_connections=[compute.VpnGatewayStatusVpnConnection(peer_external_gateway='peer_external_gateway_value')])
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertVpnGatewayRequest):
    client = VpnGatewaysClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',vpn_gateway_resource=vpn_gateway_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert compute.VpnGateway.to_json(vpn_gateway_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListVpnGatewaysRequest):
    client = VpnGatewaysClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.VpnGateway(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_set_labels_rest(transport: str = 'rest', request_type=compute.SetLabelsVpnGatewayRequest):
    client = VpnGatewaysClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsVpnGatewayRequest):
    client = VpnGatewaysClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_vpn_gateways_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.vpn_gateways.transports.VpnGatewaysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_vpn_gateways_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.vpn_gateways.transports.VpnGatewaysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.VpnGatewaysTransport()
        adc.assert_called_once()
