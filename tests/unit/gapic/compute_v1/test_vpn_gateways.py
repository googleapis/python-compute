...
from google.cloud.compute_v1.services.vpn_gateways import (
    VpnGatewaysClient,
    pagers,
    transports,
)
...
def test_set_labels_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetLabelsVpnGatewayRequest.meta.fields[
...
def test_test_iam_permissions_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsVpnGatewayRequest.meta.fields[
