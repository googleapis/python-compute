...
def test_delete_unary_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("project", "")("region", "")("vpn_gateway", "")]
            actual_params = req.call_args.kwargs["params"]
            assert expected_params == actual_params
...
def test_get_status_rest_required_fields(
    ...
    unset_fields = transport_class._get_status_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_insert_unary_rest(
    ...
    request_init["vpn_gateway_resource"] = compute.VpnGateway(
        creation_timestamp="creation_timestamp_value"
    )
    request = request_type(request_init)
