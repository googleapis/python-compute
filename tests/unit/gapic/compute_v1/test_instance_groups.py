...
from google.cloud.compute_v1.services.instance_groups.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.instance_groups.transports.base import _GOOGLE_AUTH_VERSION
...
def test_instance_groups_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
project='project_value',zone='zone_value',instance_group='instance_group_value',instance_groups_add_instances_request_resource=instance_groups_add_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert 'instance_group_value'
 in http_call[1] + str(body)
        assert compute.InstanceGroupsAddInstancesRequest.to_json(instance_groups_add_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListInstanceGroupsRequest):
    client = InstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.InstanceGroupAggregatedList(
            id='id_value',
            items={'key_value': compute.InstanceGroupsScopedList(instance_groups=[compute.InstanceGroup(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.id == 'id_value'
    assert response.items == {'key_value': compute.InstanceGroupsScopedList(instance_groups=[compute.InstanceGroup(creation_timestamp='creation_timestamp_value')])}
    assert response.kind == 'kind_value'
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',zone='zone_value',instance_group='instance_group_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetInstanceGroupRequest):
    client = InstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',zone='zone_value',instance_group_resource=instance_group_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert compute.InstanceGroup.to_json(instance_group_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListInstanceGroupsRequest):
    client = InstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.InstanceGroupList(
            id='id_value',
            items=[compute.InstanceGroup(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.InstanceGroup(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_list_instances_rest(transport: str = 'rest', request_type=compute.ListInstancesInstanceGroupsRequest):
    client = InstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',zone='zone_value',instance_group='instance_group_value',instance_groups_list_instances_request_resource=instance_groups_list_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_value'
 in http_call[1] + str(body)
        assert compute.InstanceGroupsListInstancesRequest.to_json(instance_groups_list_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance_group='instance_group_value',instance_groups_remove_instances_request_resource=instance_groups_remove_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_value'
 in http_call[1] + str(body)
        assert compute.InstanceGroupsRemoveInstancesRequest.to_json(instance_groups_remove_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance_group='instance_group_value',instance_groups_set_named_ports_request_resource=instance_groups_set_named_ports_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_value'
 in http_call[1] + str(body)
        assert compute.InstanceGroupsSetNamedPortsRequest.to_json(instance_groups_set_named_ports_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_instance_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.instance_groups.transports.InstanceGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instance_groups_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.instance_groups.transports.InstanceGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.InstanceGroupsTransport()
        adc.assert_called_once()
