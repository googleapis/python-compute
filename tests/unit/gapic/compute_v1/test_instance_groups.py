...
def test_add_instances_unary_rest_required_fields(
    ...
    unset_fields = transport_class._add_instances_get_unset_required_fields(
        jsonified_request
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("instance_group", "")("project", "")("zone", "")]
...
def test_list_instances_rest_required_fields(
    ...
    unset_fields = transport_class._list_instances_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_remove_instances_unary_rest_required_fields(
    ...
    unset_fields = transport_class._remove_instances_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_named_ports_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_named_ports_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
