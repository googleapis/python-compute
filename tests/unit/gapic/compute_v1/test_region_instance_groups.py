...
from google.cloud.compute_v1.services.region_instance_groups.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_instance_groups.transports.base import _GOOGLE_AUTH_VERSION
...
def test_region_instance_groups_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.get(
project='project_value',region='region_value',instance_group='instance_group_value',        )
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionInstanceGroupsRequest):
    client = RegionInstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instances_rest(transport: str = 'rest', request_type=compute.ListInstancesRegionInstanceGroupsRequest):
    client = RegionInstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the value into a proper Response obj
        json_return_value = compute.RegionInstanceGroupsListInstances.to_json(return_value)
        response_value = Response()
        response_value.status_code = 200
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
...
project='project_value',region='region_value',instance_group='instance_group_value',region_instance_groups_list_instances_request_resource=region_instance_groups_list_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupsListInstancesRequest.to_json(region_instance_groups_list_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_named_ports_rest(transport: str = 'rest', request_type=compute.SetNamedPortsRegionInstanceGroupRequest):
    client = RegionInstanceGroupsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group='instance_group_value',region_instance_groups_set_named_ports_request_resource=region_instance_groups_set_named_ports_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupsSetNamedPortsRequest.to_json(region_instance_groups_set_named_ports_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_region_instance_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_instance_groups.transports.RegionInstanceGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_instance_groups_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_instance_groups.transports.RegionInstanceGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionInstanceGroupsTransport()
        adc.assert_called_once()
