...
@pytest.mark.parametrize(
    "request_type", [compute.DeleteRegionNetworkEndpointGroupRequest, dict,]
)
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteRegionNetworkEndpointGroupRequest(
        {"project": "sample1", "region": "sample2", "network_endpoint_group": "sample3"}
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}"
...
@pytest.mark.parametrize(
    "request_type", [compute.GetRegionNetworkEndpointGroupRequest, dict,]
)
...
@pytest.mark.parametrize(
    "request_type", [compute.InsertRegionNetworkEndpointGroupRequest, dict,]
)
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.ListRegionNetworkEndpointGroupsRequest, dict,]
)
