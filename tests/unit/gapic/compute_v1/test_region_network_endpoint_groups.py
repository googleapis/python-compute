...
from google.cloud.compute_v1.services.region_network_endpoint_groups.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_network_endpoint_groups.transports.base import _GOOGLE_AUTH_VERSION
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.delete(
project='project_value',region='region_value',network_endpoint_group='network_endpoint_group_value',        )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',network_endpoint_group_resource=network_endpoint_group_resource,        )
...
def test_region_network_endpoint_groups_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_network_endpoint_groups_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_region_network_endpoint_groups_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_network_endpoint_groups.transports.RegionNetworkEndpointGroupsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionNetworkEndpointGroupsTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_region_network_endpoint_groups_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        RegionNetworkEndpointGroupsClient()
