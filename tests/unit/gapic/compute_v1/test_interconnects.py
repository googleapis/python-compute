...
def test_interconnects_client_from_service_account_info():
    ...
    with mock.patch.object(
        ...
        info = {"valid": True}
        client = InterconnectsClient.from_service_account_info(info)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert compute.Interconnect.to_json(
            interconnect_resource, including_default_value_fields=False
