...
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteInterconnectRequest(
        {"project": "sample1", "interconnect": "sample2"}
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/interconnects/{interconnect}"
...
def test_get_diagnostics_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/interconnects/{interconnect}/getDiagnostics"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/interconnects"
            % client.transport._host,
            args[1],
        )
