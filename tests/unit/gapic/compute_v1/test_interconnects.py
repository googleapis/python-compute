...
from google.cloud.compute_v1.services.interconnects.transports.base import (
...
@pytest.mark.parametrize("client_class", [InterconnectsClient,])
def test_interconnects_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_interconnects_client_service_account_always_use_jwt_true(
