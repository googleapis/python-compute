...
from google.cloud.compute_v1.services.resource_policies.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.resource_policies.transports.base import _GOOGLE_AUTH_VERSION
...
def test_resource_policies_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListResourcePoliciesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ResourcePolicyAggregatedList(
            etag='etag_value',
            id='id_value',
            items={'key_value': compute.ResourcePoliciesScopedList(resource_policies=[compute.ResourcePolicy(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.ResourcePoliciesScopedList(resource_policies=[compute.ResourcePolicy(creation_timestamp='creation_timestamp_value')])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',region='region_value',resource_policy='resource_policy_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ResourcePolicy(
            creation_timestamp='creation_timestamp_value',
            description='description_value',
            group_placement_policy=compute.ResourcePolicyGroupPlacementPolicy(availability_domain_count=2650),
            id='id_value',
            kind='kind_value',
            name='name_value',
            region='region_value',
            self_link='self_link_value',
            snapshot_schedule_policy=compute.ResourcePolicySnapshotSchedulePolicy(retention_policy=compute.ResourcePolicySnapshotSchedulePolicyRetentionPolicy(max_retention_days=1933)),
    ...
    assert response.creation_timestamp == 'creation_timestamp_value'
    assert response.description == 'description_value'
    assert response.group_placement_policy == compute.ResourcePolicyGroupPlacementPolicy(availability_domain_count=2650)
    assert response.id == 'id_value'
    assert response.kind == 'kind_value'
    assert response.name == 'name_value'
    assert response.region == 'region_value'
    assert response.self_link == 'self_link_value'
    assert response.snapshot_schedule_policy == compute.ResourcePolicySnapshotSchedulePolicy(retention_policy=compute.ResourcePolicySnapshotSchedulePolicyRetentionPolicy(max_retention_days=1933))
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',resource_policy_resource=resource_policy_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert compute.ResourcePolicy.to_json(resource_policy_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListResourcePoliciesRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ResourcePolicyList(
            etag='etag_value',
            id='id_value',
            items=[compute.ResourcePolicy(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.etag == 'etag_value'
    assert response.id == 'id_value'
    assert response.items == [compute.ResourcePolicy(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicyResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resource_policies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.resource_policies.transports.ResourcePoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_resource_policies_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.resource_policies.transports.ResourcePoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ResourcePoliciesTransport()
        adc.assert_called_once()
