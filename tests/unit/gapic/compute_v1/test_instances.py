...
from google.cloud.compute_v1.services.instances.transports.base import _GOOGLE_AUTH_VERSION
...
project='project_value',zone='zone_value',instance='instance_value',network_interface='network_interface_value',access_config_resource=access_config_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert 'network_interface_value'
 in http_call[1] + str(body)
        assert compute.AccessConfig.to_json(access_config_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_add_resource_policies_request_resource=instances_add_resource_policies_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesAddResourcePoliciesRequest.to_json(instances_add_resource_policies_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListInstancesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.InstanceAggregatedList(
            id='id_value',
            items={'key_value': compute.InstancesScopedList(instances=[compute.Instance(can_ip_forward=True)])},
            kind='kind_value',
    ...
    assert response.id == 'id_value'
    assert response.items == {'key_value': compute.InstancesScopedList(instances=[compute.Instance(can_ip_forward=True)])}
    assert response.kind == 'kind_value'
...
def test_attach_disk_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.attach_disk(
project='project_value',zone='zone_value',instance='instance_value',attached_disk_resource=attached_disk_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.AttachedDisk.to_json(attached_disk_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',access_config='access_config_value',network_interface='network_interface_value',        )
...
def test_detach_disk_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.detach_disk(
project='project_value',zone='zone_value',instance='instance_value',device_name='device_name_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetInstanceRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.Instance(
            can_ip_forward=True,
            confidential_instance_config=compute.ConfidentialInstanceConfig(enable_confidential_compute=True),
            ...
            name='name_value',
            network_interfaces=[compute.NetworkInterface(access_configs=[compute.AccessConfig(kind='kind_value')])],
            private_ipv6_google_access=compute.Instance.PrivateIpv6GoogleAccess.ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE,
            reservation_affinity=compute.ReservationAffinity(consume_reservation_type=compute.ReservationAffinity.ConsumeReservationType.ANY_RESERVATION),
            ...
            shielded_instance_config=compute.ShieldedInstanceConfig(enable_integrity_monitoring=True),
            shielded_instance_integrity_policy=compute.ShieldedInstanceIntegrityPolicy(update_auto_learn_policy=True),
    ...
    assert response.confidential_instance_config == compute.ConfidentialInstanceConfig(enable_confidential_compute=True)
    ...
    assert response.guest_accelerators == [compute.AcceleratorConfig(accelerator_count=1805)]
    ...
    assert response.name == 'name_value'
    assert response.network_interfaces == [compute.NetworkInterface(access_configs=[compute.AccessConfig(kind='kind_value')])]
    ...
    assert response.reservation_affinity == compute.ReservationAffinity(consume_reservation_type=compute.ReservationAffinity.ConsumeReservationType.ANY_RESERVATION)
    ...
    assert response.shielded_instance_config == compute.ShieldedInstanceConfig(enable_integrity_monitoring=True)
    assert response.shielded_instance_integrity_policy == compute.ShieldedInstanceIntegrityPolicy(update_auto_learn_policy=True)
...
def test_get_guest_attributes_rest(transport: str = 'rest', request_type=compute.GetGuestAttributesInstanceRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.GuestAttributes(
            ...
            query_value=compute.GuestAttributesValue(items=[compute.GuestAttributesEntry(key='key_value')]),
            self_link='self_link_value',
    ...
    assert response.query_value == compute.GuestAttributesValue(items=[compute.GuestAttributesEntry(key='key_value')])
    assert response.self_link == 'self_link_value'
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyInstanceRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.Policy(
            audit_configs=[compute.AuditConfig(audit_log_configs=[compute.AuditLogConfig(exempted_members=['exempted_members_value'])])],
    ...
    assert response.audit_configs == [compute.AuditConfig(audit_log_configs=[compute.AuditLogConfig(exempted_members=['exempted_members_value'])])]
...
def test_get_shielded_instance_identity_rest(transport: str = 'rest', request_type=compute.GetShieldedInstanceIdentityInstanceRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ShieldedInstanceIdentity(
            encryption_key=compute.ShieldedInstanceIdentityEntry(ek_cert='ek_cert_value'),
            kind='kind_value',
    ...
    assert response.encryption_key == compute.ShieldedInstanceIdentityEntry(ek_cert='ek_cert_value')
    assert response.kind == 'kind_value'
    assert response.signing_key == compute.ShieldedInstanceIdentityEntry(ek_cert='ek_cert_value')
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',zone='zone_value',instance_resource=instance_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert compute.Instance.to_json(instance_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_remove_resource_policies_request_resource=instances_remove_resource_policies_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesRemoveResourcePoliciesRequest.to_json(instances_remove_resource_policies_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',auto_delete=True,device_name='device_name_value',        )
...
project='project_value',zone='zone_value',resource='resource_value',zone_set_policy_request_resource=zone_set_policy_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'resource_value'
 in http_call[1] + str(body)
        assert compute.ZoneSetPolicyRequest.to_json(zone_set_policy_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_labels(
project='project_value',zone='zone_value',instance='instance_value',instances_set_labels_request_resource=instances_set_labels_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesSetLabelsRequest.to_json(instances_set_labels_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_set_machine_resources_request_resource=instances_set_machine_resources_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesSetMachineResourcesRequest.to_json(instances_set_machine_resources_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_set_machine_type_request_resource=instances_set_machine_type_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesSetMachineTypeRequest.to_json(instances_set_machine_type_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_metadata_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_metadata(
project='project_value',zone='zone_value',instance='instance_value',metadata_resource=metadata_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.Metadata.to_json(metadata_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_set_min_cpu_platform_request_resource=instances_set_min_cpu_platform_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesSetMinCpuPlatformRequest.to_json(instances_set_min_cpu_platform_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',scheduling_resource=scheduling_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.Scheduling.to_json(scheduling_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_set_service_account_request_resource=instances_set_service_account_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesSetServiceAccountRequest.to_json(instances_set_service_account_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',shielded_instance_integrity_policy_resource=shielded_instance_integrity_policy_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.ShieldedInstanceIntegrityPolicy.to_json(shielded_instance_integrity_policy_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_tags_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_tags(
project='project_value',zone='zone_value',instance='instance_value',tags_resource=tags_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.Tags.to_json(tags_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',instances_start_with_encryption_key_request_resource=instances_start_with_encryption_key_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.InstancesStartWithEncryptionKeyRequest.to_json(instances_start_with_encryption_key_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_update_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        instance_resource = compute.Instance(can_ip_forward=True)
        client.update(
project='project_value',zone='zone_value',instance='instance_value',instance_resource=instance_resource,        )
...
project='project_value',zone='zone_value',instance='instance_value',display_device_resource=display_device_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.DisplayDevice.to_json(display_device_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_update_network_interface_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        network_interface_resource = compute.NetworkInterface(access_configs=[compute.AccessConfig(kind='kind_value')])
        client.update_network_interface(
project='project_value',zone='zone_value',instance='instance_value',network_interface='network_interface_value',network_interface_resource=network_interface_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'network_interface_value'
 in http_call[1] + str(body)
        assert compute.NetworkInterface.to_json(network_interface_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',zone='zone_value',instance='instance_value',shielded_instance_config_resource=shielded_instance_config_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_value'
 in http_call[1] + str(body)
        assert compute.ShieldedInstanceConfig.to_json(shielded_instance_config_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_instances_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instances_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.instances.transports.InstancesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.InstancesTransport()
        adc.assert_called_once()
