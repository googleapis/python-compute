...
def test_add_nodes_unary_rest_required_fields(
    ...
    unset_fields = transport_class._add_nodes_get_unset_required_fields(
        jsonified_request
    )
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("node_group", "")("project", "")("zone", "")]
...
def test_delete_nodes_unary_rest_required_fields(
    ...
    unset_fields = transport_class._delete_nodes_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertNodeGroupRequest):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [("initial_node_count", "")("project", "")("zone", "")]
            actual_params = req.call_args.kwargs["params"]
            assert expected_params == actual_params
...
def test_list_nodes_rest_required_fields(
    ...
    unset_fields = transport_class._list_nodes_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_set_node_template_unary_rest_required_fields(
    ...
    unset_fields = transport_class._set_node_template_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
