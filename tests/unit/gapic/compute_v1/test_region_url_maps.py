...
from google.cloud.compute_v1.services.region_url_maps.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_url_maps.transports.base import _GOOGLE_AUTH_VERSION
...
def test_region_url_maps_client_from_service_account_info(client_class):
...
def test_region_url_maps_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionUrlMapRequest):
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetRegionUrlMapRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.UrlMap(
            creation_timestamp='creation_timestamp_value',
            default_route_action=compute.HttpRouteAction(cors_policy=compute.CorsPolicy(allow_credentials=True)),
            default_service='default_service_value',
            default_url_redirect=compute.HttpRedirectAction(host_redirect='host_redirect_value'),
            description='description_value',
            fingerprint='fingerprint_value',
            header_action=compute.HttpHeaderAction(request_headers_to_add=[compute.HttpHeaderOption(header_name='header_name_value')]),
            host_rules=[compute.HostRule(description='description_value')],
            id='id_value',
            kind='kind_value',
            name='name_value',
            path_matchers=[compute.PathMatcher(default_route_action=compute.HttpRouteAction(cors_policy=compute.CorsPolicy(allow_credentials=True)))],
            region='region_value',
            self_link='self_link_value',
    ...
    assert response.creation_timestamp == 'creation_timestamp_value'
    assert response.default_route_action == compute.HttpRouteAction(cors_policy=compute.CorsPolicy(allow_credentials=True))
    assert response.default_service == 'default_service_value'
    assert response.default_url_redirect == compute.HttpRedirectAction(host_redirect='host_redirect_value')
    assert response.description == 'description_value'
    assert response.fingerprint == 'fingerprint_value'
    assert response.header_action == compute.HttpHeaderAction(request_headers_to_add=[compute.HttpHeaderOption(header_name='header_name_value')])
    assert response.host_rules == [compute.HostRule(description='description_value')]
    assert response.id == 'id_value'
    assert response.kind == 'kind_value'
    assert response.name == 'name_value'
    assert response.path_matchers == [compute.PathMatcher(default_route_action=compute.HttpRouteAction(cors_policy=compute.CorsPolicy(allow_credentials=True)))]
    assert response.region == 'region_value'
    assert response.self_link == 'self_link_value'
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',url_map_resource=url_map_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert compute.UrlMap.to_json(url_map_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionUrlMapsRequest):
    client = RegionUrlMapsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.UrlMap(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        url_map_resource = compute.UrlMap(creation_timestamp='creation_timestamp_value')
        client.patch(
project='project_value',region='region_value',url_map='url_map_value',url_map_resource=url_map_resource,        )
...
def test_update_rest(transport: str = 'rest', request_type=compute.UpdateRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_validate_rest(transport: str = 'rest', request_type=compute.ValidateRegionUrlMapRequest):
    client = RegionUrlMapsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.result == compute.UrlMapValidationResult(load_errors=['load_errors_value'])
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.validate(
project='project_value',region='region_value',url_map='url_map_value',region_url_maps_validate_request_resource=region_url_maps_validate_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'url_map_value'
 in http_call[1] + str(body)
        assert compute.RegionUrlMapsValidateRequest.to_json(region_url_maps_validate_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_region_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_url_maps_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_region_url_maps_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionUrlMapsTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_region_url_maps_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        RegionUrlMapsClient()
