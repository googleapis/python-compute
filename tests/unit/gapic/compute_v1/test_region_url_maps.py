...
from google.cloud.compute_v1.services.region_url_maps.transports.base import (
...
@pytest.mark.parametrize("client_class", [RegionUrlMapsClient,])
def test_region_url_maps_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_region_url_maps_client_service_account_always_use_jwt_true(
...
def test_delete_rest_flattened():
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(),)
