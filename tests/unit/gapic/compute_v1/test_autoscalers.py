...
from google.cloud.compute_v1.services.autoscalers.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.autoscalers.transports.base import _GOOGLE_AUTH_VERSION
...
def test_autoscalers_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListAutoscalersRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.AutoscalerAggregatedList(
            id='id_value',
            items={'key_value': compute.AutoscalersScopedList(autoscalers=[compute.Autoscaler(autoscaling_policy=compute.AutoscalingPolicy(cool_down_period_sec=2112))])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.AutoscalersScopedList(autoscalers=[compute.Autoscaler(autoscaling_policy=compute.AutoscalingPolicy(cool_down_period_sec=2112))])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteAutoscalerRequest):
    client = AutoscalersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetAutoscalerRequest):
    ...
    assert response.autoscaling_policy == compute.AutoscalingPolicy(cool_down_period_sec=2112)
    assert response.creation_timestamp == 'creation_timestamp_value'
    assert response.description == 'description_value'
    assert response.id == 'id_value'
    assert response.kind == 'kind_value'
    ...
    assert response.status_details == [compute.AutoscalerStatusDetails(message='message_value')]
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertAutoscalerRequest):
    client = AutoscalersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',zone='zone_value',autoscaler_resource=autoscaler_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert compute.Autoscaler.to_json(autoscaler_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListAutoscalersRequest):
    client = AutoscalersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.AutoscalerList(
            id='id_value',
            items=[compute.Autoscaler(autoscaling_policy=compute.AutoscalingPolicy(cool_down_period_sec=2112))],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.Autoscaler(autoscaling_policy=compute.AutoscalingPolicy(cool_down_period_sec=2112))]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchAutoscalerRequest):
    client = AutoscalersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_rest(transport: str = 'rest', request_type=compute.UpdateAutoscalerRequest):
    client = AutoscalersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_autoscalers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.autoscalers.transports.AutoscalersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_autoscalers_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.autoscalers.transports.AutoscalersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AutoscalersTransport()
        adc.assert_called_once()
