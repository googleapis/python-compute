...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AutoscalersClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        AutoscalersClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AutoscalersClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AutoscalersClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
@mock.patch.object(
    AutoscalersClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AutoscalersClient)
)
def test_autoscalers_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_autoscalers_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_autoscalers_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_autoscalers_client_client_options_credentials_file(
    client_class, transport_class, transport_name
):
...
@pytest.mark.parametrize(
    "request_type", [compute.AggregatedListAutoscalersRequest, dict,]
)
def test_aggregated_list_rest(request_type, transport: str = "rest"):
    ...
    request = compute.AggregatedListAutoscalersRequest({"project": "sample1"})
...
def test_aggregated_list_rest_required_fields(
    request_type=compute.AggregatedListAutoscalersRequest,
):
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/autoscalers"
...
def test_aggregated_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.aggregated_list(
            compute.AggregatedListAutoscalersRequest(), project="project_value",
        )
...
def test_aggregated_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.AutoscalerAggregatedList(items={}, next_page_token="def",),
            compute.AutoscalerAggregatedList(
                items={"g": compute.AutoscalersScopedList(),}, next_page_token="ghi",
            ),
            compute.AutoscalerAggregatedList(
                items={
...
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteAutoscalerRequest(
        {"project": "sample1", "zone": "sample2", "autoscaler": "sample3"}
    )
...
def test_delete_unary_rest_required_fields(
    ...
    # verify fields with default values are dropped
    assert "autoscaler" not in jsonified_request
    assert "project" not in jsonified_request
    ...
    assert jsonified_request["autoscaler"] == request_init["autoscaler"]
    assert "project" in jsonified_request
    assert jsonified_request["project"] == request_init["project"]
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/autoscalers/{autoscaler}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertAutoscalerRequest({"project": "sample1", "zone": "sample2"})
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/autoscalers"
            % client.transport._host,
            args[1],
        )
...
def test_list_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListAutoscalersRequest({"project": "sample1", "zone": "sample2"})
...
def test_list_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = (
            ...
            compute.AutoscalerList(items=[], next_page_token="def",),
            compute.AutoscalerList(
...
def test_patch_unary_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchAutoscalerRequest({"project": "sample1", "zone": "sample2"})
...
def test_update_unary_rest(request_type, transport: str = "rest"):
    ...
    # Send a request that will satisfy transcoding
    request = compute.UpdateAutoscalerRequest({"project": "sample1", "zone": "sample2"})
...
def test_update_unary_rest_required_fields(
    request_type=compute.UpdateAutoscalerRequest,
):
    transport_class = transports.AutoscalersRestTransport
...
def test_autoscalers_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.autoscalers.transports.AutoscalersTransport.__init__"
    ) as Transport:
