...
@pytest.mark.parametrize("client_class", [AutoscalersClient,])
def test_autoscalers_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_autoscalers_client_service_account_always_use_jwt_true(
...
def test_aggregated_list_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.AutoscalerAggregatedList(
            id="id_value",
            items={
                "key_value": compute.AutoscalersScopedList(
                    autoscalers=[
                        compute.Autoscaler(
