...
from google.cloud.compute_v1.services.instance_templates.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.instance_templates.transports.base import _GOOGLE_AUTH_VERSION
...
def test_instance_templates_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteInstanceTemplateRequest):
...
project='project_value',instance_template='instance_template_value',        )
 ...
 in http_call[1] + str(body)
        assert 'instance_template_value'
 in http_call[1] + str(body)
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetInstanceTemplateRequest):
    client = InstanceTemplatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.InstanceTemplate(
            ...
            source_instance_params=compute.SourceInstanceParams(disk_configs=[compute.DiskInstantiationConfig(auto_delete=True)]),
        )
    ...
    assert response.source_instance_params == compute.SourceInstanceParams(disk_configs=[compute.DiskInstantiationConfig(auto_delete=True)])
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyInstanceTemplateRequest):
    client = InstanceTemplatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertInstanceTemplateRequest):
    client = InstanceTemplatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',instance_template_resource=instance_template_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.InstanceTemplate.to_json(instance_template_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListInstanceTemplatesRequest):
    client = InstanceTemplatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.InstanceTemplateList(
            id='id_value',
            items=[compute.InstanceTemplate(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.InstanceTemplate(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicyInstanceTemplateRequest):
    client = InstanceTemplatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsInstanceTemplateRequest):
    client = InstanceTemplatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_instance_templates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.instance_templates.transports.InstanceTemplatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_instance_templates_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.instance_templates.transports.InstanceTemplatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.InstanceTemplatesTransport()
        adc.assert_called_once()
