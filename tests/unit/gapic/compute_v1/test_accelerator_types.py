...
from google.cloud.compute_v1.services.accelerator_types.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.accelerator_types.transports.base import _GOOGLE_AUTH_VERSION
...
def test_accelerator_types_client_from_service_account_info(client_class):
...
def test_accelerator_types_client_from_service_account_file(client_class):
    creds = credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AcceleratorTypesClient, transports.AcceleratorTypesRestTransport, "rest", "true"),
    (AcceleratorTypesClient, transports.AcceleratorTypesRestTransport, "rest", "false"),
])
@mock.patch.object(AcceleratorTypesClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AcceleratorTypesClient))
...
def test_accelerator_types_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListAcceleratorTypesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.AcceleratorTypeAggregatedList(
            id='id_value',
            items={'key_value': compute.AcceleratorTypesScopedList(accelerator_types=[compute.AcceleratorType(creation_timestamp='creation_timestamp_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.AcceleratorTypesScopedList(accelerator_types=[compute.AcceleratorType(creation_timestamp='creation_timestamp_value')])}
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetAcceleratorTypeRequest):
    client = AcceleratorTypesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.get(
project='project_value',zone='zone_value',accelerator_type='accelerator_type_value',        )
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListAcceleratorTypesRequest):
    client = AcceleratorTypesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.AcceleratorTypeList(
            id='id_value',
            items=[compute.AcceleratorType(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.AcceleratorType(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_list_pager():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.AcceleratorType)
                   for i in results)
...
def test_accelerator_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        ...
        load_creds.assert_called_once_with("credentials.json",
            scopes=None,
            default_scopes=(            'https://www.googleapis.com/auth/compute.readonly',            'https://www.googleapis.com/auth/compute',            'https://www.googleapis.com/auth/cloud-platform',            ),
            quota_project_id="octopus",
        )


@requires_google_auth_lt_1_25_0
def test_accelerator_types_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_accelerator_types_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.accelerator_types.transports.AcceleratorTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.AcceleratorTypesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_accelerator_types_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        AcceleratorTypesClient()
        adc.assert_called_once_with(
            scopes=(                'https://www.googleapis.com/auth/compute.readonly',                'https://www.googleapis.com/auth/compute',                'https://www.googleapis.com/auth/cloud-platform',),
            quota_project_id=None,
        )
...
def test_accelerator_types_host_no_port():
    client = AcceleratorTypesClient(
        credentials=credentials.AnonymousCredentials(),
...
def test_accelerator_types_host_with_port():
    client = AcceleratorTypesClient(
        credentials=credentials.AnonymousCredentials(),
