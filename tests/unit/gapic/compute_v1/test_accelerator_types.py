...
from google.cloud.compute_v1.services.accelerator_types.transports.base import (
...
@pytest.mark.parametrize("client_class", [AcceleratorTypesClient,])
def test_accelerator_types_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_accelerator_types_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
def test_aggregated_list_rest_flattened():
    client = AcceleratorTypesClient(credentials=ga_credentials.AnonymousCredentials(),)
