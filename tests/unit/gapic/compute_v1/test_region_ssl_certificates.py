...
from google.cloud.compute_v1.services.region_ssl_certificates import RegionSslCertificatesClient
...
from google.cloud.compute_v1.services.region_ssl_certificates.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_ssl_certificates.transports.base import _GOOGLE_AUTH_VERSION
...
def test_region_ssl_certificates_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionSslCertificateRequest):
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.delete(
project='project_value',region='region_value',ssl_certificate='ssl_certificate_value',        )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetRegionSslCertificateRequest):
    client = RegionSslCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.SslCertificate(
            ...
            id='id_value',
            kind='kind_value',
            managed=compute.SslCertificateManagedSslCertificate(domain_status={'key_value': 'value_value'}),
            name='name_value',
            private_key='private_key_value',
            region='region_value',
            self_link='self_link_value',
            self_managed=compute.SslCertificateSelfManagedSslCertificate(certificate='certificate_value'),
    ...
    assert response.id == 'id_value'
    assert response.kind == 'kind_value'
    assert response.managed == compute.SslCertificateManagedSslCertificate(domain_status={'key_value': 'value_value'})
    assert response.name == 'name_value'
    assert response.private_key == 'private_key_value'
    assert response.region == 'region_value'
    assert response.self_link == 'self_link_value'
    assert response.self_managed == compute.SslCertificateSelfManagedSslCertificate(certificate='certificate_value')
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionSslCertificateRequest):
    client = RegionSslCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',ssl_certificate_resource=ssl_certificate_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'region_value'
 in http_call[1] + str(body)
        assert compute.SslCertificate.to_json(ssl_certificate_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListRegionSslCertificatesRequest):
    client = RegionSslCertificatesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_region_ssl_certificates_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_ssl_certificates.transports.RegionSslCertificatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_ssl_certificates_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_ssl_certificates.transports.RegionSslCertificatesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionSslCertificatesTransport()
        adc.assert_called_once()
