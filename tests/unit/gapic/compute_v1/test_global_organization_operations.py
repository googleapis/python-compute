...
from google.cloud.compute_v1.services.global_organization_operations.transports.base import (
...
def test_global_organization_operations_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.delete(operation="operation_value",)
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get(operation="operation_value",)
