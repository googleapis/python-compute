...
from google.cloud.compute_v1.services.global_organization_operations.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.global_organization_operations.transports.base import _GOOGLE_AUTH_VERSION
...
def test_global_organization_operations_client_from_service_account_info(client_class):
...
def test_global_organization_operations_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteGlobalOrganizationOperationRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        json_return_value = compute.DeleteGlobalOrganizationOperationResponse.to_json(return_value)
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetGlobalOrganizationOperationRequest):
    client = GlobalOrganizationOperationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListGlobalOrganizationOperationsRequest):
    client = GlobalOrganizationOperationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.Operation(client_operation_id='client_operation_id_value')]
    assert response.kind == 'kind_value'
...
def test_global_organization_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.global_organization_operations.transports.GlobalOrganizationOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_global_organization_operations_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.global_organization_operations.transports.GlobalOrganizationOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.GlobalOrganizationOperationsTransport()
        adc.assert_called_once()
...
def test_global_organization_operations_host_no_port():
    client = GlobalOrganizationOperationsClient(
        credentials=credentials.AnonymousCredentials(),
