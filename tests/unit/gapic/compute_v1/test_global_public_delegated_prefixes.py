...
def test__get_default_mtls_endpoint():
    ...
    assert (
        GlobalPublicDelegatedPrefixesClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
def test_global_public_delegated_prefixes_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_global_public_delegated_prefixes_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
...
def test_global_public_delegated_prefixes_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_global_public_delegated_prefixes_client_client_options_credentials_file(
    client_class, transport_class, transport_name
):
...
@pytest.mark.parametrize(
    "request_type", [compute.DeleteGlobalPublicDelegatedPrefixeRequest, dict,]
)
...
def test_delete_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",)) & set(("project", "publicDelegatedPrefix",))
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/publicDelegatedPrefixes/{public_delegated_prefix}"
...
@pytest.mark.parametrize(
    "request_type", [compute.GetGlobalPublicDelegatedPrefixeRequest, dict,]
)
...
@pytest.mark.parametrize(
    "request_type", [compute.InsertGlobalPublicDelegatedPrefixeRequest, dict,]
)
...
def test_insert_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",)) & set(("project", "publicDelegatedPrefixResource",))
    )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/global/publicDelegatedPrefixes"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.ListGlobalPublicDelegatedPrefixesRequest, dict,]
)
...
def test_list_rest_flattened_error(transport: str = "rest"):
    ...
    with pytest.raises(ValueError):
        client.list(
            compute.ListGlobalPublicDelegatedPrefixesRequest(), project="project_value",
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.PatchGlobalPublicDelegatedPrefixeRequest, dict,]
)
...
def test_patch_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (
        set(("requestId",))
        & set(("project", "publicDelegatedPrefix", "publicDelegatedPrefixResource",))
    )
...
def test_global_public_delegated_prefixes_base_transport():
    ...
    with mock.patch(
        "google.cloud.compute_v1.services.global_public_delegated_prefixes.transports.GlobalPublicDelegatedPrefixesTransport.__init__"
    ) as Transport:
...
def test_global_public_delegated_prefixes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.compute_v1.services.global_public_delegated_prefixes.transports.GlobalPublicDelegatedPrefixesTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_common_billing_account_path():
    ...
    actual = GlobalPublicDelegatedPrefixesClient.common_billing_account_path(
        billing_account
    )
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.GlobalPublicDelegatedPrefixesTransport, "_prep_wrapped_messages"
    ) as prep:
        client = GlobalPublicDelegatedPrefixesClient(
