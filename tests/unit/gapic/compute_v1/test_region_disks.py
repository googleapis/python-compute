...
from google.cloud.compute_v1.services.region_disks.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_disks.transports.base import _GOOGLE_AUTH_VERSION
...
project='project_value',region='region_value',disk='disk_value',region_disks_add_resource_policies_request_resource=region_disks_add_resource_policies_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'disk_value'
 in http_call[1] + str(body)
        assert compute.RegionDisksAddResourcePoliciesRequest.to_json(region_disks_add_resource_policies_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',region='region_value',disk='disk_value',snapshot_resource=snapshot_resource,        )
...
project='project_value',region='region_value',disk='disk_value',region_disks_remove_resource_policies_request_resource=region_disks_remove_resource_policies_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'disk_value'
 in http_call[1] + str(body)
        assert compute.RegionDisksRemoveResourcePoliciesRequest.to_json(region_disks_remove_resource_policies_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        region_disks_resize_request_resource = compute.RegionDisksResizeRequest(size_gb='size_gb_value')
        client.resize(
project='project_value',region='region_value',disk='disk_value',region_disks_resize_request_resource=region_disks_resize_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'disk_value'
 in http_call[1] + str(body)
        assert compute.RegionDisksResizeRequest.to_json(region_disks_resize_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',region='region_value',resource='resource_value',region_set_policy_request_resource=region_set_policy_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'resource_value'
 in http_call[1] + str(body)
        assert compute.RegionSetPolicyRequest.to_json(region_set_policy_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.set_labels(
project='project_value',region='region_value',resource='resource_value',region_set_labels_request_resource=region_set_labels_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'resource_value'
 in http_call[1] + str(body)
        assert compute.RegionSetLabelsRequest.to_json(region_set_labels_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',region='region_value',resource='resource_value',test_permissions_request_resource=test_permissions_request_resource,        )
...
def test_region_disks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_disks.transports.RegionDisksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_disks_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_disks.transports.RegionDisksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionDisksTransport()
        adc.assert_called_once()
