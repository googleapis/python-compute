...
from google.cloud.compute_v1.services.global_addresses.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.global_addresses.transports.base import _GOOGLE_AUTH_VERSION
...
def test_global_addresses_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.global_addresses.transports.GlobalAddressesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_global_addresses_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.global_addresses.transports.GlobalAddressesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.GlobalAddressesTransport()
        adc.assert_called_once()
