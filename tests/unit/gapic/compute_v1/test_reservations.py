...
from google.cloud.compute_v1.services.reservations.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.reservations.transports.base import _GOOGLE_AUTH_VERSION
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListReservationsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.ReservationAggregatedList(
            id='id_value',
            items={'key_value': compute.ReservationsScopedList(reservations=[compute.Reservation(commitment='commitment_value')])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.ReservationsScopedList(reservations=[compute.Reservation(commitment='commitment_value')])}
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteReservationRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetReservationRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.Reservation(
            ...
            name='name_value',
            self_link='self_link_value',
            specific_reservation=compute.AllocationSpecificSKUReservation(count='count_value'),
    ...
    assert response.name == 'name_value'
    assert response.self_link == 'self_link_value'
    assert response.specific_reservation == compute.AllocationSpecificSKUReservation(count='count_value')
...
def test_get_iam_policy_rest(transport: str = 'rest', request_type=compute.GetIamPolicyReservationRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertReservationRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',zone='zone_value',reservation_resource=reservation_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'zone_value'
 in http_call[1] + str(body)
        assert compute.Reservation.to_json(reservation_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListReservationsRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resize_rest(transport: str = 'rest', request_type=compute.ResizeReservationRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        reservations_resize_request_resource = compute.ReservationsResizeRequest(specific_sku_count='specific_sku_count_value')
        client.resize(
project='project_value',zone='zone_value',reservation='reservation_value',reservations_resize_request_resource=reservations_resize_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'reservation_value'
 in http_call[1] + str(body)
        assert compute.ReservationsResizeRequest.to_json(reservations_resize_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_iam_policy_rest(transport: str = 'rest', request_type=compute.SetIamPolicyReservationRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest(transport: str = 'rest', request_type=compute.TestIamPermissionsReservationRequest):
    client = ReservationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_reservations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.reservations.transports.ReservationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_reservations_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.reservations.transports.ReservationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ReservationsTransport()
        adc.assert_called_once()
