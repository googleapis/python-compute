...
def test_attach_network_endpoints_unary_rest_required_fields(
    ...
    unset_fields = transport_class._attach_network_endpoints_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            expected_params = [
                ("network_endpoint_group", "")("project", "")("zone", "")
            ]
            actual_params = req.call_args.kwargs["params"]
            assert expected_params == actual_params
...
def test_detach_network_endpoints_unary_rest_required_fields(
    ...
    unset_fields = transport_class._detach_network_endpoints_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
...
def test_list_network_endpoints_rest_required_fields(
    ...
    unset_fields = transport_class._list_network_endpoints_get_unset_required_fields(
        jsonified_request
    )
    jsonified_request.update(unset_fields)
