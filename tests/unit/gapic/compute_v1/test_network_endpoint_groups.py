...
@pytest.mark.parametrize(
    "request_type", [compute.AggregatedListNetworkEndpointGroupsRequest, dict,]
)
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/networkEndpointGroups"
...
@pytest.mark.parametrize(
    "request_type", [compute.AttachNetworkEndpointsNetworkEndpointGroupRequest, dict,]
)
def test_attach_network_endpoints_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.AttachNetworkEndpointsNetworkEndpointGroupRequest(
        {"project": "sample1", "zone": "sample2", "network_endpoint_group": "sample3"}
    )
...
def test_attach_network_endpoints_unary_rest_required_fields(
    ...
    # verify fields with default values are dropped
    assert "networkEndpointGroup" not in jsonified_request
    assert "project" not in jsonified_request
    ...
    assert (
        jsonified_request["networkEndpointGroup"]
        == request_init["network_endpoint_group"]
    )
    assert "project" in jsonified_request
    assert jsonified_request["project"] == request_init["project"]
...
def test_attach_network_endpoints_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.DeleteNetworkEndpointGroupRequest, dict,]
)
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.DetachNetworkEndpointsNetworkEndpointGroupRequest, dict,]
)
...
def test_detach_network_endpoints_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.GetNetworkEndpointGroupRequest, dict,]
)
...
@pytest.mark.parametrize(
    "request_type", [compute.InsertNetworkEndpointGroupRequest, dict,]
)
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.ListNetworkEndpointGroupsRequest, dict,]
)
...
@pytest.mark.parametrize(
    "request_type", [compute.ListNetworkEndpointsNetworkEndpointGroupsRequest, dict,]
)
...
def test_list_network_endpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints"
            % client.transport._host,
            args[1],
        )
...
@pytest.mark.parametrize(
    "request_type", [compute.TestIamPermissionsNetworkEndpointGroupRequest, dict,]
)
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/zones/{zone}/networkEndpointGroups/{resource}/testIamPermissions"
            % client.transport._host,
            args[1],
        )
