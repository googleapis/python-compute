...
@pytest.mark.parametrize(
    "request_type", [compute.AggregatedListTargetVpnGatewaysRequest, dict,]
)
def test_aggregated_list_rest(request_type, transport: str = "rest"):
    ...
    request = compute.AggregatedListTargetVpnGatewaysRequest({"project": "sample1"})
...
def test_aggregated_list_rest_required_fields(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            response_value = Response()
            response_value.status_code = 200
            json_return_value = compute.TargetVpnGatewayAggregatedList.to_json(
                return_value
            )
            response_value._content = json_return_value.encode("UTF-8")
            req.return_value = response_value
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/aggregated/targetVpnGateways"
...
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteTargetVpnGatewayRequest(
        {"project": "sample1", "region": "sample2", "target_vpn_gateway": "sample3"}
    )
...
def test_delete_unary_rest_required_fields(
    ...
    assert "targetVpnGateway" not in jsonified_request
    ...
    assert jsonified_request["targetVpnGateway"] == request_init["target_vpn_gateway"]
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/targetVpnGateways/{target_vpn_gateway}"
            % client.transport._host,
            args[1],
        )
...
def test_insert_unary_rest(request_type):
    ...
    request_init["target_vpn_gateway_resource"] = {
        "creation_timestamp": "creation_timestamp_value",
        "description": "description_value",
        "forwarding_rules": ["forwarding_rules_value_1", "forwarding_rules_value_2"],
        "id": 205,
        "kind": "kind_value",
        "name": "name_value",
        "network": "network_value",
        ...
        "self_link": "self_link_value",
        "status": "status_value",
        "tunnels": ["tunnels_value_1", "tunnels_value_2"],
    }
    request = request_type(request_init)
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "https://%s/compute/v1/projects/{project}/regions/{region}/targetVpnGateways"
            % client.transport._host,
            args[1],
        )
