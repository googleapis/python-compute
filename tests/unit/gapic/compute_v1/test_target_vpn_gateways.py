...
@pytest.mark.parametrize("client_class", [TargetVpnGatewaysClient,])
def test_target_vpn_gateways_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_target_vpn_gateways_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.insert(
            project="project_value",
            region="region_value",
            target_vpn_gateway_resource=target_vpn_gateway_resource,
        )
