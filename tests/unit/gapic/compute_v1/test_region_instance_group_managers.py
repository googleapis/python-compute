...
from google.cloud.compute_v1.services.region_instance_group_managers.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.region_instance_group_managers.transports.base import _GOOGLE_AUTH_VERSION
...
def test_region_instance_group_managers_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_abandon_instances_rest(transport: str = 'rest', request_type=compute.AbandonInstancesRegionInstanceGroupManagerRequest):
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_abandon_instances_request_resource=region_instance_group_managers_abandon_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersAbandonInstancesRequest.to_json(region_instance_group_managers_abandon_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_apply_updates_to_instances_rest(transport: str = 'rest', request_type=compute.ApplyUpdatesToInstancesRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_apply_updates_request_resource=region_instance_group_managers_apply_updates_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersApplyUpdatesRequest.to_json(region_instance_group_managers_apply_updates_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_create_instances_rest(transport: str = 'rest', request_type=compute.CreateInstancesRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_create_instances_request_resource=region_instance_group_managers_create_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersCreateInstancesRequest.to_json(region_instance_group_managers_create_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.delete(
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',        )
...
def test_delete_instances_rest(transport: str = 'rest', request_type=compute.DeleteInstancesRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_delete_instances_request_resource=region_instance_group_managers_delete_instances_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersDeleteInstancesRequest.to_json(region_instance_group_managers_delete_instances_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_delete_per_instance_configs_rest(transport: str = 'rest', request_type=compute.DeletePerInstanceConfigsRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_manager_delete_instance_config_req_resource=region_instance_group_manager_delete_instance_config_req_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagerDeleteInstanceConfigReq.to_json(region_instance_group_manager_delete_instance_config_req_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',region='region_value',instance_group_manager_resource=instance_group_manager_resource,        )
...
def test_patch_rest(transport: str = 'rest', request_type=compute.PatchRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        instance_group_manager_resource = compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')])
        client.patch(
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',instance_group_manager_resource=instance_group_manager_resource,        )
...
def test_patch_per_instance_configs_rest(transport: str = 'rest', request_type=compute.PatchPerInstanceConfigsRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_manager_patch_instance_config_req_resource=region_instance_group_manager_patch_instance_config_req_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagerPatchInstanceConfigReq.to_json(region_instance_group_manager_patch_instance_config_req_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_recreate_instances_rest(transport: str = 'rest', request_type=compute.RecreateInstancesRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_recreate_request_resource=region_instance_group_managers_recreate_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersRecreateRequest.to_json(region_instance_group_managers_recreate_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_resize_rest(transport: str = 'rest', request_type=compute.ResizeRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.resize(
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',size=443,        )
...
def test_set_instance_template_rest(transport: str = 'rest', request_type=compute.SetInstanceTemplateRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_set_template_request_resource=region_instance_group_managers_set_template_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersSetTemplateRequest.to_json(region_instance_group_managers_set_template_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_set_target_pools_rest(transport: str = 'rest', request_type=compute.SetTargetPoolsRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_managers_set_target_pools_request_resource=region_instance_group_managers_set_target_pools_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagersSetTargetPoolsRequest.to_json(region_instance_group_managers_set_target_pools_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_update_per_instance_configs_rest(transport: str = 'rest', request_type=compute.UpdatePerInstanceConfigsRegionInstanceGroupManagerRequest):
    client = RegionInstanceGroupManagersClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
project='project_value',region='region_value',instance_group_manager='instance_group_manager_value',region_instance_group_manager_update_instance_config_req_resource=region_instance_group_manager_update_instance_config_req_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'instance_group_manager_value'
 in http_call[1] + str(body)
        assert compute.RegionInstanceGroupManagerUpdateInstanceConfigReq.to_json(region_instance_group_manager_update_instance_config_req_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_region_instance_group_managers_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_instance_group_managers.transports.RegionInstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_region_instance_group_managers_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_instance_group_managers.transports.RegionInstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_region_instance_group_managers_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.region_instance_group_managers.transports.RegionInstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.RegionInstanceGroupManagersTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_region_instance_group_managers_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        RegionInstanceGroupManagersClient()
