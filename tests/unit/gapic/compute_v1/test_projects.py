...
from google.cloud.compute_v1.services.projects.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.projects.transports.base import _GOOGLE_AUTH_VERSION
...
project='project_value',projects_disable_xpn_resource_request_resource=projects_disable_xpn_resource_request_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.ProjectsDisableXpnResourceRequest.to_json(projects_disable_xpn_resource_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',projects_enable_xpn_resource_request_resource=projects_enable_xpn_resource_request_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.ProjectsEnableXpnResourceRequest.to_json(projects_enable_xpn_resource_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetProjectRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.Project(
            ...
            self_link='self_link_value',
            usage_export_location=compute.UsageExportLocation(bucket_name='bucket_name_value'),
    ...
    assert response.common_instance_metadata == compute.Metadata(fingerprint='fingerprint_value')
    assert response.creation_timestamp == 'creation_timestamp_value'
    ...
    assert response.self_link == 'self_link_value'
    assert response.usage_export_location == compute.UsageExportLocation(bucket_name='bucket_name_value')
...
def test_list_xpn_hosts_rest(transport: str = 'rest', request_type=compute.ListXpnHostsProjectsRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.XpnHostList(
            id='id_value',
            items=[compute.Project(common_instance_metadata=compute.Metadata(fingerprint='fingerprint_value'))],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.Project(common_instance_metadata=compute.Metadata(fingerprint='fingerprint_value'))]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
...
project='project_value',projects_list_xpn_hosts_request_resource=projects_list_xpn_hosts_request_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.ProjectsListXpnHostsRequest.to_json(projects_list_xpn_hosts_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_move_disk_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.move_disk(
project='project_value',disk_move_request_resource=disk_move_request_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.DiskMoveRequest.to_json(disk_move_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',instance_move_request_resource=instance_move_request_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.InstanceMoveRequest.to_json(instance_move_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',projects_set_default_network_tier_request_resource=projects_set_default_network_tier_request_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.ProjectsSetDefaultNetworkTierRequest.to_json(projects_set_default_network_tier_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',usage_export_location_resource=usage_export_location_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.UsageExportLocation.to_json(usage_export_location_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_projects_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.projects.transports.ProjectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_projects_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.projects.transports.ProjectsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ProjectsTransport()
        adc.assert_called_once()
