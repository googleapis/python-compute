...
from google.cloud.compute_v1.services.target_tcp_proxies.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.target_tcp_proxies.transports.base import _GOOGLE_AUTH_VERSION
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        client.insert(
project='project_value',target_tcp_proxy_resource=target_tcp_proxy_resource,        )
        ...
        assert 'project_value'
 in http_call[1] + str(body)
        assert compute.TargetTcpProxy.to_json(target_tcp_proxy_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListTargetTcpProxiesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.TargetTcpProxyList(
            id='id_value',
            items=[compute.TargetTcpProxy(creation_timestamp='creation_timestamp_value')],
            kind='kind_value',
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.TargetTcpProxy(creation_timestamp='creation_timestamp_value')]
    assert response.kind == 'kind_value'
...
project='project_value',target_tcp_proxy='target_tcp_proxy_value',target_tcp_proxies_set_backend_service_request_resource=target_tcp_proxies_set_backend_service_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_tcp_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetTcpProxiesSetBackendServiceRequest.to_json(target_tcp_proxies_set_backend_service_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
project='project_value',target_tcp_proxy='target_tcp_proxy_value',target_tcp_proxies_set_proxy_header_request_resource=target_tcp_proxies_set_proxy_header_request_resource,        )
 ...
 in http_call[1] + str(body)
        assert 'target_tcp_proxy_value'
 in http_call[1] + str(body)
        assert compute.TargetTcpProxiesSetProxyHeaderRequest.to_json(target_tcp_proxies_set_proxy_header_request_resource, including_default_value_fields=False, use_integers_for_enums=False)
 in http_call[1] + str(body)
...
def test_target_tcp_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_tcp_proxies.transports.TargetTcpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_target_tcp_proxies_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_tcp_proxies.transports.TargetTcpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_target_tcp_proxies_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.target_tcp_proxies.transports.TargetTcpProxiesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.TargetTcpProxiesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_target_tcp_proxies_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        TargetTcpProxiesClient()
