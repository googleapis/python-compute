...
from google.cloud.compute_v1.services.target_tcp_proxies.transports.base import (
...
@pytest.mark.parametrize("client_class", [TargetTcpProxiesClient,])
def test_target_tcp_proxies_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_target_tcp_proxies_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        assert "target_tcp_proxy_value" in http_call[1] + str(body)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.insert(
            project="project_value",
            target_tcp_proxy_resource=target_tcp_proxy_resource,
        )
        ...
        body = http_params.get("data")
        assert "project_value" in http_call[1] + str(body)
        assert compute.TargetTcpProxy.to_json(
...
def test_list_rest(
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        return_value = compute.TargetTcpProxyList(
            id="id_value",
            items=[
                compute.TargetTcpProxy(creation_timestamp="creation_timestamp_value")
            ],
            kind="kind_value",
...
def test_set_backend_service_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.set_backend_service(
            project="project_value",
            target_tcp_proxy="target_tcp_proxy_value",
            target_tcp_proxies_set_backend_service_request_resource=target_tcp_proxies_set_backend_service_request_resource,
        )
        ...
        assert "project_value" in http_call[1] + str(body)
        assert "target_tcp_proxy_value" in http_call[1] + str(body)
        assert compute.TargetTcpProxiesSetBackendServiceRequest.to_json(
...
def test_set_proxy_header_rest_flattened():
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        client.set_proxy_header(
            project="project_value",
            target_tcp_proxy="target_tcp_proxy_value",
            target_tcp_proxies_set_proxy_header_request_resource=target_tcp_proxies_set_proxy_header_request_resource,
        )
        ...
        assert "project_value" in http_call[1] + str(body)
        assert "target_tcp_proxy_value" in http_call[1] + str(body)
        assert compute.TargetTcpProxiesSetProxyHeaderRequest.to_json(
