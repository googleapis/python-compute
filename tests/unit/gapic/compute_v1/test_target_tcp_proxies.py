...
def test_delete_unary_rest(request_type, transport: str = "rest"):
    ...
    request = compute.DeleteTargetTcpProxyRequest(
        {"project": "sample1", "target_tcp_proxy": "sample2"}
    )
...
@pytest.mark.parametrize(
    "request_type", [compute.SetBackendServiceTargetTcpProxyRequest, dict,]
)
...
@pytest.mark.parametrize(
    "request_type", [compute.SetProxyHeaderTargetTcpProxyRequest, dict,]
)
