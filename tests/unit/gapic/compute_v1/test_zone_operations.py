...
from google.cloud.compute_v1.services.zone_operations.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.zone_operations.transports.base import _GOOGLE_AUTH_VERSION
...
def test_zone_operations_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteZoneOperationRequest):
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetZoneOperationRequest):
    client = ZoneOperationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListZoneOperationsRequest):
    client = ZoneOperationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_wait_rest(transport: str = 'rest', request_type=compute.WaitZoneOperationRequest):
    client = ZoneOperationsClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_zone_operations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.zone_operations.transports.ZoneOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_zone_operations_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.zone_operations.transports.ZoneOperationsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.ZoneOperationsTransport()
        adc.assert_called_once()
