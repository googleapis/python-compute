...
from google.cloud.compute_v1.services.machine_types.transports.base import _API_CORE_VERSION
from google.cloud.compute_v1.services.machine_types.transports.base import _GOOGLE_AUTH_VERSION
...
def test_machine_types_client_from_service_account_info(client_class):
...
def test_machine_types_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_aggregated_list_rest(transport: str = 'rest', request_type=compute.AggregatedListMachineTypesRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.MachineTypeAggregatedList(
            id='id_value',
            items={'key_value': compute.MachineTypesScopedList(machine_types=[compute.MachineType(accelerators=[compute.Accelerators(guest_accelerator_count=2452)])])},
            kind='kind_value',
    ...
    assert response.items == {'key_value': compute.MachineTypesScopedList(machine_types=[compute.MachineType(accelerators=[compute.Accelerators(guest_accelerator_count=2452)])])}
...
def test_get_rest(transport: str = 'rest', request_type=compute.GetMachineTypeRequest):
    ...
    assert response.maximum_persistent_disks_size_gb == 'maximum_persistent_disks_size_gb_value'
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # using the keyword arguments to the method.
        client.get(
project='project_value',zone='zone_value',machine_type='machine_type_value',        )
...
def test_list_rest(transport: str = 'rest', request_type=compute.ListMachineTypesRequest):
    client = MachineTypesClient(
        credentials=credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        return_value = compute.MachineTypeList(
            id='id_value',
            items=[compute.MachineType(accelerators=[compute.Accelerators(guest_accelerator_count=2452)])],
            kind='kind_value',
            next_page_token='next_page_token_value',
            self_link='self_link_value',
            warning=compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED),
    ...
    assert response.id == 'id_value'
    assert response.items == [compute.MachineType(accelerators=[compute.Accelerators(guest_accelerator_count=2452)])]
    assert response.kind == 'kind_value'
    assert response.next_page_token == 'next_page_token_value'
    assert response.self_link == 'self_link_value'
    assert response.warning == compute.Warning(code=compute.Warning.Code.CLEANUP_FAILED)
...
def test_machine_types_base_transport_with_credentials_file():
    ...
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.machine_types.transports.MachineTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_machine_types_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.machine_types.transports.MachineTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (credentials.AnonymousCredentials(), None)
...
def test_machine_types_base_transport_with_adc():
    ...
    with mock.patch.object(auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.machine_types.transports.MachineTypesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transport = transports.MachineTypesTransport()
        adc.assert_called_once()
...
@requires_google_auth_lt_1_25_0
def test_machine_types_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(auth, 'default', autospec=True) as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        MachineTypesClient()
...
def test_machine_types_host_no_port():
    client = MachineTypesClient(
        credentials=credentials.AnonymousCredentials(),
...
def test_machine_types_host_with_port():
    client = MachineTypesClient(
        credentials=credentials.AnonymousCredentials(),
