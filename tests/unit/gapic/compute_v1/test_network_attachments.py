...
def test_insert_rest(request_type):
    ...
    test_field = compute.InsertNetworkAttachmentRequest.meta.fields[
    ...
    for subfield_to_delete in subfields_not_in_runtime:
        ...
        if subfield:
            if field_repeated:
                for i in range(
                    0, len(request_init["network_attachment_resource"][field])
                ):
...
def test_set_iam_policy_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.SetIamPolicyNetworkAttachmentRequest.meta.fields[
...
def test_test_iam_permissions_rest(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = compute.TestIamPermissionsNetworkAttachmentRequest.meta.fields[
