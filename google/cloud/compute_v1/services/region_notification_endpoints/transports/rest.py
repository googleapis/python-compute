...
from .base import RegionNotificationEndpointsTransport, DEFAULT_CLIENT_INFO
...
class RegionNotificationEndpointsRestTransport(RegionNotificationEndpointsTransport):
    ...
    def delete(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/notificationEndpoints/{notification_endpoint}".format(
            host=self._host,
        ...
        *,
        ...
        Returns:
            ~.compute.NotificationEndpoint:
                ...
                A notification endpoint resource defines an endpoint to
                receive notifications when there are status changes
                detected by the associated health check service.

                For more information, see Health checks overview. (==
                resource_for {$api_version}.notificationEndpoint ==) (==
    ...
    def insert(
        ...
        *,
        ...
        body = compute.NotificationEndpoint.to_json(
            request.notification_endpoint_resource, including_default_value_fields=False
        )

        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/notificationEndpoints".format(
