...
class RegionNotificationEndpointsClient(
    ...
    def transport(self) -> RegionNotificationEndpointsTransport:
        ...
        Returns:
            RegionNotificationEndpointsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region notification endpoints client.
    ...
    def delete(
        self,
        request: compute.DeleteRegionNotificationEndpointRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def get(
        self,
        request: compute.GetRegionNotificationEndpointRequest = None,
        *,
        project: str = None,
        region: str = None,
        notification_endpoint: str = None,
        ...
        Returns:
            google.cloud.compute_v1.types.NotificationEndpoint:
                Represents a notification endpoint.
                   ...
                   A notification endpoint resource defines an endpoint
                   to receive notifications when there are status
                   changes detected by the associated health check
                   service.
    ...
    def insert(
        self,
        request: compute.InsertRegionNotificationEndpointRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def list(
        self,
        request: compute.ListRegionNotificationEndpointsRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
