...
class InstanceTemplatesRestTransport(InstanceTemplatesTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__delete_required_fields_default_values.items()
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_iam_policy_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__get_iam_policy_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_iam_policy_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__set_iam_policy_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _test_iam_permissions_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InstanceTemplatesRestTransport.__test_iam_permissions_required_fields_default_values.items()
            if k not in message_dict
        }
