...
class RegionCommitmentsClient(metaclass=RegionCommitmentsClientMeta):
    ...
    def transport(self) -> RegionCommitmentsTransport:
        ...
        Returns:
            RegionCommitmentsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region commitments client.
    ...
    def aggregated_list(
        self,
        request: compute.AggregatedListRegionCommitmentsRequest = None,
        *,
        project: str = None,
    ...
    def get(
        self,
        request: compute.GetRegionCommitmentRequest = None,
        *,
        project: str = None,
        region: str = None,
        commitment: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.GetRegionCommitmentRequest):
                The request object.
                A request message for
    ...
    def insert(
        self,
        request: compute.InsertRegionCommitmentRequest = None,
        *,
        project: str = None,
        region: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.InsertRegionCommitmentRequest):
                The request object.
                A request message for
    ...
    def list(
        self,
        request: compute.ListRegionCommitmentsRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
