...
class PacketMirroringsClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[PacketMirroringsTransport]:
...
class PacketMirroringsClient(metaclass=PacketMirroringsClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the packet mirrorings client.
        ...
        if isinstance(transport, PacketMirroringsTransport):
        ...
        Returns:
            google.cloud.compute_v1.types.PacketMirroring:
                Represents a Packet Mirroring resource.
                   ...
                   and forwards it to a collector destination, such as
                   an instance group of an internal TCP/UDP load
                   balancer, for analysis or examination. For more
                   information about setting up Packet Mirroring, see
                   Using Packet Mirroring. (== resource_for
