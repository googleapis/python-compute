...
class VpnGatewaysRestTransport(VpnGatewaysTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_status_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__get_status_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_labels_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__set_labels_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _test_iam_permissions_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnGatewaysRestTransport.__test_iam_permissions_required_fields_default_values.items()
            if k not in message_dict
        }
