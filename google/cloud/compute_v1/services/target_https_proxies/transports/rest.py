...
class TargetHttpsProxiesRestTransport(TargetHttpsProxiesTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__patch_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_quic_override_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__set_quic_override_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_quic_override(
        ...
        *,
        ...
        query_params.update(
            self._set_quic_override_get_unset_required_fields(query_params)
        )
    ...
    def _set_ssl_certificates_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__set_ssl_certificates_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_ssl_policy_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__set_ssl_policy_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_url_map_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetHttpsProxiesRestTransport.__set_url_map_required_fields_default_values.items()
            if k not in message_dict
        }
