...
class RoutesRestTransport(RoutesTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RoutesRestTransport.__delete_required_fields_default_values.items()
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RoutesRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RoutesRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RoutesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        http_options = [
            {"method": "get", "uri": "/compute/v1/projects/{project}/global/routes",},
        ]
