...
class RoutesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[RoutesTransport]:
...
class RoutesClient(metaclass=RoutesClientMeta):
    ...
    def delete(
        self,
        request: compute.DeleteRouteRequest = None,
        *,
        project: str = None,
        route: str = None,
    ...
    def get(
        self,
        request: compute.GetRouteRequest = None,
        *,
        project: str = None,
        route: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        Returns:
            google.cloud.compute_v1.types.Route:
                Represents a Route resource.
                   ...
                   A route defines a path from VM instances in the VPC
                   network to a specific destination. This destination
                   can be inside or outside the VPC network. For more
    ...
    def insert(
        self,
        request: compute.InsertRouteRequest = None,
        *,
        project: str = None,
    ...
    def list(
        self,
        request: compute.ListRoutesRequest = None,
        *,
        project: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
