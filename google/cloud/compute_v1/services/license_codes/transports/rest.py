...
class LicenseCodesRestTransport(LicenseCodesTransport):
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in LicenseCodesRestTransport.__get_required_fields_default_values.items()
    ...
    def _test_iam_permissions_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in LicenseCodesRestTransport.__test_iam_permissions_required_fields_default_values.items()
            if k not in message_dict
        }
