...
class VpnTunnelsRestTransport(VpnTunnelsTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnTunnelsRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _aggregated_list(
        ...
        *,
        ...
        query_params = json.loads(
            compute.AggregatedListVpnTunnelsRequest.to_json(
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnTunnelsRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _delete(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.DeleteVpnTunnelRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnTunnelsRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.GetVpnTunnelRequest.to_json(
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnTunnelsRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert(
        ...
        *,
        ...
        body = compute.VpnTunnel.to_json(
            compute.VpnTunnel(transcoded_request["body"]),
            including_default_value_fields=False,
            use_integers_for_enums=False,
        )
        uri = transcoded_request["uri"]
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.InsertVpnTunnelRequest.to_json(
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in VpnTunnelsRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListVpnTunnelsRequest.to_json(
