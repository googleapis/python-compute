...
class TargetVpnGatewaysClient(metaclass=TargetVpnGatewaysClientMeta):
    ...
    def transport(self) -> TargetVpnGatewaysTransport:
        ...
        Returns:
            TargetVpnGatewaysTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the target vpn gateways client.
    ...
    def aggregated_list(
        self,
        request: compute.AggregatedListTargetVpnGatewaysRequest = None,
        *,
        project: str = None,
    ...
    def delete(
        self,
        request: compute.DeleteTargetVpnGatewayRequest = None,
        *,
        project: str = None,
        region: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.DeleteTargetVpnGatewayRequest):
                The request object.
                A request message for
    ...
    def get(
        self,
        request: compute.GetTargetVpnGatewayRequest = None,
        *,
        project: str = None,
        region: str = None,
        target_vpn_gateway: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.GetTargetVpnGatewayRequest):
                The request object.
                A request message for
    ...
    def insert(
        self,
        request: compute.InsertTargetVpnGatewayRequest = None,
        *,
        project: str = None,
        region: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.InsertTargetVpnGatewayRequest):
                The request object.
                A request message for
    ...
    def list(
        self,
        request: compute.ListTargetVpnGatewaysRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
