...
class RegionTargetHttpProxiesClient(metaclass=RegionTargetHttpProxiesClientMeta):
    ...
    def transport(self) -> RegionTargetHttpProxiesTransport:
        ...
        Returns:
            RegionTargetHttpProxiesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region target http proxies client.
        ...
        Args:
            ...
            transport (Union[str, RegionTargetHttpProxiesTransport]): The
        ...
        if isinstance(transport, RegionTargetHttpProxiesTransport):
    ...
    def delete(
        self,
        request: compute.DeleteRegionTargetHttpProxyRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def get(
        self,
        request: compute.GetRegionTargetHttpProxyRequest = None,
        *,
        project: str = None,
        region: str = None,
        target_http_proxy: str = None,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetRegionTargetHttpProxyRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert(
        self,
        request: compute.InsertRegionTargetHttpProxyRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def list(
        self,
        request: compute.ListRegionTargetHttpProxiesRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListRegionTargetHttpProxiesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def set_url_map(
        self,
        request: compute.SetUrlMapRegionTargetHttpProxyRequest = None,
        *,
        project: str = None,
        region: str = None,
        target_http_proxy: str = None,
