...
class NodeTemplatesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[NodeTemplatesTransport]:
...
class NodeTemplatesClient(metaclass=NodeTemplatesClientMeta):
    ...
    def transport(self) -> NodeTemplatesTransport:
        ...
        Returns:
            NodeTemplatesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the node templates client.
        ...
        Returns:
            google.cloud.compute_v1.types.NodeTemplate:
                Represent a sole-tenant Node Template resource.
                   ...
                   You can use a template to define properties for nodes
                   in a node group. For more information, read Creating
                   node groups and instances. (== resource_for
