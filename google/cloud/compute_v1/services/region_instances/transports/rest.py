...
from .base import RegionInstancesTransport, DEFAULT_CLIENT_INFO
...
class RegionInstancesRestTransport(RegionInstancesTransport):
    ...
    def bulk_insert(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/instances/bulkInsert".format(
        ...
        query_params = {}
        if compute.BulkInsertRegionInstanceRequest.request_id in request:
