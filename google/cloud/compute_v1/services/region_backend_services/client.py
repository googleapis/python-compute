...
class RegionBackendServicesClient(metaclass=RegionBackendServicesClientMeta):
    ...
    def transport(self) -> RegionBackendServicesTransport:
        ...
        Returns:
            RegionBackendServicesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region backend services client.
    ...
    def delete(
        self,
        request: compute.DeleteRegionBackendServiceRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def get(
        self,
        request: compute.GetRegionBackendServiceRequest = None,
        *,
        project: str = None,
        region: str = None,
        backend_service: str = None,
    ...
    def get_health(
        self,
        request: compute.GetHealthRegionBackendServiceRequest = None,
        *,
        project: str = None,
        region: str = None,
        backend_service: str = None,
    ...
    def insert(
        self,
        request: compute.InsertRegionBackendServiceRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def list(
        self,
        request: compute.ListRegionBackendServicesRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
    ...
    def patch(
        self,
        request: compute.PatchRegionBackendServiceRequest = None,
        *,
        project: str = None,
        region: str = None,
        backend_service: str = None,
    ...
    def update(
        self,
        request: compute.UpdateRegionBackendServiceRequest = None,
        *,
        project: str = None,
        region: str = None,
        backend_service: str = None,
