...
class SslCertificatesRestTransport(SslCertificatesTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in SslCertificatesRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _aggregated_list(
        ...
        *,
        ...
        query_params = json.loads(
            compute.AggregatedListSslCertificatesRequest.to_json(
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in SslCertificatesRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _delete(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.DeleteSslCertificateRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in SslCertificatesRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.GetSslCertificateRequest.to_json(
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in SslCertificatesRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.InsertSslCertificateRequest.to_json(
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in SslCertificatesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListSslCertificatesRequest.to_json(
