...
class SslCertificatesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[SslCertificatesTransport]]
    _transport_registry["rest"] = SslCertificatesRestTransport

    def get_transport_class(cls, label: str = None,) -> Type[SslCertificatesTransport]:
...
class SslCertificatesClient(metaclass=SslCertificatesClientMeta):
    ...
    def transport(self) -> SslCertificatesTransport:
        ...
        Returns:
            SslCertificatesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the ssl certificates client.
        ...
        Args:
            ...
            transport (Union[str, SslCertificatesTransport]): The
        ...
        if isinstance(transport, SslCertificatesTransport):
    ...
    def aggregated_list(
        ...
        *,
        ...
        # in a compute.AggregatedListSslCertificatesRequest.
    ...
    def get(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetSslCertificateRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListSslCertificatesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
