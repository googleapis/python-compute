...
class RegionNetworkEndpointGroupsRestTransport(RegionNetworkEndpointGroupsTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RegionNetworkEndpointGroupsRestTransport.__delete_required_fields_default_values.items()
    ...
    def _delete(
        ...
        *,
        ...
        request_kwargs = compute.DeleteRegionNetworkEndpointGroupRequest.to_dict(
            request
        )
        ...
        query_params = json.loads(
            compute.DeleteRegionNetworkEndpointGroupRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RegionNetworkEndpointGroupsRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RegionNetworkEndpointGroupsRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert(
        ...
        *,
        ...
        request_kwargs = compute.InsertRegionNetworkEndpointGroupRequest.to_dict(
            request
        )
        transcoded_request = path_template.transcode(http_options, **request_kwargs)
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.InsertRegionNetworkEndpointGroupRequest.to_json(
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RegionNetworkEndpointGroupsRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListRegionNetworkEndpointGroupsRequest.to_json(
