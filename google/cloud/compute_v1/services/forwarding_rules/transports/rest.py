...
class ForwardingRulesRestTransport(ForwardingRulesTransport):
    ...
    def aggregated_list(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/aggregated/forwardingRules".format(
    ...
    def delete(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/forwardingRules/{forwarding_rule}".format(
            host=self._host,
    ...
    def insert(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/forwardingRules".format(
    ...
    def set_labels(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/forwardingRules/{resource}/setLabels".format(
            host=self._host,
            project=request.project,
            region=request.region,
        ...
        #               not required for GCE
        query_params = {}
        if compute.SetLabelsForwardingRuleRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def set_target(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}/forwardingRules/{forwarding_rule}/setTarget".format(
            host=self._host,
            project=request.project,
            region=request.region,
            forwarding_rule=request.forwarding_rule,
