...
class RegionSslCertificatesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RegionSslCertificatesTransport]]
...
class RegionSslCertificatesClient(metaclass=RegionSslCertificatesClientMeta):
    ...
    def transport(self) -> RegionSslCertificatesTransport:
        ...
        Returns:
            RegionSslCertificatesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region ssl certificates client.
