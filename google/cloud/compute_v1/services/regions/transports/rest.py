...
class RegionsRestTransport(RegionsTransport):
        ...
        *,
        ...
        Returns:
            ~.compute.Region:
                ...
                located. For more information, read Regions and Zones.
        ...
        url = "https://{host}/compute/v1/projects/{project}/regions/{region}".format(
    ...
    def list(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/regions".format(
