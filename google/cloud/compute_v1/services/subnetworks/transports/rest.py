        ...
        *,
        ...
        Returns:
            ~.compute.Subnetwork:
                ...
                primary IP range and zero or more secondary IP ranges.
                For more information, read Virtual Private Cloud (VPC)
                Network. (== resource_for {$api_version}.subnetworks ==)
    ...
    def insert(
        ...
        *,
        ...
        body = compute.Subnetwork.to_json(
            request.subnetwork_resource, including_default_value_fields=False
        )
