...
class GlobalPublicDelegatedPrefixesClient(
    ...
    def transport(self) -> GlobalPublicDelegatedPrefixesTransport:
        ...
        Returns:
            GlobalPublicDelegatedPrefixesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, GlobalPublicDelegatedPrefixesTransport, None] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiate the global public delegated prefixes client.
        ...
        Args:
            ...
            transport (Union[str, GlobalPublicDelegatedPrefixesTransport]): The
        ...
        if isinstance(transport, GlobalPublicDelegatedPrefixesTransport):
    ...
    def delete(
        self,
        request: compute.DeleteGlobalPublicDelegatedPrefixeRequest = None,
        *,
        project: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.DeleteGlobalPublicDelegatedPrefixeRequest):
    ...
    def get(
        self,
        request: compute.GetGlobalPublicDelegatedPrefixeRequest = None,
        *,
        project: str = None,
        public_delegated_prefix: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (google.cloud.compute_v1.types.GetGlobalPublicDelegatedPrefixeRequest):
                The request object. A request message for
                GlobalPublicDelegatedPrefixes.Get. See the method
                description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetGlobalPublicDelegatedPrefixeRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert(
        self,
        request: compute.InsertGlobalPublicDelegatedPrefixeRequest = None,
        *,
        project: str = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.InsertGlobalPublicDelegatedPrefixeRequest):
                The request object. A request message for
    ...
    def list(
        self,
        request: compute.ListGlobalPublicDelegatedPrefixesRequest = None,
        *,
        project: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.ListGlobalPublicDelegatedPrefixesRequest):
                The request object. A request message for
                GlobalPublicDelegatedPrefixes.List. See the method
                description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListGlobalPublicDelegatedPrefixesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def patch(
        self,
        request: compute.PatchGlobalPublicDelegatedPrefixeRequest = None,
        *,
        project: str = None,
        public_delegated_prefix: str = None,
        public_delegated_prefix_resource: compute.PublicDelegatedPrefix = None,
        ...
        Args:
            request (google.cloud.compute_v1.types.PatchGlobalPublicDelegatedPrefixeRequest):
                The request object. A request message for
