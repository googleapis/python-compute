...
class ZonesRestTransport(ZonesTransport):
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ZonesRestTransport.__get_required_fields_default_values.items()
    ...
    def _get(
        ...
        *,
        ...
        http_options = [
            {"method": "get", "uri": "/compute/v1/projects/{project}/zones/{zone}",},
        ]
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ZonesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
