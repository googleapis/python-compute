...
class NetworksRestTransport(NetworksTransport):
    ...
    def _add_peering_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__add_peering_required_fields_default_values.items()
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_effective_firewalls_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__get_effective_firewalls_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_peering_routes_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__list_peering_routes_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_peering_routes(
        ...
        *,
        ...
        query_params.update(
            self._list_peering_routes_get_unset_required_fields(query_params)
        )
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__patch_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _remove_peering_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__remove_peering_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _remove_peering(
        ...
        *,
        ...
        query_params.update(
            self._remove_peering_get_unset_required_fields(query_params)
        )
    ...
    def _switch_to_custom_mode_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__switch_to_custom_mode_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _switch_to_custom_mode(
        ...
        *,
        ...
        query_params.update(
            self._switch_to_custom_mode_get_unset_required_fields(query_params)
        )
    ...
    def _update_peering_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in NetworksRestTransport.__update_peering_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _update_peering(
        ...
        *,
        ...
        query_params.update(
            self._update_peering_get_unset_required_fields(query_params)
        )
