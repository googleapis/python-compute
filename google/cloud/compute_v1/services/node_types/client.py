...
class NodeTypesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[NodeTypesTransport]:
...
class NodeTypesClient(metaclass=NodeTypesClientMeta):
    ...
    def transport(self) -> NodeTypesTransport:
        ...
        Returns:
            NodeTypesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the node types client.
        ...
        Args:
            ...
            transport (Union[str, NodeTypesTransport]): The
        ...
        if isinstance(transport, NodeTypesTransport):
    ...
    def aggregated_list(
        self,
        request: compute.AggregatedListNodeTypesRequest = None,
        *,
        project: str = None,
        ...
        # in a compute.AggregatedListNodeTypesRequest.
    ...
    def get(
        self,
        request: compute.GetNodeTypeRequest = None,
        *,
        project: str = None,
        zone: str = None,
        node_type: str = None,
        ...
        Returns:
            google.cloud.compute_v1.types.NodeType:
                Represent a sole-tenant Node Type resource.
                   ...
                   A node type specifies the total amount of cores and
                   memory for that node. Currently, the only available
                   node type is n1-node-96-624 node type that has 96
                   vCPUs and 624 GB of memory, available in multiple
                   zones. For more information read Node types. (==
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetNodeTypeRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(
        self,
        request: compute.ListNodeTypesRequest = None,
        *,
        project: str = None,
        zone: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListNodeTypesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
