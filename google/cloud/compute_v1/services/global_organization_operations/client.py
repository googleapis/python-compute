...
class GlobalOrganizationOperationsClient(
    ...
    def transport(self) -> GlobalOrganizationOperationsTransport:
        ...
        Returns:
            GlobalOrganizationOperationsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the global organization operations client.
    ...
    def delete(
        self,
        request: compute.DeleteGlobalOrganizationOperationRequest = None,
        *,
        operation: str = None,
    ...
    def list(
        self,
        request: compute.ListGlobalOrganizationOperationsRequest = None,
        *,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        metadata: Sequence[Tuple[str, str]] = (),
