...
class AutoscalersRestTransport(AutoscalersTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__patch_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _update_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in AutoscalersRestTransport.__update_required_fields_default_values.items()
            if k not in message_dict
        }
