...
class ProjectsRestTransport(ProjectsTransport):
    ...
    def _disable_xpn_host_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__disable_xpn_host_required_fields_default_values.items()
    ...
    def _disable_xpn_host(
        ...
        *,
        ...
        query_params.update(
            self._disable_xpn_host_get_unset_required_fields(query_params)
        )
    ...
    def _disable_xpn_resource_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__disable_xpn_resource_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _disable_xpn_resource(
        ...
        *,
        ...
        query_params.update(
            self._disable_xpn_resource_get_unset_required_fields(query_params)
        )
    ...
    def _enable_xpn_host_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__enable_xpn_host_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _enable_xpn_host(
        ...
        *,
        ...
        query_params.update(
            self._enable_xpn_host_get_unset_required_fields(query_params)
        )
    ...
    def _enable_xpn_resource_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__enable_xpn_resource_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _enable_xpn_resource(
        ...
        *,
        ...
        query_params.update(
            self._enable_xpn_resource_get_unset_required_fields(query_params)
        )
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_xpn_host_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__get_xpn_host_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_xpn_resources_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__get_xpn_resources_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_xpn_resources(
        ...
        *,
        ...
        query_params.update(
            self._get_xpn_resources_get_unset_required_fields(query_params)
        )
    ...
    def _list_xpn_hosts_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__list_xpn_hosts_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_xpn_hosts(
        ...
        *,
        ...
        query_params.update(
            self._list_xpn_hosts_get_unset_required_fields(query_params)
        )
    ...
    def _move_disk_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__move_disk_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _move_instance_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__move_instance_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_common_instance_metadata_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__set_common_instance_metadata_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_common_instance_metadata(
        ...
        *,
        ...
        query_params.update(
            self._set_common_instance_metadata_get_unset_required_fields(query_params)
        )
    ...
    def _set_default_network_tier_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__set_default_network_tier_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_default_network_tier(
        ...
        *,
        ...
        query_params.update(
            self._set_default_network_tier_get_unset_required_fields(query_params)
        )
    ...
    def _set_usage_export_bucket_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in ProjectsRestTransport.__set_usage_export_bucket_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_usage_export_bucket(
        ...
        *,
        ...
        query_params.update(
            self._set_usage_export_bucket_get_unset_required_fields(query_params)
        )
