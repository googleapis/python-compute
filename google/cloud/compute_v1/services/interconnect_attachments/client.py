...
class InterconnectAttachmentsClient(metaclass=InterconnectAttachmentsClientMeta):
    ...
    def transport(self) -> InterconnectAttachmentsTransport:
        ...
        Returns:
            InterconnectAttachmentsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the interconnect attachments client.
    ...
    def aggregated_list(
        self,
        request: compute.AggregatedListInterconnectAttachmentsRequest = None,
        *,
        project: str = None,
    ...
    def delete(
        self,
        request: compute.DeleteInterconnectAttachmentRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def get(
        self,
        request: compute.GetInterconnectAttachmentRequest = None,
        *,
        project: str = None,
        region: str = None,
        interconnect_attachment: str = None,
        ...
        Returns:
            google.cloud.compute_v1.types.InterconnectAttachment:
                Represents an Interconnect Attachment (VLAN) resource.
                   ...
                   You can use Interconnect attachments (VLANS) to
                   connect your Virtual Private Cloud networks to your
                   on-premises networks through an Interconnect. For
    ...
    def insert(
        self,
        request: compute.InsertInterconnectAttachmentRequest = None,
        *,
        project: str = None,
        region: str = None,
    ...
    def list(
        self,
        request: compute.ListInterconnectAttachmentsRequest = None,
        *,
        project: str = None,
        region: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
    ...
    def patch(
        self,
        request: compute.PatchInterconnectAttachmentRequest = None,
        *,
        project: str = None,
        region: str = None,
        interconnect_attachment: str = None,
