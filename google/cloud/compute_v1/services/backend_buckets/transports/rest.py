...
class BackendBucketsRestTransport(BackendBucketsTransport):
    ...
    def _add_signed_url_key_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__add_signed_url_key_required_fields_default_values.items()
    ...
    def _add_signed_url_key(
        ...
        *,
        ...
        query_params = json.loads(
            compute.AddSignedUrlKeyBackendBucketRequest.to_json(
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _delete(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.DeleteBackendBucketRequest.to_json(
    ...
    def _delete_signed_url_key_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__delete_signed_url_key_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _delete_signed_url_key(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.DeleteSignedUrlKeyBackendBucketRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.GetBackendBucketRequest.to_json(
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert(
        ...
        *,
        ...
        body = compute.BackendBucket.to_json(
            compute.BackendBucket(transcoded_request["body"]),
            including_default_value_fields=False,
            use_integers_for_enums=False,
        )
        uri = transcoded_request["uri"]
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.InsertBackendBucketRequest.to_json(
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListBackendBucketsRequest.to_json(
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__patch_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _patch(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.PatchBackendBucketRequest.to_json(
    ...
    def _update_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in BackendBucketsRestTransport.__update_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _update(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.UpdateBackendBucketRequest.to_json(
