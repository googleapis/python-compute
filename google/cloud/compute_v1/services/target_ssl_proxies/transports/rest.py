...
class TargetSslProxiesRestTransport(TargetSslProxiesTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__delete_required_fields_default_values.items()
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_backend_service_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__set_backend_service_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_proxy_header_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__set_proxy_header_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_proxy_header(
        ...
        *,
        ...
        body = compute.TargetSslProxiesSetProxyHeaderRequest.to_json(
            compute.TargetSslProxiesSetProxyHeaderRequest(transcoded_request["body"]),
            including_default_value_fields=False,
            use_integers_for_enums=False,
        )
        uri = transcoded_request["uri"]
    ...
    def _set_ssl_certificates_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__set_ssl_certificates_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_ssl_policy_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in TargetSslProxiesRestTransport.__set_ssl_policy_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _set_ssl_policy(
        ...
        *,
        ...
        query_params.update(
            self._set_ssl_policy_get_unset_required_fields(query_params)
        )
