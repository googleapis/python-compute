...
class RegionDiskTypesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[RegionDiskTypesTransport]]
    _transport_registry["rest"] = RegionDiskTypesRestTransport

    def get_transport_class(cls, label: str = None,) -> Type[RegionDiskTypesTransport]:
...
class RegionDiskTypesClient(metaclass=RegionDiskTypesClientMeta):
    ...
    def transport(self) -> RegionDiskTypesTransport:
        ...
        Returns:
            RegionDiskTypesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the region disk types client.
