...
class RegionDiskTypesRestTransport(RegionDiskTypesTransport):
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RegionDiskTypesRestTransport.__get_required_fields_default_values.items()
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in RegionDiskTypesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListRegionDiskTypesRequest.to_json(
