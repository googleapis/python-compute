...
class TargetGrpcProxiesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[TargetGrpcProxiesTransport]]
...
class TargetGrpcProxiesClient(metaclass=TargetGrpcProxiesClientMeta):
    ...
    def transport(self) -> TargetGrpcProxiesTransport:
        ...
        Returns:
            TargetGrpcProxiesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the target grpc proxies client.
        ...
        Returns:
            google.cloud.compute_v1.types.TargetGrpcProxy:
                Represents a Target gRPC Proxy resource.
                   ...
                   intended for load balancing gRPC traffic. Global
                   forwarding rules reference a target gRPC proxy. The
                   Target gRPC Proxy references a URL map which
                   specifies how traffic routes to gRPC backend
