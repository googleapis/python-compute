...
class TargetGrpcProxiesRestTransport(TargetGrpcProxiesTransport):
    ...
    def delete(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/global/targetGrpcProxies/{target_grpc_proxy}".format(
            host=self._host,
        ...
        query_params = {}
        if compute.DeleteTargetGrpcProxyRequest.request_id in request:
    ...
    def insert(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/global/targetGrpcProxies".format(
        ...
        #               not required for GCE
        query_params = {}
        if compute.InsertTargetGrpcProxyRequest.request_id in request:
            query_params["requestId"] = request.request_id
    ...
    def list(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.ListTargetGrpcProxiesRequest.filter in request:
            query_params["filter"] = request.filter
        if compute.ListTargetGrpcProxiesRequest.max_results in request:
            query_params["maxResults"] = request.max_results
        if compute.ListTargetGrpcProxiesRequest.order_by in request:
            query_params["orderBy"] = request.order_by
        if compute.ListTargetGrpcProxiesRequest.page_token in request:
            query_params["pageToken"] = request.page_token
        if compute.ListTargetGrpcProxiesRequest.return_partial_success in request:
    ...
    def patch(
        ...
        *,
        ...
        #               not required for GCE
        query_params = {}
        if compute.PatchTargetGrpcProxyRequest.request_id in request:
            query_params["requestId"] = request.request_id
