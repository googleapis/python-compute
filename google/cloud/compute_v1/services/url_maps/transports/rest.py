...
class UrlMapsRestTransport(UrlMapsTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__delete_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _invalidate_cache_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__invalidate_cache_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _invalidate_cache(
        ...
        *,
        ...
        query_params.update(
            self._invalidate_cache_get_unset_required_fields(query_params)
        )
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__patch_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _update_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__update_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _validate_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in UrlMapsRestTransport.__validate_required_fields_default_values.items()
            if k not in message_dict
        }
