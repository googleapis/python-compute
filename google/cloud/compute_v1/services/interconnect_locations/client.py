...
class InterconnectLocationsClient(metaclass=InterconnectLocationsClientMeta):
    ...
    def transport(self) -> InterconnectLocationsTransport:
        ...
        Returns:
            InterconnectLocationsTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the interconnect locations client.
        ...
        Args:
            ...
            transport (Union[str, InterconnectLocationsTransport]): The
        ...
        if isinstance(transport, InterconnectLocationsTransport):
    ...
    def get(
        ...
        *,
        ...
        has_flattened_params = any([project, interconnect_location])
        ...
        # in a compute.GetInterconnectLocationRequest.
    ...
    def list(
        ...
        *,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListInterconnectLocationsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
