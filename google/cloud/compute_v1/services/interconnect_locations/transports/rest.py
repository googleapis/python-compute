...
class InterconnectLocationsRestTransport(InterconnectLocationsTransport):
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectLocationsRestTransport.__get_required_fields_default_values.items()
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectLocationsRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
