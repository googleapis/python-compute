...
class RegionOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[compute.DeleteRegionOperationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.GetRegionOperationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.ListRegionOperationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_wait(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.WaitRegionOperationRequest, Sequence[Tuple[str, str]]]:
