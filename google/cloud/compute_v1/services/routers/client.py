...
class RoutersClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[RoutersTransport]:
...
class RoutersClient(metaclass=RoutersClientMeta):
    ...
    def transport(self) -> RoutersTransport:
        ...
        Returns:
            RoutersTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the routers client.
        ...
        if isinstance(transport, RoutersTransport):
