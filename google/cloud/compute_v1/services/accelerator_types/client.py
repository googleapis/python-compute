...
class AcceleratorTypesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[AcceleratorTypesTransport]:
...
class AcceleratorTypesClient(metaclass=AcceleratorTypesClientMeta):
    ...
    def transport(self) -> AcceleratorTypesTransport:
        ...
        Returns:
            AcceleratorTypesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the accelerator types client.
        ...
        Returns:
            google.cloud.compute_v1.types.AcceleratorType:
                Represents an Accelerator Type resource.
                   ...
                   Google Cloud Platform provides graphics processing
                   units (accelerators) that you can add to VM instances
                   to improve or accelerate performance when working
                   with intensive workloads. For more information, read
                   GPUs on Compute Engine. (== resource_for
