...
class DiskTypesRestTransport(DiskTypesTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in DiskTypesRestTransport.__aggregated_list_required_fields_default_values.items()
    ...
    def _aggregated_list(
        ...
        *,
        ...
        query_params = json.loads(
            compute.AggregatedListDiskTypesRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in DiskTypesRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in DiskTypesRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListDiskTypesRequest.to_json(
