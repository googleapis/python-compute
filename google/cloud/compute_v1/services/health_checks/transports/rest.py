...
class HealthChecksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[compute.AggregatedListHealthChecksRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.DeleteHealthCheckRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.GetHealthCheckRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.InsertHealthCheckRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.ListHealthChecksRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.PatchHealthCheckRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[compute.UpdateHealthCheckRequest, Sequence[Tuple[str, str]]]:
