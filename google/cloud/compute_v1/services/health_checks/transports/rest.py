...
class HealthChecksRestTransport(HealthChecksTransport):
    ...
    def aggregated_list(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/aggregated/healthChecks".format(
    ...
    def delete(
        ...
        *,
        ...
        url = "https://{host}/compute/v1/projects/{project}/global/healthChecks/{health_check}".format(
            host=self._host, project=request.project, health_check=request.health_check,
        )
    ...
    def insert(
        ...
        *,
        ...
        # TODO(yon-mg): need to handle grpc transcoding and parse url correctly
        #               current impl assumes basic case of grpc transcoding
        url = "https://{host}/compute/v1/projects/{project}/global/healthChecks".format(
            host=self._host, project=request.project,
        )
