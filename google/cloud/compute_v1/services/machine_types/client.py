...
class MachineTypesClientMeta(type):
    ...
    def get_transport_class(cls, label: str = None,) -> Type[MachineTypesTransport]:
...
class MachineTypesClient(metaclass=MachineTypesClientMeta):
    ...
    def transport(self) -> MachineTypesTransport:
        ...
        Returns:
            MachineTypesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the machine types client.
        ...
        Args:
            ...
            transport (Union[str, MachineTypesTransport]): The
        ...
        if isinstance(transport, MachineTypesTransport):
    ...
    def aggregated_list(
        self,
        request: compute.AggregatedListMachineTypesRequest = None,
        *,
        project: str = None,
        ...
        # in a compute.AggregatedListMachineTypesRequest.
    ...
    def get(
        self,
        request: compute.GetMachineTypeRequest = None,
        *,
        project: str = None,
        zone: str = None,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetMachineTypeRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(
        self,
        request: compute.ListMachineTypesRequest = None,
        *,
        project: str = None,
        zone: str = None,
        retry: retries.Retry = gapic_v1.method.DEFAULT,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListMachineTypesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
