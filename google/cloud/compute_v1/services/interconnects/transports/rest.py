...
class InterconnectsRestTransport(InterconnectsTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectsRestTransport.__delete_required_fields_default_values.items()
    ...
    def _delete(
        ...
        *,
        ...
        query_params = json.loads(
            compute.DeleteInterconnectRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectsRestTransport.__get_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.GetInterconnectRequest.to_json(
    ...
    def _get_diagnostics_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectsRestTransport.__get_diagnostics_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _get_diagnostics(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.GetDiagnosticsInterconnectRequest.to_json(
        ...
        query_params.update(
            self._get_diagnostics_get_unset_required_fields(query_params)
        )
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectsRestTransport.__insert_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _insert(
        ...
        *,
        ...
        body = compute.Interconnect.to_json(
            compute.Interconnect(transcoded_request["body"]),
            including_default_value_fields=False,
            use_integers_for_enums=False,
        )
        uri = transcoded_request["uri"]
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.InsertInterconnectRequest.to_json(
    ...
    def _list_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectsRestTransport.__list_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _list(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.ListInterconnectsRequest.to_json(
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {
            k: v
            for k, v in InterconnectsRestTransport.__patch_required_fields_default_values.items()
            if k not in message_dict
        }
    ...
    def _patch(
        ...
        *,
        ...
        # Jsonify the query params
        query_params = json.loads(
            compute.PatchInterconnectRequest.to_json(
