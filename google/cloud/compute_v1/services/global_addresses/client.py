...
class GlobalAddressesClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[GlobalAddressesTransport]]
    _transport_registry["rest"] = GlobalAddressesRestTransport

    def get_transport_class(cls, label: str = None,) -> Type[GlobalAddressesTransport]:
...
class GlobalAddressesClient(metaclass=GlobalAddressesClientMeta):
    ...
    def transport(self) -> GlobalAddressesTransport:
        ...
        Returns:
            GlobalAddressesTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the global addresses client.
