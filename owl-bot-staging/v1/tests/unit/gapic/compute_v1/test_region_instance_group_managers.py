...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "returnPartialSuccess", "orderBy", "pageToken", "maxResults", )) & set(("project", "region", )))
...
def test_list_errors_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orderBy", "returnPartialSuccess", "filter", "pageToken", "maxResults", )) & set(("instanceGroupManager", "project", "region", )))
