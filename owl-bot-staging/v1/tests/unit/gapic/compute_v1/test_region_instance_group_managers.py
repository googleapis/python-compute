...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxResults", "filter", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("project", "region", )))
...
def test_list_errors_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxResults", "filter", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("instanceGroupManager", "project", "region", )))
