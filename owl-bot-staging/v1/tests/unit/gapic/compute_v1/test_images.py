...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteImageRequest({'project': 'sample1', 'image': 'sample2'})
...
def test_deprecate_unary_rest(request_type, transport: str = 'rest'):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.DeprecateImageRequest({'project': 'sample1', 'image': 'sample2'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetImageRequest({'project': 'sample1', 'image': 'sample2'})
...
def test_get_from_family_rest(request_type, transport: str = 'rest'):
    client = ImagesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.GetFromFamilyImageRequest({'project': 'sample1', 'family': 'sample2'})
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyImageRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertImageRequest({'project': 'sample1'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListImagesRequest({'project': 'sample1'})
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchImageRequest({'project': 'sample1', 'image': 'sample2'})
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyImageRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_set_labels_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetLabelsImageRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsImageRequest({'project': 'sample1', 'resource': 'sample2'})
