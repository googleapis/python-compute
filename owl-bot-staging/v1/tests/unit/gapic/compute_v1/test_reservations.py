...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteReservationRequest):
    client = ReservationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertReservationRequest):
    client = ReservationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["reservation_resource"] = compute.Reservation(commitment='commitment_value')
    request = request_type(request_init)
...
def test_resize_unary_rest(transport: str = 'rest', request_type=compute.ResizeReservationRequest):
    client = ReservationsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "reservation": "sample3"}
    request_init["reservations_resize_request_resource"] = compute.ReservationsResizeRequest(specific_sku_count=1920)
    request = request_type(request_init)
