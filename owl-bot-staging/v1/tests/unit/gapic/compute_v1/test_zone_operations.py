...
def test_delete_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteZoneOperationRequest({'project': 'sample1', 'zone': 'sample2', 'operation': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetZoneOperationRequest({'project': 'sample1', 'zone': 'sample2', 'operation': 'sample3'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListZoneOperationsRequest({'project': 'sample1', 'zone': 'sample2'})
...
def test_wait_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.WaitZoneOperationRequest({'project': 'sample1', 'zone': 'sample2', 'operation': 'sample3'})
