...
def test_list_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orderBy", "returnPartialSuccess", "filter", "pageToken", "maxResults", )) & set(("instanceGroup", "project", "region", "regionInstanceGroupsListInstancesRequestResource", )))
