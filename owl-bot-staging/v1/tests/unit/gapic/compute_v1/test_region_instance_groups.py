...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.GetRegionInstanceGroupRequest({'project': 'sample1', 'region': 'sample2', 'instance_group': 'sample3'})
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/instanceGroups/{instance_group}" % client.transport._host, args[1])
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionInstanceGroupsRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/instanceGroups" % client.transport._host, args[1])
...
def test_list_instances_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListInstancesRegionInstanceGroupsRequest({'project': 'sample1', 'region': 'sample2', 'instance_group': 'sample3'})
...
def test_list_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/instanceGroups/{instance_group}/listInstances" % client.transport._host, args[1])
...
def test_set_named_ports_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetNamedPortsRegionInstanceGroupRequest({'project': 'sample1', 'region': 'sample2', 'instance_group': 'sample3'})
...
def test_set_named_ports_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/instanceGroups/{instance_group}/setNamedPorts" % client.transport._host, args[1])
