...
from google.cloud.compute_v1.services.region_security_policies import RegionSecurityPoliciesClient
from google.cloud.compute_v1.services.region_security_policies import pagers
from google.cloud.compute_v1.services.region_security_policies import transports
...
def test_region_security_policies_client_from_service_account_info(client_class):
...
def test_region_security_policies_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_region_security_policies_host_no_port():
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_region_security_policies_host_with_port():
    client = RegionSecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
