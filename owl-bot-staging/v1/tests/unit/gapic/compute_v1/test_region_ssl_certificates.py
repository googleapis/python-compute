...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteRegionSslCertificateRequest({'project': 'sample1', 'region': 'sample2', 'ssl_certificate': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRegionSslCertificateRequest({'project': 'sample1', 'region': 'sample2', 'ssl_certificate': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertRegionSslCertificateRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionSslCertificatesRequest({'project': 'sample1', 'region': 'sample2'})
