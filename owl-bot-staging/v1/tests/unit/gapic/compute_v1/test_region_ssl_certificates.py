...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteRegionSslCertificateRequest):
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteRegionSslCertificateRequest):
    ...
    assert "sslCertificate" not in jsonified_request
    ...
    assert jsonified_request["sslCertificate"] == request_init["ssl_certificate"]
...
def test_delete_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/sslCertificates/{ssl_certificate}" % client.transport._host, args[1])
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertRegionSslCertificateRequest):
    client = RegionSslCertificatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/sslCertificates" % client.transport._host, args[1])
