...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AggregatedListVpnGatewaysRequest({'project': 'sample1'})
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteVpnGatewayRequest({'project': 'sample1', 'region': 'sample2', 'vpn_gateway': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetVpnGatewayRequest({'project': 'sample1', 'region': 'sample2', 'vpn_gateway': 'sample3'})
...
def test_get_status_rest(request_type, transport: str = 'rest'):
    client = VpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.GetStatusVpnGatewayRequest({'project': 'sample1', 'region': 'sample2', 'vpn_gateway': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertVpnGatewayRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListVpnGatewaysRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_set_labels_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetLabelsVpnGatewayRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsVpnGatewayRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
