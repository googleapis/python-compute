...
def test_list_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "returnPartialSuccess", "orderBy", "pageToken", "maxResults", )) & set(("instanceGroup", "instanceGroupsListInstancesRequestResource", "project", "zone", )))
