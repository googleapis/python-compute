...
def test_add_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_add_instances") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_add_instances") as pre:
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_list") as post, \
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_list_instances") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_list_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_remove_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_remove_instances") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_remove_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_named_ports_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "post_set_named_ports") as post, \
         mock.patch.object(transports.InstanceGroupsRestInterceptor, "pre_set_named_ports") as pre:
        pre.assert_not_called()
        post.assert_not_called()
