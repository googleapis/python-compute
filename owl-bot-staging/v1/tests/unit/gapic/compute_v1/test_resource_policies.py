...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AggregatedListResourcePoliciesRequest({'project': 'sample1'})
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/resourcePolicies" % client.transport._host, args[1])
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteResourcePolicyRequest({'project': 'sample1', 'region': 'sample2', 'resource_policy': 'sample3'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteResourcePolicyRequest):
    ...
    assert "resourcePolicy" not in jsonified_request
    ...
    assert jsonified_request["resourcePolicy"] == request_init["resource_policy"]
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource_policy}" % client.transport._host, args[1])
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetResourcePolicyRequest({'project': 'sample1', 'region': 'sample2', 'resource_policy': 'sample3'})
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyResourcePolicyRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertResourcePolicyRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies" % client.transport._host, args[1])
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListResourcePoliciesRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyResourcePolicyRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsResourcePolicyRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/resourcePolicies/{resource}/testIamPermissions" % client.transport._host, args[1])
