...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertResourcePolicyRequest):
    client = ResourcePoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["resource_policy_resource"] = compute.ResourcePolicy(creation_timestamp='creation_timestamp_value')
    request = request_type(request_init)
