...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteRegionNetworkEndpointGroupRequest({'project': 'sample1', 'region': 'sample2', 'network_endpoint_group': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRegionNetworkEndpointGroupRequest({'project': 'sample1', 'region': 'sample2', 'network_endpoint_group': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertRegionNetworkEndpointGroupRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionNetworkEndpointGroupsRequest({'project': 'sample1', 'region': 'sample2'})
