...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteRegionNetworkEndpointGroupRequest):
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertRegionNetworkEndpointGroupRequest):
    client = RegionNetworkEndpointGroupsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
