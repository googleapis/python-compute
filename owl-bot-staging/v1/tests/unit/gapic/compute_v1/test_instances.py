...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).aggregated_list._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "max_results", "return_partial_success", "order_by", "page_token", "include_all_scopes", ))
    jsonified_request.update(unset_fields)
...
def test_aggregated_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "returnPartialSuccess", "orderBy", "pageToken", "includeAllScopes", )) & set(("project", )))
...
def test_delete_access_config_unary_rest_required_fields(request_type=compute.DeleteAccessConfigInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_access_config._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("network_interface", "access_config", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_access_config_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("networkInterface", "accessConfig", "requestId", )) & set(("accessConfig", "instance", "networkInterface", "project", "zone", )))
...
def test_get_guest_attributes_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("variableKey", "queryPath", )) & set(("instance", "project", "zone", )))
...
def test_get_serial_port_output_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("start", "port", )) & set(("instance", "project", "zone", )))
...
def test_insert_unary_rest_required_fields(request_type=compute.InsertInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).insert._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("source_instance_template", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_insert_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("sourceInstanceTemplate", "requestId", )) & set(("instanceResource", "project", "zone", )))
...
def test_list_rest_required_fields(request_type=compute.ListInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "return_partial_success", "order_by", "page_token", "max_results", ))
    jsonified_request.update(unset_fields)
...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "returnPartialSuccess", "orderBy", "pageToken", "maxResults", )) & set(("project", "zone", )))
...
def test_list_referrers_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "returnPartialSuccess", "orderBy", "pageToken", "maxResults", )) & set(("instance", "project", "zone", )))
...
def test_set_disk_auto_delete_unary_rest_required_fields(request_type=compute.SetDiskAutoDeleteInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_disk_auto_delete._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("device_name", "auto_delete", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_set_disk_auto_delete_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deviceName", "autoDelete", "requestId", )) & set(("autoDelete", "deviceName", "instance", "project", "zone", )))
