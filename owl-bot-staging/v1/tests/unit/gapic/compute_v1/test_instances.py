...
def test_instances_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_add_access_config_rest(request_type):
    ...
    request_init["access_config_resource"] = {'external_ipv6': 'external_ipv6_value', 'external_ipv6_prefix_length': 2837, 'kind': 'kind_value', 'name': 'name_value', 'nat_i_p': 'nat_i_p_value', 'network_tier': 'network_tier_value', 'public_ptr_domain_name': 'public_ptr_domain_name_value', 'set_public_ptr': True, 'type_': 'type__value'}
...
def test_add_access_config_rest_required_fields(request_type=compute.AddAccessConfigInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).add_access_config._get_unset_required_fields(jsonified_request)
...
def test_add_access_config_rest_unset_required_fields():
    transport = transports.InstancesRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.add_access_config._get_unset_required_fields({})
    assert set(unset_fields) == (set(("networkInterface", "requestId", )) & set(("accessConfigResource", "instance", "networkInterface", "project", "zone", )))
...
def test_add_access_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.InstancesRestInterceptor, "post_add_access_config") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_add_access_config") as pre:
        ...
        client.add_access_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_add_access_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/addAccessConfig" % client.transport._host, args[1])
...
def test_add_access_config_unary_rest_required_fields(request_type=compute.AddAccessConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_add_access_config_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.add_access_config_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_add_access_config_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AddAccessConfigInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_resource_policies_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_add_resource_policies_request_resource"] = {'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2']}
    request = request_type(request_init)
...
def test_add_resource_policies_rest_required_fields(request_type=compute.AddResourcePoliciesInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_add_resource_policies_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesAddResourcePoliciesRequestResource", "project", "zone", )))
...
def test_add_resource_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_add_resource_policies") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_add_resource_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_add_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/addResourcePolicies" % client.transport._host, args[1])
...
def test_add_resource_policies_unary_rest_required_fields(request_type=compute.AddResourcePoliciesInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_add_resource_policies_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AddResourcePoliciesInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListInstancesRequest):
    transport_class = transports.InstancesRestTransport
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceAggregatedList.to_json(compute.InstanceAggregatedList())
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/aggregated/instances" % client.transport._host, args[1])
...
def test_attach_disk_rest_required_fields(request_type=compute.AttachDiskInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).attach_disk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_attach_disk_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("forceAttach", "requestId", )) & set(("attachedDiskResource", "instance", "project", "zone", )))
...
def test_attach_disk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_attach_disk") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_attach_disk") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.attach_disk(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_attach_disk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            ...
            zone='zone_value',
            instance='instance_value',
            attached_disk_resource=compute.AttachedDisk(architecture='architecture_value'),
        )
        mock_args.update(sample_request)
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/attachDisk" % client.transport._host, args[1])
...
def test_attach_disk_unary_rest_required_fields(request_type=compute.AttachDiskInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_attach_disk_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.attach_disk_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_attach_disk_unary_rest_bad_request(transport: str = 'rest', request_type=compute.AttachDiskInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_bulk_insert_rest_required_fields(request_type=compute.BulkInsertInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_bulk_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("bulkInsertInstanceResourceResource", "project", "zone", )))
...
def test_bulk_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_bulk_insert") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_bulk_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_bulk_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/bulkInsert" % client.transport._host, args[1])
...
def test_bulk_insert_unary_rest_required_fields(request_type=compute.BulkInsertInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_bulk_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.BulkInsertInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "project", "zone", )))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}" % client.transport._host, args[1])
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_access_config_rest_required_fields(request_type=compute.DeleteAccessConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_access_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_access_config._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("access_config", "network_interface", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_delete_access_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("accessConfig", "networkInterface", "requestId", )) & set(("accessConfig", "instance", "networkInterface", "project", "zone", )))
...
def test_delete_access_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_delete_access_config") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_delete_access_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_access_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_access_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/deleteAccessConfig" % client.transport._host, args[1])
...
def test_delete_access_config_unary_rest_required_fields(request_type=compute.DeleteAccessConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_delete_access_config_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.delete_access_config_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_access_config_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteAccessConfigInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_detach_disk_rest_required_fields(request_type=compute.DetachDiskInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).detach_disk._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_detach_disk_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deviceName", "requestId", )) & set(("deviceName", "instance", "project", "zone", )))
...
def test_detach_disk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_detach_disk") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_detach_disk") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.detach_disk(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_detach_disk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/detachDisk" % client.transport._host, args[1])
...
def test_detach_disk_unary_rest_required_fields(request_type=compute.DetachDiskInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_detach_disk_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.detach_disk_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_detach_disk_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DetachDiskInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_effective_firewalls_rest_required_fields(request_type=compute.GetEffectiveFirewallsInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_get_effective_firewalls_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("networkInterface", )) & set(("instance", "networkInterface", "project", "zone", )))
...
def test_get_effective_firewalls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_effective_firewalls") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_effective_firewalls") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstancesGetEffectiveFirewallsResponse.to_json(compute.InstancesGetEffectiveFirewallsResponse())
...
def test_get_effective_firewalls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/getEffectiveFirewalls" % client.transport._host, args[1])
...
def test_get_guest_attributes_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("queryPath", "variableKey", )) & set(("instance", "project", "zone", )))
...
def test_get_guest_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_guest_attributes") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_guest_attributes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.GuestAttributes.to_json(compute.GuestAttributes())
...
def test_get_guest_attributes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/getGuestAttributes" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_required_fields(request_type=compute.GetIamPolicyInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_get_screenshot_rest_required_fields(request_type=compute.GetScreenshotInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_screenshot._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_screenshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_screenshot") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_screenshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_screenshot(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_screenshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/screenshot" % client.transport._host, args[1])
...
def test_get_serial_port_output_rest_required_fields(request_type=compute.GetSerialPortOutputInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_serial_port_output._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_serial_port_output_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("port", "start", )) & set(("instance", "project", "zone", )))
...
def test_get_serial_port_output_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_serial_port_output") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_serial_port_output") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.SerialPortOutput.to_json(compute.SerialPortOutput())
        ...
        client.get_serial_port_output(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_serial_port_output_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/serialPort" % client.transport._host, args[1])
...
def test_get_shielded_instance_identity_rest_required_fields(request_type=compute.GetShieldedInstanceIdentityInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_shielded_instance_identity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_shielded_instance_identity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_get_shielded_instance_identity") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_get_shielded_instance_identity") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.ShieldedInstanceIdentity.to_json(compute.ShieldedInstanceIdentity())
        ...
        client.get_shielded_instance_identity(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_shielded_instance_identity_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/getShieldedInstanceIdentity" % client.transport._host, args[1])
...
def test_insert_rest_required_fields(request_type=compute.InsertInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).insert._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "source_instance_template", "source_machine_image", ))
    jsonified_request.update(unset_fields)
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "sourceInstanceTemplate", "sourceMachineImage", )) & set(("instanceResource", "project", "zone", )))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances" % client.transport._host, args[1])
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_referrers_rest_required_fields(request_type=compute.ListReferrersInstancesRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_referrers._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_referrers_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("instance", "project", "zone", )))
...
def test_list_referrers_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_list_referrers") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_list_referrers") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceListReferrers.to_json(compute.InstanceListReferrers())
        ...
        client.list_referrers(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_referrers_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/referrers" % client.transport._host, args[1])
...
def test_remove_resource_policies_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_remove_resource_policies_request_resource"] = {'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2']}
    request = request_type(request_init)
...
def test_remove_resource_policies_rest_required_fields(request_type=compute.RemoveResourcePoliciesInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_remove_resource_policies_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesRemoveResourcePoliciesRequestResource", "project", "zone", )))
...
def test_remove_resource_policies_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_remove_resource_policies") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_remove_resource_policies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_remove_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/removeResourcePolicies" % client.transport._host, args[1])
...
def test_remove_resource_policies_unary_rest_required_fields(request_type=compute.RemoveResourcePoliciesInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_remove_resource_policies_unary_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveResourcePoliciesInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_reset_rest_required_fields(request_type=compute.ResetInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_reset") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_reset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.reset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_reset_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/reset" % client.transport._host, args[1])
...
def test_reset_unary_rest_bad_request(transport: str = 'rest', request_type=compute.ResetInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_rest_required_fields(request_type=compute.ResumeInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).resume._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_resume") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_resume") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.resume(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_resume_rest_bad_request(transport: str = 'rest', request_type=compute.ResumeInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/resume" % client.transport._host, args[1])
...
def test_resume_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.resume_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_resume_unary_rest_bad_request(transport: str = 'rest', request_type=compute.ResumeInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_send_diagnostic_interrupt_rest_required_fields(request_type=compute.SendDiagnosticInterruptInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).send_diagnostic_interrupt._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_send_diagnostic_interrupt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_send_diagnostic_interrupt") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_send_diagnostic_interrupt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.SendDiagnosticInterruptInstanceResponse.to_json(compute.SendDiagnosticInterruptInstanceResponse())
        ...
        client.send_diagnostic_interrupt(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_send_diagnostic_interrupt_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/sendDiagnosticInterrupt" % client.transport._host, args[1])
...
def test_set_deletion_protection_rest_required_fields(request_type=compute.SetDeletionProtectionInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_deletion_protection._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_deletion_protection_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deletionProtection", "requestId", )) & set(("project", "resource", "zone", )))
...
def test_set_deletion_protection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_deletion_protection") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_deletion_protection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_deletion_protection(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_deletion_protection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{resource}/setDeletionProtection" % client.transport._host, args[1])
...
def test_set_deletion_protection_unary_rest_required_fields(request_type=compute.SetDeletionProtectionInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_deletion_protection_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_deletion_protection_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_deletion_protection_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetDeletionProtectionInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_disk_auto_delete_rest_required_fields(request_type=compute.SetDiskAutoDeleteInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_disk_auto_delete._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_disk_auto_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("autoDelete", "deviceName", "requestId", )) & set(("autoDelete", "deviceName", "instance", "project", "zone", )))
...
def test_set_disk_auto_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_disk_auto_delete") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_disk_auto_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_disk_auto_delete(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_disk_auto_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setDiskAutoDelete" % client.transport._host, args[1])
...
def test_set_disk_auto_delete_unary_rest_required_fields(request_type=compute.SetDiskAutoDeleteInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_disk_auto_delete_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_disk_auto_delete_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_disk_auto_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetDiskAutoDeleteInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_required_fields(request_type=compute.SetIamPolicyInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_set_labels_request_resource"] = {'label_fingerprint': 'label_fingerprint_value', 'labels': {}}
    request = request_type(request_init)
...
def test_set_labels_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesSetLabelsRequestResource", "project", "zone", )))
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_labels") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_labels_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setLabels" % client.transport._host, args[1])
...
def test_set_labels_unary_rest_required_fields(request_type=compute.SetLabelsInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_labels_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetLabelsInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_machine_resources_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_set_machine_resources_request_resource"] = {'guest_accelerators': [{'accelerator_count': 1805, 'accelerator_type': 'accelerator_type_value'}]}
    request = request_type(request_init)
...
def test_set_machine_resources_rest_required_fields(request_type=compute.SetMachineResourcesInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_machine_resources._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_machine_resources_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesSetMachineResourcesRequestResource", "project", "zone", )))
...
def test_set_machine_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_machine_resources") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_machine_resources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_machine_resources(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_machine_resources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setMachineResources" % client.transport._host, args[1])
...
def test_set_machine_resources_unary_rest_required_fields(request_type=compute.SetMachineResourcesInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_machine_resources_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_machine_resources_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_machine_resources_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetMachineResourcesInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_machine_type_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_set_machine_type_request_resource"] = {'machine_type': 'machine_type_value'}
    request = request_type(request_init)
...
def test_set_machine_type_rest_required_fields(request_type=compute.SetMachineTypeInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_machine_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_machine_type_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesSetMachineTypeRequestResource", "project", "zone", )))
...
def test_set_machine_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_machine_type") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_machine_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_machine_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_machine_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setMachineType" % client.transport._host, args[1])
...
def test_set_machine_type_unary_rest_required_fields(request_type=compute.SetMachineTypeInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_machine_type_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_machine_type_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_machine_type_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetMachineTypeInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_metadata_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["metadata_resource"] = {'fingerprint': 'fingerprint_value', 'items': [{'key': 'key_value', 'value': 'value_value'}], 'kind': 'kind_value'}
    request = request_type(request_init)
...
def test_set_metadata_rest_required_fields(request_type=compute.SetMetadataInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_metadata._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_metadata_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "metadataResource", "project", "zone", )))
...
def test_set_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_metadata") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_metadata(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_metadata_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setMetadata" % client.transport._host, args[1])
...
def test_set_metadata_unary_rest_required_fields(request_type=compute.SetMetadataInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_metadata_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_metadata_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_metadata_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetMetadataInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_min_cpu_platform_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_set_min_cpu_platform_request_resource"] = {'min_cpu_platform': 'min_cpu_platform_value'}
    request = request_type(request_init)
...
def test_set_min_cpu_platform_rest_required_fields(request_type=compute.SetMinCpuPlatformInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_min_cpu_platform._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_min_cpu_platform_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesSetMinCpuPlatformRequestResource", "project", "zone", )))
...
def test_set_min_cpu_platform_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_min_cpu_platform") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_min_cpu_platform") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_min_cpu_platform(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_min_cpu_platform_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setMinCpuPlatform" % client.transport._host, args[1])
...
def test_set_min_cpu_platform_unary_rest_required_fields(request_type=compute.SetMinCpuPlatformInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_min_cpu_platform_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_min_cpu_platform_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_min_cpu_platform_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetMinCpuPlatformInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_scheduling_rest_required_fields(request_type=compute.SetSchedulingInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_scheduling._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_scheduling_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "project", "schedulingResource", "zone", )))
...
def test_set_scheduling_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_scheduling") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_scheduling") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_scheduling(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_scheduling_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setScheduling" % client.transport._host, args[1])
...
def test_set_scheduling_unary_rest_required_fields(request_type=compute.SetSchedulingInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_scheduling_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_scheduling_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_scheduling_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetSchedulingInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_service_account_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_set_service_account_request_resource"] = {'email': 'email_value', 'scopes': ['scopes_value_1', 'scopes_value_2']}
    request = request_type(request_init)
...
def test_set_service_account_rest_required_fields(request_type=compute.SetServiceAccountInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_service_account._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_service_account_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesSetServiceAccountRequestResource", "project", "zone", )))
...
def test_set_service_account_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_service_account") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_service_account") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_service_account(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_service_account_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setServiceAccount" % client.transport._host, args[1])
...
def test_set_service_account_unary_rest_required_fields(request_type=compute.SetServiceAccountInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_service_account_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_service_account_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_service_account_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetServiceAccountInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_shielded_instance_integrity_policy_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["shielded_instance_integrity_policy_resource"] = {'update_auto_learn_policy': True}
    request = request_type(request_init)
...
def test_set_shielded_instance_integrity_policy_rest_required_fields(request_type=compute.SetShieldedInstanceIntegrityPolicyInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_shielded_instance_integrity_policy._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_shielded_instance_integrity_policy_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "project", "shieldedInstanceIntegrityPolicyResource", "zone", )))
...
def test_set_shielded_instance_integrity_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_shielded_instance_integrity_policy") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_shielded_instance_integrity_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_shielded_instance_integrity_policy(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_shielded_instance_integrity_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setShieldedInstanceIntegrityPolicy" % client.transport._host, args[1])
...
def test_set_shielded_instance_integrity_policy_unary_rest_required_fields(request_type=compute.SetShieldedInstanceIntegrityPolicyInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
@pytest.mark.parametrize("null_interceptor", [True, False])
def test_set_shielded_instance_integrity_policy_unary_rest_interceptors(null_interceptor):
    transport = transports.InstancesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InstancesRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_shielded_instance_integrity_policy_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_shielded_instance_integrity_policy_unary_rest_flattened_error(transport: str = 'rest'):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_tags_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["tags_resource"] = {'fingerprint': 'fingerprint_value', 'items': ['items_value_1', 'items_value_2']}
    request = request_type(request_init)
...
def test_set_tags_rest_required_fields(request_type=compute.SetTagsInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_tags._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_tags_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "project", "tagsResource", "zone", )))
...
def test_set_tags_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_set_tags") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_set_tags") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_tags(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_tags_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/setTags" % client.transport._host, args[1])
...
def test_set_tags_unary_rest_required_fields(request_type=compute.SetTagsInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_set_tags_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_tags_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_set_tags_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SetTagsInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_simulate_maintenance_event_rest_required_fields(request_type=compute.SimulateMaintenanceEventInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_simulate_maintenance_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_simulate_maintenance_event") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_simulate_maintenance_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_simulate_maintenance_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/simulateMaintenanceEvent" % client.transport._host, args[1])
...
def test_simulate_maintenance_event_unary_rest_required_fields(request_type=compute.SimulateMaintenanceEventInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_simulate_maintenance_event_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SimulateMaintenanceEventInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_rest_required_fields(request_type=compute.StartInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_start") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_start") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.start(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_start_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/start" % client.transport._host, args[1])
...
def test_start_unary_rest_bad_request(transport: str = 'rest', request_type=compute.StartInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_with_encryption_key_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["instances_start_with_encryption_key_request_resource"] = {'disks': [{'disk_encryption_key': {'kms_key_name': 'kms_key_name_value', 'kms_key_service_account': 'kms_key_service_account_value', 'raw_key': 'raw_key_value', 'rsa_encrypted_key': 'rsa_encrypted_key_value', 'sha256': 'sha256_value'}, 'source': 'source_value'}]}
    request = request_type(request_init)
...
def test_start_with_encryption_key_rest_required_fields(request_type=compute.StartWithEncryptionKeyInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start_with_encryption_key._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_with_encryption_key_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "instancesStartWithEncryptionKeyRequestResource", "project", "zone", )))
...
def test_start_with_encryption_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_start_with_encryption_key") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_start_with_encryption_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.start_with_encryption_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_start_with_encryption_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/startWithEncryptionKey" % client.transport._host, args[1])
...
def test_start_with_encryption_key_unary_rest_required_fields(request_type=compute.StartWithEncryptionKeyInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_start_with_encryption_key_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.start_with_encryption_key_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_start_with_encryption_key_unary_rest_bad_request(transport: str = 'rest', request_type=compute.StartWithEncryptionKeyInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_rest_required_fields(request_type=compute.StopInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).stop._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_stop") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_stop") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.stop(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/stop" % client.transport._host, args[1])
...
def test_stop_unary_rest_bad_request(transport: str = 'rest', request_type=compute.StopInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_suspend_rest_required_fields(request_type=compute.SuspendInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).suspend._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_suspend_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_suspend") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_suspend") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.suspend(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_suspend_rest_bad_request(transport: str = 'rest', request_type=compute.SuspendInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_suspend_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/suspend" % client.transport._host, args[1])
...
def test_suspend_unary_rest_required_fields(request_type=compute.SuspendInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_suspend_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.suspend_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_suspend_unary_rest_bad_request(transport: str = 'rest', request_type=compute.SuspendInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_required_fields(request_type=compute.TestIamPermissionsInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_rest_required_fields(request_type=compute.UpdateInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("minimal_action", "most_disruptive_allowed_action", "request_id", ))
    jsonified_request.update(unset_fields)
...
def test_update_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("minimalAction", "mostDisruptiveAllowedAction", "requestId", )) & set(("instance", "instanceResource", "project", "zone", )))
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_update") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_access_config_rest_required_fields(request_type=compute.UpdateAccessConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_access_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_access_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_update_access_config") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_update_access_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_access_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_access_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/updateAccessConfig" % client.transport._host, args[1])
...
def test_update_access_config_unary_rest_required_fields(request_type=compute.UpdateAccessConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_update_access_config_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_access_config_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_display_device_rest_required_fields(request_type=compute.UpdateDisplayDeviceInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_display_device._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_display_device_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("displayDeviceResource", "instance", "project", "zone", )))
...
def test_update_display_device_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_update_display_device") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_update_display_device") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_display_device(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_display_device_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/updateDisplayDevice" % client.transport._host, args[1])
...
def test_update_display_device_unary_rest_required_fields(request_type=compute.UpdateDisplayDeviceInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_update_display_device_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_display_device_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_display_device_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateDisplayDeviceInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_network_interface_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["network_interface_resource"] = {'access_configs': [{'external_ipv6': 'external_ipv6_value', 'external_ipv6_prefix_length': 2837, 'kind': 'kind_value', 'name': 'name_value', 'nat_i_p': 'nat_i_p_value', 'network_tier': 'network_tier_value', 'public_ptr_domain_name': 'public_ptr_domain_name_value', 'set_public_ptr': True, 'type_': 'type__value'}], 'alias_ip_ranges': [{'ip_cidr_range': 'ip_cidr_range_value', 'subnetwork_range_name': 'subnetwork_range_name_value'}], 'fingerprint': 'fingerprint_value', 'internal_ipv6_prefix_length': 2831, 'ipv6_access_configs': {}, 'ipv6_access_type': 'ipv6_access_type_value', 'ipv6_address': 'ipv6_address_value', 'kind': 'kind_value', 'name': 'name_value', 'network': 'network_value', 'network_i_p': 'network_i_p_value', 'nic_type': 'nic_type_value', 'queue_count': 1197, 'stack_type': 'stack_type_value', 'subnetwork': 'subnetwork_value'}
    request = request_type(request_init)
...
def test_update_network_interface_rest_required_fields(request_type=compute.UpdateNetworkInterfaceInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_network_interface._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_network_interface_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("networkInterface", "requestId", )) & set(("instance", "networkInterface", "networkInterfaceResource", "project", "zone", )))
...
def test_update_network_interface_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_update_network_interface") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_update_network_interface") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_network_interface(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_network_interface_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/updateNetworkInterface" % client.transport._host, args[1])
...
def test_update_network_interface_unary_rest_required_fields(request_type=compute.UpdateNetworkInterfaceInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_update_network_interface_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_network_interface_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_network_interface_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateNetworkInterfaceInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_shielded_instance_config_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance': 'sample3'}
    request_init["shielded_instance_config_resource"] = {'enable_integrity_monitoring': True, 'enable_secure_boot': True, 'enable_vtpm': True}
    request = request_type(request_init)
...
def test_update_shielded_instance_config_rest_required_fields(request_type=compute.UpdateShieldedInstanceConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_shielded_instance_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_shielded_instance_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("instance", "project", "shieldedInstanceConfigResource", "zone", )))
...
def test_update_shielded_instance_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstancesRestInterceptor, "post_update_shielded_instance_config") as post, \
         mock.patch.object(transports.InstancesRestInterceptor, "pre_update_shielded_instance_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_shielded_instance_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_shielded_instance_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/instances/{instance}/updateShieldedInstanceConfig" % client.transport._host, args[1])
...
def test_update_shielded_instance_config_unary_rest_required_fields(request_type=compute.UpdateShieldedInstanceConfigInstanceRequest):
    transport_class = transports.InstancesRestTransport
...
def test_update_shielded_instance_config_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_shielded_instance_config_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_shielded_instance_config_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateShieldedInstanceConfigInstanceRequest):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_shielded_instance_config_unary_rest_flattened_error(transport: str = 'rest'):
    client = InstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
