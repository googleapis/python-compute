...
def test_add_access_config_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "networkInterface", )) & set(("accessConfigResource", "instance", "networkInterface", "project", "zone", )))
...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).aggregated_list._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("order_by", "include_all_scopes", "return_partial_success", "filter", "page_token", "max_results", ))
    jsonified_request.update(unset_fields)
...
def test_aggregated_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orderBy", "includeAllScopes", "returnPartialSuccess", "filter", "pageToken", "maxResults", )) & set(("project", )))
...
def test_attach_disk_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "forceAttach", )) & set(("attachedDiskResource", "instance", "project", "zone", )))
...
def test_delete_access_config_unary_rest_required_fields(request_type=compute.DeleteAccessConfigInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_access_config._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "access_config", "network_interface", ))
    jsonified_request.update(unset_fields)
...
def test_delete_access_config_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "accessConfig", "networkInterface", )) & set(("accessConfig", "instance", "networkInterface", "project", "zone", )))
...
def test_detach_disk_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "deviceName", )) & set(("deviceName", "instance", "project", "zone", )))
...
def test_list_referrers_rest_required_fields(request_type=compute.ListReferrersInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_referrers._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("order_by", "return_partial_success", "filter", "page_token", "max_results", ))
    jsonified_request.update(unset_fields)
...
def test_list_referrers_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orderBy", "returnPartialSuccess", "filter", "pageToken", "maxResults", )) & set(("instance", "project", "zone", )))
...
def test_set_deletion_protection_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "deletionProtection", )) & set(("project", "resource", "zone", )))
...
def test_set_disk_auto_delete_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "autoDelete", "deviceName", )) & set(("autoDelete", "deviceName", "instance", "project", "zone", )))
...
def test_update_unary_rest_required_fields(request_type=compute.UpdateInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("request_id", "most_disruptive_allowed_action", "minimal_action", ))
    jsonified_request.update(unset_fields)
...
def test_update_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "mostDisruptiveAllowedAction", "minimalAction", )) & set(("instance", "instanceResource", "project", "zone", )))
...
def test_update_network_interface_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "networkInterface", )) & set(("instance", "networkInterface", "networkInterfaceResource", "project", "zone", )))
