...
def test_aggregated_list_rest_required_fields(request_type=compute.AggregatedListInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).aggregated_list._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("max_results", "include_all_scopes", "filter", "order_by", "page_token", "return_partial_success", ))
    jsonified_request.update(unset_fields)
...
def test_aggregated_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxResults", "includeAllScopes", "filter", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("project", )))
...
def test_delete_access_config_unary_rest_required_fields(request_type=compute.DeleteAccessConfigInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_access_config._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("access_config", "request_id", "network_interface", ))
    jsonified_request.update(unset_fields)
...
def test_delete_access_config_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("accessConfig", "requestId", "networkInterface", )) & set(("accessConfig", "instance", "networkInterface", "project", "zone", )))
...
def test_list_rest_required_fields(request_type=compute.ListInstancesRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("max_results", "filter", "order_by", "page_token", "return_partial_success", ))
    jsonified_request.update(unset_fields)
...
def test_list_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxResults", "filter", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("project", "zone", )))
...
def test_list_referrers_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxResults", "filter", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("instance", "project", "zone", )))
...
def test_set_disk_auto_delete_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("deviceName", "requestId", "autoDelete", )) & set(("autoDelete", "deviceName", "instance", "project", "zone", )))
...
def test_update_unary_rest_required_fields(request_type=compute.UpdateInstanceRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("minimal_action", "request_id", "most_disruptive_allowed_action", ))
    jsonified_request.update(unset_fields)
...
def test_update_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("minimalAction", "requestId", "mostDisruptiveAllowedAction", )) & set(("instance", "instanceResource", "project", "zone", )))
