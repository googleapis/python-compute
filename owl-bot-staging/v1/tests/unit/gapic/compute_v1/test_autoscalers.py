...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/autoscalers" % client.transport._host, args[1])
...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/autoscalers/{autoscaler}" % client.transport._host, args[1])
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/autoscalers" % client.transport._host, args[1])
...
def test_patch_unary_rest(transport: str = 'rest', request_type=compute.PatchAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_unary_rest(transport: str = 'rest', request_type=compute.UpdateAutoscalerRequest):
    client = AutoscalersClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
