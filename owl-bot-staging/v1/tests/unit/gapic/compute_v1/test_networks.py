...
def test_add_peering_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("network", "networksAddPeeringRequestResource", "project", )))
...
def test_add_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NetworksRestInterceptor, "post_add_peering") as post, \
        ...
        client.add_peering(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_add_peering_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}/addPeering" % client.transport._host, args[1])
...
def test_add_peering_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.add_peering_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}" % client.transport._host, args[1])
...
def test_get_effective_firewalls_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworksRestInterceptor, "post_get_effective_firewalls") as post, \
         mock.patch.object(transports.NetworksRestInterceptor, "pre_get_effective_firewalls") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.NetworksGetEffectiveFirewallsResponse.to_json(compute.NetworksGetEffectiveFirewallsResponse())
...
def test_get_effective_firewalls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}/getEffectiveFirewalls" % client.transport._host, args[1])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("networkResource", "project", )))
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks" % client.transport._host, args[1])
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, compute.Network)
                for i in results)
...
def test_list_peering_routes_rest_required_fields(request_type=compute.ListPeeringRoutesNetworksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_peering_routes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_peering_routes._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("direction", "filter", "max_results", "order_by", "page_token", "peering_name", "region", "return_partial_success", ))
    jsonified_request.update(unset_fields)
...
def test_list_peering_routes_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("direction", "filter", "maxResults", "orderBy", "pageToken", "peeringName", "region", "returnPartialSuccess", )) & set(("network", "project", )))
...
def test_list_peering_routes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworksRestInterceptor, "post_list_peering_routes") as post, \
         mock.patch.object(transports.NetworksRestInterceptor, "pre_list_peering_routes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.ExchangedPeeringRoutesList.to_json(compute.ExchangedPeeringRoutesList())
        ...
        client.list_peering_routes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_peering_routes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}/listPeeringRoutes" % client.transport._host, args[1])
...
def test_list_peering_routes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, compute.ExchangedPeeringRoute)
                for i in results)
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("network", "networkResource", "project", )))
...
def test_remove_peering_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["networks_remove_peering_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_remove_peering_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("network", "networksRemovePeeringRequestResource", "project", )))
...
def test_remove_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworksRestInterceptor, "post_remove_peering") as post, \
         mock.patch.object(transports.NetworksRestInterceptor, "pre_remove_peering") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.remove_peering(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_remove_peering_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}/removePeering" % client.transport._host, args[1])
...
def test_remove_peering_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.remove_peering_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_switch_to_custom_mode_rest_required_fields(request_type=compute.SwitchToCustomModeNetworkRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).switch_to_custom_mode._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_switch_to_custom_mode_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworksRestInterceptor, "post_switch_to_custom_mode") as post, \
         mock.patch.object(transports.NetworksRestInterceptor, "pre_switch_to_custom_mode") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.switch_to_custom_mode(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_switch_to_custom_mode_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}/switchToCustomMode" % client.transport._host, args[1])
...
def test_switch_to_custom_mode_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.switch_to_custom_mode_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_peering_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'network': 'sample2'}
    request_init["networks_update_peering_request_resource"] = {'network_peering': {'auto_create_routes': True, 'exchange_subnet_routes': True, 'export_custom_routes': True, 'export_subnet_routes_with_public_ip': True, 'import_custom_routes': True, 'import_subnet_routes_with_public_ip': True, 'name': 'name_value', 'network': 'network_value', 'peer_mtu': 865, 'stack_type': 'stack_type_value', 'state': 'state_value', 'state_details': 'state_details_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["networks_update_peering_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_update_peering_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("network", "networksUpdatePeeringRequestResource", "project", )))
...
def test_update_peering_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworksRestInterceptor, "post_update_peering") as post, \
         mock.patch.object(transports.NetworksRestInterceptor, "pre_update_peering") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_peering(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_peering_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/networks/{network}/updatePeering" % client.transport._host, args[1])
...
def test_update_peering_unary_rest(request_type):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_peering_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.update_peering_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_peering_unary_rest_error():
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_networks_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.networks.transports.NetworksTransport.__init__') as Transport:
...
def test_networks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.networks.transports.NetworksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_networks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.networks.transports.NetworksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworksTransport()
        adc.assert_called_once()
