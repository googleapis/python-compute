...
def test_add_peering_unary_rest(transport: str = 'rest', request_type=compute.AddPeeringNetworkRequest):
    ...
    request_init["networks_add_peering_request_resource"] = compute.NetworksAddPeeringRequest(auto_create_routes=True)
...
def test_get_effective_firewalls_rest(transport: str = 'rest', request_type=compute.GetEffectiveFirewallsNetworkRequest):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertNetworkRequest):
    ...
    request_init["network_resource"] = compute.Network(I_pv4_range='I_pv4_range_value')
    request = request_type(request_init)
...
def test_list_peering_routes_rest_flattened(transport: str = 'rest'):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_peering_unary_rest(transport: str = 'rest', request_type=compute.RemovePeeringNetworkRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "network": "sample2"}
    request_init["networks_remove_peering_request_resource"] = compute.NetworksRemovePeeringRequest(name='name_value')
    request = request_type(request_init)
...
def test_update_peering_unary_rest(transport: str = 'rest', request_type=compute.UpdatePeeringNetworkRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "network": "sample2"}
    request_init["networks_update_peering_request_resource"] = compute.NetworksUpdatePeeringRequest(network_peering=compute.NetworkPeering(auto_create_routes=True))
    request = request_type(request_init)
