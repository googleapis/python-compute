...
def test_networks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_add_peering_unary_rest(request_type, transport: str = 'rest'):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.AddPeeringNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_get_effective_firewalls_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetEffectiveFirewallsNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_get_effective_firewalls_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/networks/{network}/getEffectiveFirewalls" % client.transport._host, args[1])
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertNetworkRequest({'project': 'sample1'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListNetworksRequest({'project': 'sample1'})
...
def test_list_peering_routes_rest(request_type, transport: str = 'rest'):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.ListPeeringRoutesNetworksRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_list_peering_routes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/networks/{network}/listPeeringRoutes" % client.transport._host, args[1])
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_remove_peering_unary_rest(request_type, transport: str = 'rest'):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.RemovePeeringNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_switch_to_custom_mode_unary_rest(request_type, transport: str = 'rest'):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.SwitchToCustomModeNetworkRequest({'project': 'sample1', 'network': 'sample2'})
...
def test_update_peering_unary_rest(request_type, transport: str = 'rest'):
    client = NetworksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.UpdatePeeringNetworkRequest({'project': 'sample1', 'network': 'sample2'})
