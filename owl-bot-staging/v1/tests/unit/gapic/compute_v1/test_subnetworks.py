...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_aggregated_list") as pre:
...
def test_expand_ip_cidr_range_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_expand_ip_cidr_range") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_expand_ip_cidr_range") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_usable_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_list_usable") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_list_usable") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_private_ip_google_access_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_set_private_ip_google_access") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_set_private_ip_google_access") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.SubnetworksRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
