...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteSslPolicyRequest({'project': 'sample1', 'ssl_policy': 'sample2'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteSslPolicyRequest):
    ...
    assert "sslPolicy" not in jsonified_request
    ...
    assert jsonified_request["sslPolicy"] == request_init["ssl_policy"]
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetSslPolicyRequest({'project': 'sample1', 'ssl_policy': 'sample2'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertSslPolicyRequest({'project': 'sample1'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListSslPoliciesRequest({'project': 'sample1'})
...
def test_list_available_features_rest(request_type, transport: str = 'rest'):
    client = SslPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.ListAvailableFeaturesSslPoliciesRequest({'project': 'sample1'})
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchSslPolicyRequest({'project': 'sample1', 'ssl_policy': 'sample2'})
