...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "pre_aggregated_list") as pre:
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_get") as post, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_wait_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "post_wait") as post, \
         mock.patch.object(transports.GlobalOperationsRestInterceptor, "pre_wait") as pre:
        pre.assert_not_called()
        post.assert_not_called()
