...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteInstanceTemplateRequest):
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertInstanceTemplateRequest):
    client = InstanceTemplatesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["instance_template_resource"] = compute.InstanceTemplate(creation_timestamp='creation_timestamp_value')
    request = request_type(request_init)
