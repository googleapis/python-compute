...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteInstanceTemplateRequest({'project': 'sample1', 'instance_template': 'sample2'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteInstanceTemplateRequest):
    ...
    assert "instanceTemplate" not in jsonified_request
    ...
    assert jsonified_request["instanceTemplate"] == request_init["instance_template"]
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/instanceTemplates/{instance_template}" % client.transport._host, args[1])
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetInstanceTemplateRequest({'project': 'sample1', 'instance_template': 'sample2'})
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyInstanceTemplateRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/instanceTemplates/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertInstanceTemplateRequest({'project': 'sample1'})
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/instanceTemplates" % client.transport._host, args[1])
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListInstanceTemplatesRequest({'project': 'sample1'})
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyInstanceTemplateRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/instanceTemplates/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsInstanceTemplateRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/instanceTemplates/{resource}/testIamPermissions" % client.transport._host, args[1])
