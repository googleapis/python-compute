...
def test_delete_rest_interceptors(null_interceptor):
    transport = transports.TargetSslProxiesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TargetSslProxiesRestInterceptor(),
        )
    client = TargetSslProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_delete") as pre:
...
def test_get_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.TargetSslProxy.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            target_ssl_proxy_resource=compute.TargetSslProxy(certificate_map='certificate_map_value'),
        )
        mock_args.update(sample_request)
...
def test_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.TargetSslProxyList.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_backend_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_backend_service") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_set_backend_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_certificate_map") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_set_certificate_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_certificate_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(
            project='project_value',
            target_ssl_proxy='target_ssl_proxy_value',
            target_ssl_proxies_set_certificate_map_request_resource=compute.TargetSslProxiesSetCertificateMapRequest(certificate_map='certificate_map_value'),
        )
        mock_args.update(sample_request)
...
def test_set_certificate_map_unary_rest_flattened_error(transport: str = 'rest'):
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        client.set_certificate_map_unary(
            compute.SetCertificateMapTargetSslProxyRequest(),
            project='project_value',
            target_ssl_proxy='target_ssl_proxy_value',
            target_ssl_proxies_set_certificate_map_request_resource=compute.TargetSslProxiesSetCertificateMapRequest(certificate_map='certificate_map_value'),
...
def test_set_proxy_header_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_proxy_header") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_set_proxy_header") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_ssl_certificates") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_set_ssl_certificates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_ssl_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "post_set_ssl_policy") as post, \
         mock.patch.object(transports.TargetSslProxiesRestInterceptor, "pre_set_ssl_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
