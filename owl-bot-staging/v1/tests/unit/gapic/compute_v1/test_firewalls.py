...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.FirewallsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.FirewallsRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FirewallsRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.FirewallsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FirewallsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.FirewallsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FirewallsRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.FirewallsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FirewallsRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.FirewallsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FirewallsRestInterceptor, "post_update") as post, \
         mock.patch.object(transports.FirewallsRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_firewalls_client_transport_session_collision(transport_name):
    ...
    client1 = FirewallsClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = FirewallsClient(
        credentials=creds2,
        transport=transport_name,
    )
