...
def test_list_network_endpoints_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("maxResults", "filter", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("networkEndpointGroup", "networkEndpointGroupsListEndpointsRequestResource", "project", "zone", )))
