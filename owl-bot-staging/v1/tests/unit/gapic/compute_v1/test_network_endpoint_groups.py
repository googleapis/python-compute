...
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = compute.NetworkEndpointGroupAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_aggregated_list") as pre:
...
def test_attach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_attach_network_endpoints") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_attach_network_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_detach_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_detach_network_endpoints") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_detach_network_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_network_endpoints_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.NetworkEndpointGroupsListNetworkEndpoints.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_network_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_list_network_endpoints") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_list_network_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.NetworkEndpointGroupsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
