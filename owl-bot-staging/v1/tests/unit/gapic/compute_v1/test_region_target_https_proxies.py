...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteRegionTargetHttpsProxyRequest({'project': 'sample1', 'region': 'sample2', 'target_https_proxy': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRegionTargetHttpsProxyRequest({'project': 'sample1', 'region': 'sample2', 'target_https_proxy': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertRegionTargetHttpsProxyRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionTargetHttpsProxiesRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_set_ssl_certificates_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetSslCertificatesRegionTargetHttpsProxyRequest({'project': 'sample1', 'region': 'sample2', 'target_https_proxy': 'sample3'})
...
def test_set_ssl_certificates_unary_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'target_https_proxy': 'sample3'}
    request_init["region_target_https_proxies_set_ssl_certificates_request_resource"] = {'ssl_certificates': ['ssl_certificates_value_1', 'ssl_certificates_value_2']}
    request = request_type(request_init)
...
def test_set_url_map_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetUrlMapRegionTargetHttpsProxyRequest({'project': 'sample1', 'region': 'sample2', 'target_https_proxy': 'sample3'})
