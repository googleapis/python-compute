...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "pre_delete") as pre:
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_get") as post, \
...
def test_insert_rest(request_type):
    ...
    request_init["address_resource"] = {'address': 'address_value', 'address_type': 'address_type_value', 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'id': 205, 'ip_version': 'ip_version_value', 'ipv6_endpoint_type': 'ipv6_endpoint_type_value', 'kind': 'kind_value', 'name': 'name_value', 'network': 'network_value', 'network_tier': 'network_tier_value', 'prefix_length': 1391, 'purpose': 'purpose_value', 'region': 'region_value', 'self_link': 'self_link_value', 'status': 'status_value', 'subnetwork': 'subnetwork_value', 'users': ['users_value1', 'users_value2']}
    request = request_type(**request_init)
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_list") as post, \
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "post_set_labels") as post, \
         mock.patch.object(transports.GlobalAddressesRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
