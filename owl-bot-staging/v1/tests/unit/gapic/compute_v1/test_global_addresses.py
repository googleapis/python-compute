...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteGlobalAddressRequest):
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertGlobalAddressRequest):
    client = GlobalAddressesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
