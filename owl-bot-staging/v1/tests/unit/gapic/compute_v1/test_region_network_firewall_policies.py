...
def test_region_network_firewall_policies_client_from_service_account_info(client_class):
...
def test_region_network_firewall_policies_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_get_effective_firewalls_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        json_return_value = compute.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse.to_json(return_value)
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
...
def test_region_network_firewall_policies_host_no_port():
    client = RegionNetworkFirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_region_network_firewall_policies_host_with_port():
    client = RegionNetworkFirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
