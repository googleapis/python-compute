...
def test_insert_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", "initialNodeCount", )) & set(("initialNodeCount", "nodeGroupResource", "project", "zone", )))
...
def test_list_nodes_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("orderBy", "returnPartialSuccess", "filter", "pageToken", "maxResults", )) & set(("nodeGroup", "project", "zone", )))
