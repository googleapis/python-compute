...
def test_disable_xpn_host_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ProjectsRestInterceptor, "post_disable_xpn_host") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_disable_xpn_host") as pre:
        ...
        client.disable_xpn_host(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_disable_xpn_host_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/disableXpnHost" % client.transport._host, args[1])
...
def test_disable_xpn_host_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.disable_xpn_host_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_disable_xpn_resource_rest(request_type):
    ...
    for field, value in request_init["projects_disable_xpn_resource_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
...
def test_disable_xpn_resource_rest_required_fields(request_type=compute.DisableXpnResourceProjectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).disable_xpn_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_disable_xpn_resource_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "projectsDisableXpnResourceRequestResource", )))
...
def test_disable_xpn_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_disable_xpn_resource") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_disable_xpn_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.disable_xpn_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_disable_xpn_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/disableXpnResource" % client.transport._host, args[1])
...
def test_disable_xpn_resource_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.disable_xpn_resource_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_xpn_host_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_enable_xpn_host") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_enable_xpn_host") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.enable_xpn_host(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_xpn_host_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/enableXpnHost" % client.transport._host, args[1])
...
def test_enable_xpn_host_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.enable_xpn_host_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_xpn_resource_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["projects_enable_xpn_resource_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_enable_xpn_resource_rest_required_fields(request_type=compute.EnableXpnResourceProjectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enable_xpn_resource._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enable_xpn_resource_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "projectsEnableXpnResourceRequestResource", )))
...
def test_enable_xpn_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_enable_xpn_resource") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_enable_xpn_resource") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.enable_xpn_resource(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_xpn_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/enableXpnResource" % client.transport._host, args[1])
...
def test_enable_xpn_resource_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.enable_xpn_resource_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}" % client.transport._host, args[1])
...
def test_get_xpn_host_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_get_xpn_host") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_get_xpn_host") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_xpn_host(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_xpn_host_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/getXpnHost" % client.transport._host, args[1])
...
def test_get_xpn_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_get_xpn_resources") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_get_xpn_resources") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.ProjectsGetXpnResources.to_json(compute.ProjectsGetXpnResources())
        ...
        client.get_xpn_resources(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_xpn_resources_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/getXpnResources" % client.transport._host, args[1])
...
def test_list_xpn_hosts_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["projects_list_xpn_hosts_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_list_xpn_hosts_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "maxResults", "orderBy", "pageToken", "returnPartialSuccess", )) & set(("project", "projectsListXpnHostsRequestResource", )))
...
def test_list_xpn_hosts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_list_xpn_hosts") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_list_xpn_hosts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.list_xpn_hosts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_xpn_hosts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/listXpnHosts" % client.transport._host, args[1])
...
def test_move_disk_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["disk_move_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_move_disk_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("diskMoveRequestResource", "project", )))
...
def test_move_disk_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.move_disk(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_move_disk_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/moveDisk" % client.transport._host, args[1])
...
def test_move_disk_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.move_disk_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_move_instance_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["instance_move_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_move_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_move_instance") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_move_instance") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_move_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/moveInstance" % client.transport._host, args[1])
...
def test_move_instance_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.move_instance_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_common_instance_metadata_rest_required_fields(request_type=compute.SetCommonInstanceMetadataProjectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_common_instance_metadata._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_common_instance_metadata_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("metadataResource", "project", )))
...
def test_set_common_instance_metadata_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_set_common_instance_metadata") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_set_common_instance_metadata") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_common_instance_metadata(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_common_instance_metadata_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/setCommonInstanceMetadata" % client.transport._host, args[1])
...
def test_set_common_instance_metadata_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_common_instance_metadata_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_default_network_tier_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["projects_set_default_network_tier_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_default_network_tier_rest_required_fields(request_type=compute.SetDefaultNetworkTierProjectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_default_network_tier._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_default_network_tier_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "projectsSetDefaultNetworkTierRequestResource", )))
...
def test_set_default_network_tier_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_set_default_network_tier") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_set_default_network_tier") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_default_network_tier(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_default_network_tier_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/setDefaultNetworkTier" % client.transport._host, args[1])
...
def test_set_default_network_tier_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_default_network_tier_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_usage_export_bucket_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["usage_export_location_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_usage_export_bucket_rest_required_fields(request_type=compute.SetUsageExportBucketProjectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_usage_export_bucket._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_usage_export_bucket_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("project", "usageExportLocationResource", )))
...
def test_set_usage_export_bucket_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_set_usage_export_bucket") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_set_usage_export_bucket") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.set_usage_export_bucket(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_set_usage_export_bucket_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/setUsageExportBucket" % client.transport._host, args[1])
...
def test_set_usage_export_bucket_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.set_usage_export_bucket_unary(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
