...
def test_add_signed_url_key_rest_interceptors(null_interceptor):
    transport = transports.BackendServicesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.BackendServicesRestInterceptor(),
        )
    client = BackendServicesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_add_signed_url_key") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_add_signed_url_key") as pre:
...
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.BackendServiceAggregatedList.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_delete_signed_url_key") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_delete_signed_url_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_get") as post, \
...
def test_get_health_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_health") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_get_health") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_list") as post, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_edge_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_edge_security_policy") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_set_edge_security_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_security_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_set_security_policy") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_set_security_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "post_update") as post, \
         mock.patch.object(transports.BackendServicesRestInterceptor, "pre_update") as pre:
        pre.assert_not_called()
        post.assert_not_called()
