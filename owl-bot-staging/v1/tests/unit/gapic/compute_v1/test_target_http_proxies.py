...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_aggregated_list") as pre:
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "post_set_url_map") as post, \
         mock.patch.object(transports.TargetHttpProxiesRestInterceptor, "pre_set_url_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
