...
def test_insert_rest(request_type):
    ...
    request_init["service_attachment_resource"] = {'connected_endpoints': [{'endpoint': 'endpoint_value', 'psc_connection_id': 1793, 'status': 'status_value'}], 'connection_preference': 'connection_preference_value', 'consumer_accept_lists': [{'connection_limit': 1710, 'project_id_or_num': 'project_id_or_num_value'}], 'consumer_reject_lists': ['consumer_reject_lists_value_1', 'consumer_reject_lists_value_2'], 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'domain_names': ['domain_names_value_1', 'domain_names_value_2'], 'enable_proxy_protocol': True, 'fingerprint': 'fingerprint_value', 'id': 205, 'kind': 'kind_value', 'name': 'name_value', 'nat_subnets': ['nat_subnets_value_1', 'nat_subnets_value_2'], 'producer_forwarding_rule': 'producer_forwarding_rule_value', 'psc_service_attachment_id': {'high': 416, 'low': 338}, 'region': 'region_value', 'self_link': 'self_link_value', 'target_service': 'target_service_value'}
    request = request_type(request_init)
