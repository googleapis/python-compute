...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'service_attachment': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'service_attachment': 'sample3'})
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_insert_unary_rest(request_type):
    ...
    request_init["service_attachment_resource"] = {'connected_endpoints': [{'endpoint': 'endpoint_value', 'psc_connection_id': 1793, 'status': 'status_value'}], 'connection_preference': 'connection_preference_value', 'consumer_accept_lists': [{'connection_limit': 1710, 'project_id_or_num': 'project_id_or_num_value'}], 'consumer_reject_lists': ['consumer_reject_lists_value_1', 'consumer_reject_lists_value_2'], 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'enable_proxy_protocol': True, 'fingerprint': 'fingerprint_value', 'id': 205, 'kind': 'kind_value', 'name': 'name_value', 'nat_subnets': ['nat_subnets_value_1', 'nat_subnets_value_2'], 'producer_forwarding_rule': 'producer_forwarding_rule_value', 'psc_service_attachment_id': {'high': 416, 'low': 338}, 'region': 'region_value', 'self_link': 'self_link_value', 'target_service': 'target_service_value'}
    request = request_type(request_init)
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListServiceAttachmentsRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'service_attachment': 'sample3'})
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsServiceAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
