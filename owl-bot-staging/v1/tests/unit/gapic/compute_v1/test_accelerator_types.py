...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AggregatedListAcceleratorTypesRequest({'project': 'sample1'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetAcceleratorTypeRequest({'project': 'sample1', 'zone': 'sample2', 'accelerator_type': 'sample3'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListAcceleratorTypesRequest({'project': 'sample1', 'zone': 'sample2'})
