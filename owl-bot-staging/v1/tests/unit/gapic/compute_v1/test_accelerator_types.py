...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.AcceleratorTypesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AcceleratorTypesRestInterceptor(),
        )
    client = AcceleratorTypesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.AcceleratorTypesRestInterceptor, "pre_aggregated_list") as pre:
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_get") as post, \
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AcceleratorTypesRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.AcceleratorTypesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
