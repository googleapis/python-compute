...
def test_licenses_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteLicenseRequest({'project': 'sample1', 'license_': 'sample2'})
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenses/{license_}" % client.transport._host, args[1])
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetLicenseRequest({'project': 'sample1', 'license_': 'sample2'})
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyLicenseRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.GetIamPolicyLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenses/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertLicenseRequest({'project': 'sample1'})
...
def test_insert_unary_rest(request_type):
    ...
    request_init["license_resource"] = {'charges_use_fee': True, 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'id': 205, 'kind': 'kind_value', 'license_code': 1245, 'name': 'name_value', 'resource_requirements': {'min_guest_cpu_count': 2042, 'min_memory_mb': 1386}, 'self_link': 'self_link_value', 'transferable': True}
    request = request_type(request_init)
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenses" % client.transport._host, args[1])
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListLicensesRequest({'project': 'sample1'})
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListLicensesRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert all(isinstance(i, compute.License)
                for i in results)
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyLicenseRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_set_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetIamPolicyLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenses/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsLicenseRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/licenses/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_licenses_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.licenses.transports.LicensesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_licenses_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.licenses.transports.LicensesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LicensesTransport()
        adc.assert_called_once()
