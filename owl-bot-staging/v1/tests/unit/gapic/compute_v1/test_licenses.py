...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("license", "requestId", )) & set(("license", "project", )))
...
def test_delete_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicensesRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.LicensesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest(request_type):
    ...
    for field, value in request_init["license_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("requestId", )) & set(("licenseResource", "project", )))
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.LicensesListResponse.to_json(compute.LicensesListResponse())
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicensesRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.LicensesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.LicensesRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.LicensesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/global/licenses/{resource}/testIamPermissions" % client.transport._host, args[1])
