...
def test_delete_rest(transport: str = 'rest', request_type=compute.DeleteLicenseRequest):
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertLicenseRequest):
    client = LicensesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
