...
def test_delete_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteRegionOperationRequest({'project': 'sample1', 'region': 'sample2', 'operation': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRegionOperationRequest({'project': 'sample1', 'region': 'sample2', 'operation': 'sample3'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionOperationsRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/operations" % client.transport._host, args[1])
...
def test_wait_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.WaitRegionOperationRequest({'project': 'sample1', 'region': 'sample2', 'operation': 'sample3'})
...
def test_wait_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/operations/{operation}/wait" % client.transport._host, args[1])
