...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteExternalVpnGatewayRequest):
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_unary_rest(transport: str = 'rest', request_type=compute.SetLabelsExternalVpnGatewayRequest):
    client = ExternalVpnGatewaysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
