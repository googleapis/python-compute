...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteExternalVpnGatewayRequest({'project': 'sample1', 'external_vpn_gateway': 'sample2'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteExternalVpnGatewayRequest):
    ...
    assert "externalVpnGateway" not in jsonified_request
    ...
    assert jsonified_request["externalVpnGateway"] == request_init["external_vpn_gateway"]
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetExternalVpnGatewayRequest({'project': 'sample1', 'external_vpn_gateway': 'sample2'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertExternalVpnGatewayRequest({'project': 'sample1'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListExternalVpnGatewaysRequest({'project': 'sample1'})
...
def test_set_labels_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetLabelsExternalVpnGatewayRequest({'project': 'sample1', 'resource': 'sample2'})
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsExternalVpnGatewayRequest({'project': 'sample1', 'resource': 'sample2'})
