...
def test_add_resource_policies_rest(request_type):
    ...
    for field, value in request_init["disks_add_resource_policies_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
...
def test_add_resource_policies_rest_bad_request(transport: str = 'rest', request_type=compute.AddResourcePoliciesDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/addResourcePolicies" % client.transport._host, args[1])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.DiskAggregatedList.to_json(compute.DiskAggregatedList())
...
def test_bulk_insert_rest_bad_request(transport: str = 'rest', request_type=compute.BulkInsertDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_bulk_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.BulkInsertDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_snapshot_rest_bad_request(transport: str = 'rest', request_type=compute.CreateSnapshotDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_rest_bad_request(transport: str = 'rest', request_type=compute.InsertDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_resource_policies_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["disks_remove_resource_policies_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_remove_resource_policies_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveResourcePoliciesDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_resource_policies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/removeResourcePolicies" % client.transport._host, args[1])
...
def test_resize_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["disks_resize_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_resize_rest_bad_request(transport: str = 'rest', request_type=compute.ResizeDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["zone_set_labels_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_set_labels_rest_bad_request(transport: str = 'rest', request_type=compute.SetLabelsDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_async_replication_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    for field, value in request_init["disks_start_async_replication_request_resource"].items():
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_start_async_replication_rest_bad_request(transport: str = 'rest', request_type=compute.StartAsyncReplicationDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/startAsyncReplication" % client.transport._host, args[1])
...
def test_start_async_replication_unary_rest_bad_request(transport: str = 'rest', request_type=compute.StartAsyncReplicationDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_async_replication_rest_bad_request(transport: str = 'rest', request_type=compute.StopAsyncReplicationDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/stopAsyncReplication" % client.transport._host, args[1])
...
def test_stop_async_replication_unary_rest_bad_request(transport: str = 'rest', request_type=compute.StopAsyncReplicationDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_group_async_replication_rest_bad_request(transport: str = 'rest', request_type=compute.StopGroupAsyncReplicationDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_group_async_replication_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/disks/stopGroupAsyncReplication" % client.transport._host, args[1])
...
def test_stop_group_async_replication_unary_rest_bad_request(transport: str = 'rest', request_type=compute.StopGroupAsyncReplicationDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/compute/v1/projects/{project}/zones/{zone}/disks/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_update_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_unary_rest_bad_request(transport: str = 'rest', request_type=compute.UpdateDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
