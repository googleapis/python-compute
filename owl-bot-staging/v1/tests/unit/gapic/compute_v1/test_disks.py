...
def test_insert_rest(request_type):
    ...
    request_init["disk_resource"] = {'architecture': 'architecture_value', 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'disk_encryption_key': {'kms_key_name': 'kms_key_name_value', 'kms_key_service_account': 'kms_key_service_account_value', 'raw_key': 'raw_key_value', 'rsa_encrypted_key': 'rsa_encrypted_key_value', 'sha256': 'sha256_value'}, 'guest_os_features': [{'type_': 'type__value'}], 'id': 205, 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'last_attach_timestamp': 'last_attach_timestamp_value', 'last_detach_timestamp': 'last_detach_timestamp_value', 'license_codes': [1361, 1362], 'licenses': ['licenses_value_1', 'licenses_value_2'], 'location_hint': 'location_hint_value', 'name': 'name_value', 'options': 'options_value', 'physical_block_size_bytes': 2663, 'provisioned_iops': 1740, 'region': 'region_value', 'replica_zones': ['replica_zones_value_1', 'replica_zones_value_2'], 'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2'], 'satisfies_pzs': True, 'self_link': 'self_link_value', 'size_gb': 739, 'source_disk': 'source_disk_value', 'source_disk_id': 'source_disk_id_value', 'source_image': 'source_image_value', 'source_image_encryption_key': {}, 'source_image_id': 'source_image_id_value', 'source_snapshot': 'source_snapshot_value', 'source_snapshot_encryption_key': {}, 'source_snapshot_id': 'source_snapshot_id_value', 'source_storage_object': 'source_storage_object_value', 'status': 'status_value', 'type_': 'type__value', 'users': ['users_value_1', 'users_value_2'], 'zone': 'zone_value'}
    request = request_type(request_init)
