...
def test_disks_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_add_resource_policies_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AddResourcePoliciesDiskRequest({'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'})
...
def test_add_resource_policies_unary_rest(request_type):
    ...
    request_init["disks_add_resource_policies_request_resource"] = {'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2']}
...
def test_add_resource_policies_unary_rest_required_fields(request_type=compute.AddResourcePoliciesDiskRequest):
    ...
    assert "disk" not in jsonified_request
    ...
    assert jsonified_request["disk"] == request_init["disk"]
...
def test_add_resource_policies_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/addResourcePolicies" % client.transport._host, args[1])
...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.AggregatedListDisksRequest({'project': 'sample1'})
...
def test_aggregated_list_rest_bad_request(transport: str = 'rest', request_type=compute.AggregatedListDisksRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/disks" % client.transport._host, args[1])
...
def test_create_snapshot_unary_rest(request_type, transport: str = 'rest'):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.CreateSnapshotDiskRequest({'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'})
...
def test_create_snapshot_unary_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'}
    request_init["snapshot_resource"] = {'auto_created': True, 'chain_name': 'chain_name_value', 'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'disk_size_gb': 1261, 'download_bytes': 1502, 'id': 205, 'kind': 'kind_value', 'label_fingerprint': 'label_fingerprint_value', 'labels': {}, 'license_codes': [1361, 1362], 'licenses': ['licenses_value_1', 'licenses_value_2'], 'location_hint': 'location_hint_value', 'name': 'name_value', 'satisfies_pzs': True, 'self_link': 'self_link_value', 'snapshot_encryption_key': {'kms_key_name': 'kms_key_name_value', 'kms_key_service_account': 'kms_key_service_account_value', 'raw_key': 'raw_key_value', 'rsa_encrypted_key': 'rsa_encrypted_key_value', 'sha256': 'sha256_value'}, 'source_disk': 'source_disk_value', 'source_disk_encryption_key': {'kms_key_name': 'kms_key_name_value', 'kms_key_service_account': 'kms_key_service_account_value', 'raw_key': 'raw_key_value', 'rsa_encrypted_key': 'rsa_encrypted_key_value', 'sha256': 'sha256_value'}, 'source_disk_id': 'source_disk_id_value', 'status': 'status_value', 'storage_bytes': 1403, 'storage_bytes_status': 'storage_bytes_status_value', 'storage_locations': ['storage_locations_value_1', 'storage_locations_value_2']}
    request = request_type(request_init)
...
def test_create_snapshot_unary_rest_bad_request(transport: str = 'rest', request_type=compute.CreateSnapshotDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_snapshot_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/createSnapshot" % client.transport._host, args[1])
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteDiskRequest({'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'})
...
def test_delete_unary_rest_bad_request(transport: str = 'rest', request_type=compute.DeleteDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}" % client.transport._host, args[1])
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetDiskRequest({'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'})
...
def test_get_rest_bad_request(transport: str = 'rest', request_type=compute.GetDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyDiskRequest({'project': 'sample1', 'zone': 'sample2', 'resource': 'sample3'})
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.GetIamPolicyDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{resource}/getIamPolicy" % client.transport._host, args[1])
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertDiskRequest({'project': 'sample1', 'zone': 'sample2'})
...
def test_insert_unary_rest_bad_request(transport: str = 'rest', request_type=compute.InsertDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks" % client.transport._host, args[1])
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListDisksRequest({'project': 'sample1', 'zone': 'sample2'})
...
def test_list_rest_bad_request(transport: str = 'rest', request_type=compute.ListDisksRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_resource_policies_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.RemoveResourcePoliciesDiskRequest({'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'})
...
def test_remove_resource_policies_unary_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'}
    request_init["disks_remove_resource_policies_request_resource"] = {'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2']}
    request = request_type(request_init)
...
def test_remove_resource_policies_unary_rest_bad_request(transport: str = 'rest', request_type=compute.RemoveResourcePoliciesDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_resource_policies_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/removeResourcePolicies" % client.transport._host, args[1])
...
def test_resize_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ResizeDiskRequest({'project': 'sample1', 'zone': 'sample2', 'disk': 'sample3'})
...
def test_resize_unary_rest_bad_request(transport: str = 'rest', request_type=compute.ResizeDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resize_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{disk}/resize" % client.transport._host, args[1])
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyDiskRequest({'project': 'sample1', 'zone': 'sample2', 'resource': 'sample3'})
...
def test_set_iam_policy_rest_bad_request(transport: str = 'rest', request_type=compute.SetIamPolicyDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{resource}/setIamPolicy" % client.transport._host, args[1])
...
def test_set_labels_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetLabelsDiskRequest({'project': 'sample1', 'zone': 'sample2', 'resource': 'sample3'})
...
def test_set_labels_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{resource}/setLabels" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsDiskRequest({'project': 'sample1', 'zone': 'sample2', 'resource': 'sample3'})
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=compute.TestIamPermissionsDiskRequest):
    client = DisksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/disks/{resource}/testIamPermissions" % client.transport._host, args[1])
...
def test_disks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.disks.transports.DisksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_disks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.disks.transports.DisksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DisksTransport()
        adc.assert_called_once()
