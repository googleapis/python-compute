...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/healthChecks" % client.transport._host, args[1])
...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteHealthCheckRequest):
    client = HealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteHealthCheckRequest):
    ...
    # verify fields with default values are dropped
    assert "healthCheck" not in jsonified_request
    assert "project" not in jsonified_request
    ...
    assert jsonified_request["healthCheck"] == request_init["health_check"]
    assert "project" in jsonified_request
    assert jsonified_request["project"] == request_init["project"]
...
def test_delete_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/healthChecks/{health_check}" % client.transport._host, args[1])
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertHealthCheckRequest):
    client = HealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/healthChecks" % client.transport._host, args[1])
...
def test_patch_unary_rest(transport: str = 'rest', request_type=compute.PatchHealthCheckRequest):
    client = HealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_unary_rest(transport: str = 'rest', request_type=compute.UpdateHealthCheckRequest):
    client = HealthChecksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
