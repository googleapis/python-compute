...
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = compute.ForwardingRuleAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.ForwardingRulesRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ForwardingRulesRestInterceptor(),
        )
    client = ForwardingRulesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "pre_aggregated_list") as pre:
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_get") as post, \
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_list") as post, \
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_set_labels") as post, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_target_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "post_set_target") as post, \
         mock.patch.object(transports.ForwardingRulesRestInterceptor, "pre_set_target") as pre:
        pre.assert_not_called()
        post.assert_not_called()
