...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_unary_rest(transport: str = 'rest', request_type=compute.PatchForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_labels_unary_rest(transport: str = 'rest', request_type=compute.SetLabelsForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_target_unary_rest(transport: str = 'rest', request_type=compute.SetTargetForwardingRuleRequest):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
