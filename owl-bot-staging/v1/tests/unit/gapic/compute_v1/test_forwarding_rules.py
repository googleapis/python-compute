...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AggregatedListForwardingRulesRequest({'project': 'sample1'})
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteForwardingRuleRequest({'project': 'sample1', 'region': 'sample2', 'forwarding_rule': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetForwardingRuleRequest({'project': 'sample1', 'region': 'sample2', 'forwarding_rule': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertForwardingRuleRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListForwardingRulesRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchForwardingRuleRequest({'project': 'sample1', 'region': 'sample2', 'forwarding_rule': 'sample3'})
...
def test_set_labels_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetLabelsForwardingRuleRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_set_target_unary_rest(request_type, transport: str = 'rest'):
    client = ForwardingRulesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.SetTargetForwardingRuleRequest({'project': 'sample1', 'region': 'sample2', 'forwarding_rule': 'sample3'})
