...
def test_add_resource_policies_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AddResourcePoliciesRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'})
...
def test_add_resource_policies_unary_rest(request_type):
    ...
    request_init["region_disks_add_resource_policies_request_resource"] = {'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2']}
...
def test_create_snapshot_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.CreateSnapshotRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'})
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'})
...
def test_get_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetIamPolicyRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertRegionDiskRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionDisksRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_remove_resource_policies_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.RemoveResourcePoliciesRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'})
...
def test_remove_resource_policies_unary_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'}
    request_init["region_disks_remove_resource_policies_request_resource"] = {'resource_policies': ['resource_policies_value_1', 'resource_policies_value_2']}
    request = request_type(request_init)
...
def test_resize_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ResizeRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'disk': 'sample3'})
...
def test_set_iam_policy_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetIamPolicyRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_set_labels_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetLabelsRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
...
def test_test_iam_permissions_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.TestIamPermissionsRegionDiskRequest({'project': 'sample1', 'region': 'sample2', 'resource': 'sample3'})
