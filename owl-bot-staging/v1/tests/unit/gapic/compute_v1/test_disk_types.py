...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.DiskTypesRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.DiskTypesRestInterceptor, "pre_aggregated_list") as pre:
