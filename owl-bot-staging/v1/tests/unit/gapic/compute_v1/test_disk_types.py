...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AggregatedListDiskTypesRequest({'project': 'sample1'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetDiskTypeRequest({'project': 'sample1', 'zone': 'sample2', 'disk_type': 'sample3'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListDiskTypesRequest({'project': 'sample1', 'zone': 'sample2'})
