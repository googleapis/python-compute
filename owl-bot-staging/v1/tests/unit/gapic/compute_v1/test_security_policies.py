...
def test_add_rule_rest(transport: str = 'rest', request_type=compute.AddRuleSecurityPolicyRequest):
    ...
    request_init["security_policy_rule_resource"] = compute.SecurityPolicyRule(action='action_value')
...
def test_insert_rest(transport: str = 'rest', request_type=compute.InsertSecurityPolicyRequest):
    ...
    request_init["security_policy_resource"] = compute.SecurityPolicy(adaptive_protection_config=compute.SecurityPolicyAdaptiveProtectionConfig(layer7_ddos_defense_config=compute.SecurityPolicyAdaptiveProtectionConfigLayer7DdosDefenseConfig(enable=True)))
    request = request_type(request_init)
