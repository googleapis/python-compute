...
def test_add_rule_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AddRuleSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
...
def test_add_rule_unary_rest(request_type):
    ...
    request_init["security_policy_rule_resource"] = {'action': 'action_value', 'description': 'description_value', 'kind': 'kind_value', 'match': {'config': {'src_ip_ranges': ['src_ip_ranges_value_1', 'src_ip_ranges_value_2']}, 'expr': {'description': 'description_value', 'expression': 'expression_value', 'location': 'location_value', 'title': 'title_value'}, 'versioned_expr': 'versioned_expr_value'}, 'preview': True, 'priority': 898}
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
...
def test_get_rule_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRuleSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/securityPolicies/{security_policy}/getRule" % client.transport._host, args[1])
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertSecurityPolicyRequest({'project': 'sample1'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListSecurityPoliciesRequest({'project': 'sample1'})
...
def test_list_preconfigured_expression_sets_rest(request_type, transport: str = 'rest'):
    client = SecurityPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    # Send a request that will satisfy transcoding
    request = compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest({'project': 'sample1'})
...
def test_list_preconfigured_expression_sets_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/global/securityPolicies/listPreconfiguredExpressionSets" % client.transport._host, args[1])
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
...
def test_patch_rule_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchRuleSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
...
def test_remove_rule_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.RemoveRuleSecurityPolicyRequest({'project': 'sample1', 'security_policy': 'sample2'})
