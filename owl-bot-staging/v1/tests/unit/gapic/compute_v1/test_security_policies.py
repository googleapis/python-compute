...
def test_add_rule_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("project", "securityPolicy", "securityPolicyRuleResource", )))
...
def test_patch_rule_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("priority", )) & set(("project", "securityPolicy", "securityPolicyRuleResource", )))
