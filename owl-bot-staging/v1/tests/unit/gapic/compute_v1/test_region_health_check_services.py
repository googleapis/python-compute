...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteRegionHealthCheckServiceRequest):
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertRegionHealthCheckServiceRequest):
    client = RegionHealthCheckServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_patch_unary_rest(transport: str = 'rest', request_type=compute.PatchRegionHealthCheckServiceRequest):
    client = RegionHealthCheckServicesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
