...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteRegionHealthCheckServiceRequest({'project': 'sample1', 'region': 'sample2', 'health_check_service': 'sample3'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteRegionHealthCheckServiceRequest):
    ...
    assert "healthCheckService" not in jsonified_request
    ...
    assert jsonified_request["healthCheckService"] == request_init["health_check_service"]
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetRegionHealthCheckServiceRequest({'project': 'sample1', 'region': 'sample2', 'health_check_service': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertRegionHealthCheckServiceRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_insert_unary_rest(request_type):
    ...
    request_init["health_check_service_resource"] = {'creation_timestamp': 'creation_timestamp_value', 'description': 'description_value', 'fingerprint': 'fingerprint_value', 'health_checks': ['health_checks_value_1', 'health_checks_value_2'], 'health_status_aggregation_policy': 'health_status_aggregation_policy_value', 'id': 205, 'kind': 'kind_value', 'name': 'name_value', 'network_endpoint_groups': ['network_endpoint_groups_value_1', 'network_endpoint_groups_value_2'], 'notification_endpoints': ['notification_endpoints_value_1', 'notification_endpoints_value_2'], 'region': 'region_value', 'self_link': 'self_link_value'}
    request = request_type(request_init)
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListRegionHealthCheckServicesRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchRegionHealthCheckServiceRequest({'project': 'sample1', 'region': 'sample2', 'health_check_service': 'sample3'})
