...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteTargetInstanceRequest({'project': 'sample1', 'zone': 'sample2', 'target_instance': 'sample3'})
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetTargetInstanceRequest({'project': 'sample1', 'zone': 'sample2', 'target_instance': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertTargetInstanceRequest({'project': 'sample1', 'zone': 'sample2'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListTargetInstancesRequest({'project': 'sample1', 'zone': 'sample2'})
