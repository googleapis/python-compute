...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/targetInstances" % client.transport._host, args[1])
...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/targetInstances/{target_instance}" % client.transport._host, args[1])
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertTargetInstanceRequest):
    client = TargetInstancesClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["target_instance_resource"] = compute.TargetInstance(creation_timestamp='creation_timestamp_value')
    request = request_type(request_init)
...
def test_insert_unary_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/targetInstances" % client.transport._host, args[1])
