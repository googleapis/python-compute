...
from google.cloud.compute_v1.services.network_firewall_policies import NetworkFirewallPoliciesClient
...
def test_network_firewall_policies_client_from_service_account_info(client_class):
...
def test_network_firewall_policies_client_from_service_account_file(client_class):
    creds = ga_credentials.AnonymousCredentials()
...
def test_add_association_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_add_association") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_add_association") as pre:
...
def test_add_rule_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_add_rule") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_add_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_clone_rules_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_clone_rules") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_clone_rules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_association") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_get_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_get_rule") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_get_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rule_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_patch_rule") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_patch_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_remove_association_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_remove_association") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_remove_association") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_remove_rule_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_remove_rule") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_remove_rule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_network_firewall_policies_host_no_port():
    client = NetworkFirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_network_firewall_policies_host_with_port():
    client = NetworkFirewallPoliciesClient(
        credentials=ga_credentials.AnonymousCredentials(),
