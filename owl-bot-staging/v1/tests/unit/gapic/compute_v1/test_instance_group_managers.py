...
def test_abandon_instances_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_abandon_instances") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_abandon_instances") as pre:
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_aggregated_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_apply_updates_to_instances_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_apply_updates_to_instances") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_apply_updates_to_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_instances_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_create_instances") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_create_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_instances_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_delete_instances") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_delete_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_per_instance_configs_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_delete_per_instance_configs") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_delete_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_errors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_list_errors") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_list_errors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_managed_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_list_managed_instances") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_list_managed_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_list_per_instance_configs") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_list_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_per_instance_configs_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_patch_per_instance_configs") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_patch_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_recreate_instances_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_recreate_instances") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_recreate_instances") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_resize_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_resize") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_resize") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_instance_template_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_set_instance_template") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_set_instance_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_target_pools_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_set_target_pools") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_set_target_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_per_instance_configs_unary_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "post_update_per_instance_configs") as post, \
         mock.patch.object(transports.InstanceGroupManagersRestInterceptor, "pre_update_per_instance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
