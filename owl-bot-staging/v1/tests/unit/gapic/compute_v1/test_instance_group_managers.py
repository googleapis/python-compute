...
def test_abandon_instances_rest(transport: str = 'rest', request_type=compute.AbandonInstancesInstanceGroupManagerRequest):
    ...
    request_init["instance_group_managers_abandon_instances_request_resource"] = compute.InstanceGroupManagersAbandonInstancesRequest(instances=['instances_value'])
...
def test_abandon_instances_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/abandonInstances" % client.transport._host, args[1])
...
def test_aggregated_list_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/instanceGroupManagers" % client.transport._host, args[1])
...
def test_apply_updates_to_instances_rest(transport: str = 'rest', request_type=compute.ApplyUpdatesToInstancesInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_apply_updates_request_resource"] = compute.InstanceGroupManagersApplyUpdatesRequest(all_instances=True)
    request = request_type(request_init)
...
def test_apply_updates_to_instances_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/applyUpdatesToInstances" % client.transport._host, args[1])
...
def test_create_instances_rest(transport: str = 'rest', request_type=compute.CreateInstancesInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_create_instances_request_resource"] = compute.InstanceGroupManagersCreateInstancesRequest(instances=[compute.PerInstanceConfig(fingerprint='fingerprint_value')])
    request = request_type(request_init)
...
def test_create_instances_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/createInstances" % client.transport._host, args[1])
...
def test_delete_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}" % client.transport._host, args[1])
...
def test_delete_instances_rest(transport: str = 'rest', request_type=compute.DeleteInstancesInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_delete_instances_request_resource"] = compute.InstanceGroupManagersDeleteInstancesRequest(instances=['instances_value'])
    request = request_type(request_init)
...
def test_delete_instances_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/deleteInstances" % client.transport._host, args[1])
...
def test_delete_per_instance_configs_rest(transport: str = 'rest', request_type=compute.DeletePerInstanceConfigsInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_delete_per_instance_configs_req_resource"] = compute.InstanceGroupManagersDeletePerInstanceConfigsReq(names=['names_value'])
    request = request_type(request_init)
...
def test_delete_per_instance_configs_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/deletePerInstanceConfigs" % client.transport._host, args[1])
...
def test_insert_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers" % client.transport._host, args[1])
...
def test_list_errors_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listErrors" % client.transport._host, args[1])
...
def test_list_managed_instances_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listManagedInstances" % client.transport._host, args[1])
...
def test_list_per_instance_configs_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listPerInstanceConfigs" % client.transport._host, args[1])
...
def test_patch_per_instance_configs_rest(transport: str = 'rest', request_type=compute.PatchPerInstanceConfigsInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_patch_per_instance_configs_req_resource"] = compute.InstanceGroupManagersPatchPerInstanceConfigsReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')])
    request = request_type(request_init)
...
def test_patch_per_instance_configs_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/patchPerInstanceConfigs" % client.transport._host, args[1])
...
def test_recreate_instances_rest(transport: str = 'rest', request_type=compute.RecreateInstancesInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_recreate_instances_request_resource"] = compute.InstanceGroupManagersRecreateInstancesRequest(instances=['instances_value'])
    request = request_type(request_init)
...
def test_recreate_instances_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/recreateInstances" % client.transport._host, args[1])
...
def test_resize_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resize" % client.transport._host, args[1])
...
def test_set_instance_template_rest(transport: str = 'rest', request_type=compute.SetInstanceTemplateInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_set_instance_template_request_resource"] = compute.InstanceGroupManagersSetInstanceTemplateRequest(instance_template='instance_template_value')
    request = request_type(request_init)
...
def test_set_instance_template_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setInstanceTemplate" % client.transport._host, args[1])
...
def test_set_target_pools_rest(transport: str = 'rest', request_type=compute.SetTargetPoolsInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_set_target_pools_request_resource"] = compute.InstanceGroupManagersSetTargetPoolsRequest(fingerprint='fingerprint_value')
    request = request_type(request_init)
...
def test_set_target_pools_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setTargetPools" % client.transport._host, args[1])
...
def test_update_per_instance_configs_rest(transport: str = 'rest', request_type=compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {"project": "sample1", "zone": "sample2", "instance_group_manager": "sample3"}
    request_init["instance_group_managers_update_per_instance_configs_req_resource"] = compute.InstanceGroupManagersUpdatePerInstanceConfigsReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')])
    request = request_type(request_init)
...
def test_update_per_instance_configs_rest_flattened(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/updatePerInstanceConfigs" % client.transport._host, args[1])
