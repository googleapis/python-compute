...
def test_list_errors_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "returnPartialSuccess", "orderBy", "pageToken", "maxResults", )) & set(("instanceGroupManager", "project", "zone", )))
...
def test_resize_unary_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("size", "requestId", )) & set(("instanceGroupManager", "project", "size", "zone", )))
