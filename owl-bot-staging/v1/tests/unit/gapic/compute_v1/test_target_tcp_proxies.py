...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.DeleteTargetTcpProxyRequest({'project': 'sample1', 'target_tcp_proxy': 'sample2'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteTargetTcpProxyRequest):
    ...
    assert "targetTcpProxy" not in jsonified_request
    ...
    assert jsonified_request["targetTcpProxy"] == request_init["target_tcp_proxy"]
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetTargetTcpProxyRequest({'project': 'sample1', 'target_tcp_proxy': 'sample2'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertTargetTcpProxyRequest({'project': 'sample1'})
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListTargetTcpProxiesRequest({'project': 'sample1'})
...
def test_set_backend_service_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetBackendServiceTargetTcpProxyRequest({'project': 'sample1', 'target_tcp_proxy': 'sample2'})
...
def test_set_proxy_header_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.SetProxyHeaderTargetTcpProxyRequest({'project': 'sample1', 'target_tcp_proxy': 'sample2'})
