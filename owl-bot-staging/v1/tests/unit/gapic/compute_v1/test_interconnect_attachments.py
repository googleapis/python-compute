...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (InterconnectAttachmentsClient, transports.InterconnectAttachmentsRestTransport, "rest", None),
])
...
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = compute.InterconnectAttachmentAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    transport = transports.InterconnectAttachmentsRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.InterconnectAttachmentsRestInterceptor(),
        )
    client = InterconnectAttachmentsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_aggregated_list") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_aggregated_list") as pre:
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_delete") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_delete") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.InterconnectAttachment.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_get") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_get") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_insert") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_insert") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = compute.InterconnectAttachmentList.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_list") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_list") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_patch") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_patch") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_labels_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "post_set_labels") as post, \
         mock.patch.object(transports.InterconnectAttachmentsRestInterceptor, "pre_set_labels") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (InterconnectAttachmentsClient, transports.InterconnectAttachmentsRestTransport),
])
