...
def test_aggregated_list_rest(request_type, transport: str = 'rest'):
    ...
    request = compute.AggregatedListInterconnectAttachmentsRequest({'project': 'sample1'})
...
def test_aggregated_list_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("https://%s/compute/v1/projects/{project}/aggregated/interconnectAttachments" % client.transport._host, args[1])
...
def test_delete_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.DeleteInterconnectAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'interconnect_attachment': 'sample3'})
...
def test_delete_unary_rest_required_fields(request_type=compute.DeleteInterconnectAttachmentRequest):
    ...
    # verify fields with default values are dropped
    assert "interconnectAttachment" not in jsonified_request
    assert "project" not in jsonified_request
    ...
    assert jsonified_request["interconnectAttachment"] == request_init["interconnect_attachment"]
    assert "project" in jsonified_request
    assert jsonified_request["project"] == request_init["project"]
...
def test_delete_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/interconnectAttachments/{interconnect_attachment}" % client.transport._host, args[1])
...
def test_get_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.GetInterconnectAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'interconnect_attachment': 'sample3'})
...
def test_insert_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.InsertInterconnectAttachmentRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_insert_unary_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("https://%s/compute/v1/projects/{project}/regions/{region}/interconnectAttachments" % client.transport._host, args[1])
...
def test_list_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.ListInterconnectAttachmentsRequest({'project': 'sample1', 'region': 'sample2'})
...
def test_patch_unary_rest(request_type, transport: str = 'rest'):
    ...
    # Send a request that will satisfy transcoding
    request = compute.PatchInterconnectAttachmentRequest({'project': 'sample1', 'region': 'sample2', 'interconnect_attachment': 'sample3'})
