...
def test_delete_unary_rest(transport: str = 'rest', request_type=compute.DeleteInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_insert_unary_rest(transport: str = 'rest', request_type=compute.InsertInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    request_init["interconnect_attachment_resource"] = compute.InterconnectAttachment(admin_enabled=True)
    request = request_type(request_init)
...
def test_patch_unary_rest(transport: str = 'rest', request_type=compute.PatchInterconnectAttachmentRequest):
    client = InterconnectAttachmentsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
