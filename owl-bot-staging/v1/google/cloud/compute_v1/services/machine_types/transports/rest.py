...
class MachineTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListMachineTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListMachineTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetMachineTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetMachineTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListMachineTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListMachineTypesRequest, Sequence[Tuple[str, str]]]:
...
class MachineTypesRestTransport(MachineTypesTransport):
    ...
    """
    _STUBS: Dict[str, MachineTypesRestStub] = {}
    ...
    class _AggregatedList(MachineTypesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.AggregatedListMachineTypesRequest.to_dict(request)
            ...
            query_params = json.loads(compute.AggregatedListMachineTypesRequest.to_json(
                compute.AggregatedListMachineTypesRequest(transcoded_request['query_params']),
            ...
            # Return the response
            resp = compute.MachineTypeAggregatedList.from_json(
                response.content,
    ...
    class _Get(MachineTypesRestStub):
        def __hash__(self):
            return hash("Get")
        ...
        def __call__(self,
            ...
            request_kwargs = compute.GetMachineTypeRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetMachineTypeRequest.to_json(
                compute.GetMachineTypeRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = compute.MachineType.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _List(MachineTypesRestStub):
        def __hash__(self):
            return hash("List")
        ...
        def __call__(self,
            ...
            request_kwargs = compute.ListMachineTypesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListMachineTypesRequest.to_json(
                compute.ListMachineTypesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = compute.MachineTypeList.from_json(
                response.content,
                ignore_unknown_fields=True
            )
