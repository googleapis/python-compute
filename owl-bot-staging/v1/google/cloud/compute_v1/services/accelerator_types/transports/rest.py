...
class AcceleratorTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListAcceleratorTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListAcceleratorTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetAcceleratorTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetAcceleratorTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListAcceleratorTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListAcceleratorTypesRequest, Sequence[Tuple[str, str]]]:
