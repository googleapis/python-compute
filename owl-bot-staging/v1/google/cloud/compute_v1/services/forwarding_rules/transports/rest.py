...
class ForwardingRulesRestTransport(ForwardingRulesTransport):
    ...
    class _AggregatedList(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListForwardingRulesRequest.to_json(
                compute.AggregatedListForwardingRulesRequest(transcoded_request['query_params']),
            ...
            # Return the response
            resp = compute.ForwardingRuleAggregatedList.from_json(
                response.content,
    ...
    class _Delete(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteForwardingRuleRequest.to_json(
                compute.DeleteForwardingRuleRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Get(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetForwardingRuleRequest.to_json(
                compute.GetForwardingRuleRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertForwardingRuleRequest.to_json(
                compute.InsertForwardingRuleRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListForwardingRulesRequest.to_json(
                compute.ListForwardingRulesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Patch(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchForwardingRuleRequest.to_json(
                compute.PatchForwardingRuleRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _SetLabels(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetLabelsForwardingRuleRequest.to_json(
                compute.SetLabelsForwardingRuleRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _SetTarget(ForwardingRulesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetTargetForwardingRuleRequest.to_json(
                compute.SetTargetForwardingRuleRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
