...
from .base import GlobalOperationsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class GlobalOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListGlobalOperationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListGlobalOperationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteGlobalOperationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteGlobalOperationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetGlobalOperationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetGlobalOperationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListGlobalOperationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListGlobalOperationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_wait(self, request: compute.WaitGlobalOperationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.WaitGlobalOperationRequest, Sequence[Tuple[str, str]]]:
...
class GlobalOperationsRestTransport(GlobalOperationsTransport):
    ...
    class _AggregatedList(GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListGlobalOperationsRequest.to_json(
                compute.AggregatedListGlobalOperationsRequest(transcoded_request['query_params']),
    ...
    class _Delete(GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteGlobalOperationRequest.to_json(
                compute.DeleteGlobalOperationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Get(GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetGlobalOperationRequest.to_json(
    ...
    class _List(GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListGlobalOperationsRequest.to_json(
    ...
    class _Wait(GlobalOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.WaitGlobalOperationRequest.to_json(
    ...
    def wait(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["wait"] = self._Wait(self._session, self._host, self._interceptor)
