...
class VpnGatewaysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListVpnGatewaysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListVpnGatewaysRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_aggregated_list(self, response: compute.VpnGatewayAggregatedList) -> compute.VpnGatewayAggregatedList:
    ...
    def pre_delete(self, request: compute.DeleteVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_status(self, request: compute.GetStatusVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetStatusVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_status(self, response: compute.VpnGatewaysGetStatusResponse) -> compute.VpnGatewaysGetStatusResponse:
    ...
    def pre_insert(self, request: compute.InsertVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListVpnGatewaysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListVpnGatewaysRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_labels(self, request: compute.SetLabelsVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsVpnGatewayRequest, Sequence[Tuple[str, str]]]:
...
class VpnGatewaysRestTransport(VpnGatewaysTransport):
    ...
    class _AggregatedList(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListVpnGatewaysRequest.to_json(
                compute.AggregatedListVpnGatewaysRequest(transcoded_request['query_params']),
    ...
    class _Delete(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteVpnGatewayRequest.to_json(
    ...
    class _Get(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetVpnGatewayRequest.to_json(
    ...
    class _GetStatus(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetStatusVpnGatewayRequest.to_json(
                compute.GetStatusVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            body = compute.VpnGateway.to_json(
                compute.VpnGateway(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertVpnGatewayRequest.to_json(
    ...
    class _List(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListVpnGatewaysRequest.to_json(
    ...
    class _SetLabels(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            body = compute.RegionSetLabelsRequest.to_json(
                compute.RegionSetLabelsRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetLabelsVpnGatewayRequest.to_json(
                compute.SetLabelsVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(VpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.TestIamPermissionsVpnGatewayRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsVpnGatewayRequest.to_json(
                compute.TestIamPermissionsVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def get_status(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_status"] = self._GetStatus(self._session, self._host, self._interceptor)
