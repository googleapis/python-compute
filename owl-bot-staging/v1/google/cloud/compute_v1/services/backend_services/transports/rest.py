...
class BackendServicesRestTransport(BackendServicesTransport):
    ...
    class _AddSignedUrlKey(BackendServicesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.SignedUrlKey.to_json(
                compute.SignedUrlKey(transcoded_request['body']),                including_default_value_fields=False,
    ...
    class _GetHealth(BackendServicesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.ResourceGroupReference.to_json(
                compute.ResourceGroupReference(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _Insert(BackendServicesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.BackendService.to_json(
                compute.BackendService(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _SetEdgeSecurityPolicy(BackendServicesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.SetEdgeSecurityPolicyBackendServiceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = compute.SecurityPolicyReference.to_json(
                compute.SecurityPolicyReference(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetEdgeSecurityPolicyBackendServiceRequest.to_json(
                compute.SetEdgeSecurityPolicyBackendServiceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def add_signed_url_key(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_signed_url_key"] = self._AddSignedUrlKey(self._session, self._host, self._interceptor)
    ...
    def delete_signed_url_key(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["delete_signed_url_key"] = self._DeleteSignedUrlKey(self._session, self._host, self._interceptor)
    ...
    def get_health(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_health"] = self._GetHealth(self._session, self._host, self._interceptor)
    ...
    def set_edge_security_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_edge_security_policy"] = self._SetEdgeSecurityPolicy(self._session, self._host, self._interceptor)
    ...
    def set_security_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_security_policy"] = self._SetSecurityPolicy(self._session, self._host, self._interceptor)
