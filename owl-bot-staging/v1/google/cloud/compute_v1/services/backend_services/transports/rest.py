...
class BackendServicesRestTransport(BackendServicesTransport):
    ...
    def add_signed_url_key(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_signed_url_key"] = self._AddSignedUrlKey(self._session, self._host)
    ...
    def delete_signed_url_key(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["delete_signed_url_key"] = self._DeleteSignedUrlKey(self._session, self._host)
    ...
    def set_security_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_security_policy"] = self._SetSecurityPolicy(self._session, self._host)
