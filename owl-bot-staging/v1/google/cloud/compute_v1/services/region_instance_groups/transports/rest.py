...
class RegionInstanceGroupsRestTransport(RegionInstanceGroupsTransport):
    ...
    def _get_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionInstanceGroupsRestTransport.__get_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionInstanceGroupsRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list_instances_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionInstanceGroupsRestTransport.__list_instances_required_fields_default_values.items() if k not in message_dict}
    ...
    def _set_named_ports_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionInstanceGroupsRestTransport.__set_named_ports_required_fields_default_values.items() if k not in message_dict}
