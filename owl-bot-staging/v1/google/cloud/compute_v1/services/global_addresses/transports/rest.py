...
class GlobalAddressesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteGlobalAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteGlobalAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_get(self, request: compute.GetGlobalAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetGlobalAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get(self, response: compute.Address) -> compute.Address:
        ...
        """
        return response
    def pre_insert(self, request: compute.InsertGlobalAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertGlobalAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_insert(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_list(self, request: compute.ListGlobalAddressesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListGlobalAddressesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list(self, response: compute.AddressList) -> compute.AddressList:
        ...
        """
        return response
    def pre_move(self, request: compute.MoveGlobalAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.MoveGlobalAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_move(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_labels(self, request: compute.SetLabelsGlobalAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsGlobalAddressRequest, Sequence[Tuple[str, str]]]:
...
class GlobalAddressesRestTransport(GlobalAddressesTransport):
    ...
    class _Move(GlobalAddressesRestStub):
        def __hash__(self):
            return hash("Move")
    ...
    class _SetLabels(GlobalAddressesRestStub):
        def __hash__(self):
