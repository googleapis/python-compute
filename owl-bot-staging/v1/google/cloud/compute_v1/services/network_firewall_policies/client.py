...
class NetworkFirewallPoliciesClient(metaclass=NetworkFirewallPoliciesClientMeta):
    ...
    def remove_association_unary(self,
            request: Union[compute.RemoveAssociationNetworkFirewallPolicyRequest, dict] = None,
            *,
            project: str = None,
            firewall_policy: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def test_iam_permissions(self,
            request: Union[compute.TestIamPermissionsNetworkFirewallPolicyRequest, dict] = None,
            *,
            project: str = None,
            resource: str = None,
