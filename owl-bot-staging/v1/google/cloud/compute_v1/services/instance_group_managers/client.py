...
class InstanceGroupManagersClient(metaclass=InstanceGroupManagersClientMeta):
    ...
    def abandon_instances_unary(self,
            request: Union[compute.AbandonInstancesInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
        ...
        has_flattened_params = any([project, zone, instance_group_manager, instance_group_managers_abandon_instances_request_resource])
    ...
    def apply_updates_to_instances_unary(self,
            request: Union[compute.ApplyUpdatesToInstancesInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, instance_group_manager, instance_group_managers_apply_updates_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def delete_per_instance_configs_unary(self,
            request: Union[compute.DeletePerInstanceConfigsInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, instance_group_manager, instance_group_managers_delete_per_instance_configs_req_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list_managed_instances(self,
            request: Union[compute.ListManagedInstancesInstanceGroupManagersRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
    ...
    def list_per_instance_configs(self,
            request: Union[compute.ListPerInstanceConfigsInstanceGroupManagersRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
    ...
    def patch_unary(self,
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, instance_group_manager, instance_group_manager_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def patch_per_instance_configs_unary(self,
            request: Union[compute.PatchPerInstanceConfigsInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
    ...
    def recreate_instances_unary(self,
            request: Union[compute.RecreateInstancesInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
    ...
    def set_instance_template_unary(self,
            request: Union[compute.SetInstanceTemplateInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
    ...
    def set_target_pools_unary(self,
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, instance_group_manager, instance_group_managers_set_target_pools_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def update_per_instance_configs_unary(self,
            request: Union[compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            instance_group_manager: str = None,
