...
from .base import SslCertificatesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class SslCertificatesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListSslCertificatesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListSslCertificatesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteSslCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteSslCertificateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetSslCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetSslCertificateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertSslCertificateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertSslCertificateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListSslCertificatesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListSslCertificatesRequest, Sequence[Tuple[str, str]]]:
...
class SslCertificatesRestTransport(SslCertificatesTransport):
    ...
    """
    _STUBS: Dict[str, SslCertificatesRestStub] = {}
    ...
    class _AggregatedList(SslCertificatesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.AggregatedListSslCertificatesRequest.to_dict(request)
            ...
            query_params = json.loads(compute.AggregatedListSslCertificatesRequest.to_json(
                compute.AggregatedListSslCertificatesRequest(transcoded_request['query_params']),
            ...
            # Return the response
            resp = compute.SslCertificateAggregatedList.from_json(
                response.content,
    ...
    class _Delete(SslCertificatesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.DeleteSslCertificateRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteSslCertificateRequest.to_json(
                compute.DeleteSslCertificateRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Get(SslCertificatesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.GetSslCertificateRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetSslCertificateRequest.to_json(
                compute.GetSslCertificateRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(SslCertificatesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.InsertSslCertificateRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = compute.SslCertificate.to_json(
                compute.SslCertificate(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertSslCertificateRequest.to_json(
                compute.InsertSslCertificateRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(SslCertificatesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.ListSslCertificatesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListSslCertificatesRequest.to_json(
                compute.ListSslCertificatesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
