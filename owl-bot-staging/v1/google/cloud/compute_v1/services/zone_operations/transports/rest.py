...
from .base import ZoneOperationsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ZoneOperationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteZoneOperationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteZoneOperationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetZoneOperationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetZoneOperationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListZoneOperationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListZoneOperationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_wait(self, request: compute.WaitZoneOperationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.WaitZoneOperationRequest, Sequence[Tuple[str, str]]]:
...
class ZoneOperationsRestTransport(ZoneOperationsTransport):
    ...
    class _Delete(ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteZoneOperationRequest.to_json(
    ...
    class _Get(ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetZoneOperationRequest.to_json(
    ...
    class _List(ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListZoneOperationsRequest.to_json(
    ...
    class _Wait(ZoneOperationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.WaitZoneOperationRequest.to_json(
