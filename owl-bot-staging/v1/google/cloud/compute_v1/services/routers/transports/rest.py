...
class RoutersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListRoutersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListRoutersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteRouterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetRouterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_nat_mapping_info(self, request: compute.GetNatMappingInfoRoutersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetNatMappingInfoRoutersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_router_status(self, request: compute.GetRouterStatusRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetRouterStatusRouterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertRouterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListRoutersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListRoutersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchRouterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_preview(self, request: compute.PreviewRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PreviewRouterRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update(self, request: compute.UpdateRouterRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.UpdateRouterRequest, Sequence[Tuple[str, str]]]:
...
class RoutersRestTransport(RoutersTransport):
    ...
    class _AggregatedList(RoutersRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListRoutersRequest.to_json(
                compute.AggregatedListRoutersRequest(transcoded_request['query_params']),
    ...
    class _Delete(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteRouterRequest.to_json(
    ...
    class _Get(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetRouterRequest.to_json(
    ...
    class _GetNatMappingInfo(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetNatMappingInfoRoutersRequest.to_json(
                compute.GetNatMappingInfoRoutersRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _GetRouterStatus(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetRouterStatusRouterRequest.to_json(
                compute.GetRouterStatusRouterRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(RoutersRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Router.to_json(
                compute.Router(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertRouterRequest.to_json(
    ...
    class _List(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListRoutersRequest.to_json(
    ...
    class _Patch(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchRouterRequest.to_json(
    ...
    class _Preview(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PreviewRouterRequest.to_json(
    ...
    class _Update(RoutersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.UpdateRouterRequest.to_json(
    ...
    def get_nat_mapping_info(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_nat_mapping_info"] = self._GetNatMappingInfo(self._session, self._host, self._interceptor)
    ...
    def get_router_status(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_router_status"] = self._GetRouterStatus(self._session, self._host, self._interceptor)
    ...
    def preview(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["preview"] = self._Preview(self._session, self._host, self._interceptor)
