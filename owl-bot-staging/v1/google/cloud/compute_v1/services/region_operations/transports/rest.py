...
class RegionOperationsRestTransport(RegionOperationsTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionOperationsRestTransport.__delete_required_fields_default_values.items() if k not in message_dict}
    ...
    def _delete(self,
        ...
        request_kwargs = compute.DeleteRegionOperationRequest.to_dict(request)
        ...
        query_params = json.loads(compute.DeleteRegionOperationRequest.to_json(
            compute.DeleteRegionOperationRequest(transcoded_request['query_params']),
    ...
    def _get(self,
        ...
        request_kwargs = compute.GetRegionOperationRequest.to_dict(request)
        transcoded_request = path_template.transcode(
            http_options, **request_kwargs)
        ...
        # Jsonify the query params
        query_params = json.loads(compute.GetRegionOperationRequest.to_json(
            compute.GetRegionOperationRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionOperationsRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list(self,
        ...
        request_kwargs = compute.ListRegionOperationsRequest.to_dict(request)
        transcoded_request = path_template.transcode(
            http_options, **request_kwargs)
        ...
        # Jsonify the query params
        query_params = json.loads(compute.ListRegionOperationsRequest.to_json(
            compute.ListRegionOperationsRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _wait(self,
        ...
        request_kwargs = compute.WaitRegionOperationRequest.to_dict(request)
        transcoded_request = path_template.transcode(
            http_options, **request_kwargs)
        ...
        # Jsonify the query params
        query_params = json.loads(compute.WaitRegionOperationRequest.to_json(
            compute.WaitRegionOperationRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
