...
class NodeTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListNodeTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListNodeTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetNodeTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetNodeTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListNodeTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListNodeTypesRequest, Sequence[Tuple[str, str]]]:
...
class NodeTypesRestTransport(NodeTypesTransport):
    """REST backend transport for NodeTypes.
    ...
    """
    _STUBS: Dict[str, NodeTypesRestStub] = {}
    ...
    class _AggregatedList(NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListNodeTypesRequest.to_json(
                compute.AggregatedListNodeTypesRequest(transcoded_request['query_params']),
    ...
    class _Get(NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetNodeTypeRequest.to_json(
    ...
    class _List(NodeTypesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListNodeTypesRequest.to_json(
                compute.ListNodeTypesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
