...
from .transports.base import RegionSslPoliciesTransport, DEFAULT_CLIENT_INFO
...
class RegionSslPoliciesClient(metaclass=RegionSslPoliciesClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Union[str, RegionSslPoliciesTransport, None] = None,
        ...
        if isinstance(transport, RegionSslPoliciesTransport):
    ...
    def delete_unary(self,
            request: Union[compute.DeleteRegionSslPolicyRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            ssl_policy: str = None,
    ...
    def get(self,
            request: Union[compute.GetRegionSslPolicyRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            ssl_policy: str = None,
    ...
    def insert_unary(self,
            request: Union[compute.InsertRegionSslPolicyRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
    ...
    def list(self,
            request: Union[compute.ListRegionSslPoliciesRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def list_available_features(self,
            request: Union[compute.ListAvailableFeaturesRegionSslPoliciesRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute.ListAvailableFeaturesRegionSslPoliciesRequest):
    ...
    def patch_unary(self,
            request: Union[compute.PatchRegionSslPolicyRequest, dict] = None,
            *,
            project: str = None,
            region: str = None,
            ssl_policy: str = None,
