...
from .base import InterconnectRemoteLocationsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class InterconnectRemoteLocationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetInterconnectRemoteLocationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetInterconnectRemoteLocationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get(self, response: compute.InterconnectRemoteLocation) -> compute.InterconnectRemoteLocation:
        ...
        """
        return response
    def pre_list(self, request: compute.ListInterconnectRemoteLocationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListInterconnectRemoteLocationsRequest, Sequence[Tuple[str, str]]]:
...
class InterconnectRemoteLocationsRestTransport(InterconnectRemoteLocationsTransport):
    """REST backend transport for InterconnectRemoteLocations.
    ...
    class _Get(InterconnectRemoteLocationsRestStub):
        def __hash__(self):
            return hash("Get")
    ...
    class _List(InterconnectRemoteLocationsRestStub):
        def __hash__(self):
            return hash("List")
