...
class SnapshotsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_insert(self, request: compute.InsertSnapshotRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertSnapshotRequest, Sequence[Tuple[str, str]]]:
...
class SnapshotsRestTransport(SnapshotsTransport):
    ...
    class _Insert(SnapshotsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertSnapshotRequest.to_json(
