...
class LicensesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteLicenseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteLicenseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetLicenseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetLicenseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyLicenseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetIamPolicyLicenseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertLicenseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertLicenseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListLicensesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListLicensesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyLicenseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetIamPolicyLicenseRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsLicenseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsLicenseRequest, Sequence[Tuple[str, str]]]:
...
class LicensesRestTransport(LicensesTransport):
    ...
    class _Delete(LicensesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteLicenseRequest.to_json(
    ...
    class _Get(LicensesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetLicenseRequest.to_json(
    ...
    class _GetIamPolicy(LicensesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyLicenseRequest.to_json(
    ...
    class _Insert(LicensesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.License.to_json(
                compute.License(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertLicenseRequest.to_json(
    ...
    class _List(LicensesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListLicensesRequest.to_json(
    ...
    class _SetIamPolicy(LicensesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyLicenseRequest.to_json(
    ...
    class _TestIamPermissions(LicensesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsLicenseRequest.to_json(
                compute.TestIamPermissionsLicenseRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
