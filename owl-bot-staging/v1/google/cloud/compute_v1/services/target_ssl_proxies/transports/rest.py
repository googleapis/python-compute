...
class TargetSslProxiesRestTransport(TargetSslProxiesTransport):
    ...
    class _SetCertificateMap(TargetSslProxiesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.SetCertificateMapTargetSslProxyRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = compute.TargetSslProxiesSetCertificateMapRequest.to_json(
                compute.TargetSslProxiesSetCertificateMapRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetCertificateMapTargetSslProxyRequest.to_json(
                compute.SetCertificateMapTargetSslProxyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
