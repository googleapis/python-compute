...
class TargetSslProxiesRestTransport(TargetSslProxiesTransport):
    ...
    def set_backend_service(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_backend_service"] = self._SetBackendService(self._session, self._host, self._interceptor)
    ...
    def set_proxy_header(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_proxy_header"] = self._SetProxyHeader(self._session, self._host, self._interceptor)
