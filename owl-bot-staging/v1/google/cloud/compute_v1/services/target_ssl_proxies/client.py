...
class TargetSslProxiesClient(metaclass=TargetSslProxiesClientMeta):
    ...
    def set_backend_service_unary(self,
            request: Optional[Union[compute.SetBackendServiceTargetSslProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_ssl_proxy: Optional[str] = None,
            target_ssl_proxies_set_backend_service_request_resource: Optional[compute.TargetSslProxiesSetBackendServiceRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_ssl_proxy, target_ssl_proxies_set_backend_service_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetBackendServiceTargetSslProxyRequest):
            ...
            if target_ssl_proxies_set_backend_service_request_resource is not None:
                request.target_ssl_proxies_set_backend_service_request_resource = target_ssl_proxies_set_backend_service_request_resource
    ...
    def set_certificate_map_unary(self,
            request: Optional[Union[compute.SetCertificateMapTargetSslProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_ssl_proxy: Optional[str] = None,
            target_ssl_proxies_set_certificate_map_request_resource: Optional[compute.TargetSslProxiesSetCertificateMapRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        if not isinstance(request, compute.SetCertificateMapTargetSslProxyRequest):
            ...
            if target_ssl_proxies_set_certificate_map_request_resource is not None:
                request.target_ssl_proxies_set_certificate_map_request_resource = target_ssl_proxies_set_certificate_map_request_resource
    ...
    def set_proxy_header_unary(self,
            request: Optional[Union[compute.SetProxyHeaderTargetSslProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_ssl_proxy: Optional[str] = None,
            target_ssl_proxies_set_proxy_header_request_resource: Optional[compute.TargetSslProxiesSetProxyHeaderRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_ssl_proxy, target_ssl_proxies_set_proxy_header_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetProxyHeaderTargetSslProxyRequest):
            ...
            if target_ssl_proxies_set_proxy_header_request_resource is not None:
                request.target_ssl_proxies_set_proxy_header_request_resource = target_ssl_proxies_set_proxy_header_request_resource
    ...
    def set_ssl_certificates_unary(self,
            request: Optional[Union[compute.SetSslCertificatesTargetSslProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_ssl_proxy: Optional[str] = None,
            target_ssl_proxies_set_ssl_certificates_request_resource: Optional[compute.TargetSslProxiesSetSslCertificatesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_ssl_proxy, target_ssl_proxies_set_ssl_certificates_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetSslCertificatesTargetSslProxyRequest):
            ...
            if target_ssl_proxies_set_ssl_certificates_request_resource is not None:
                request.target_ssl_proxies_set_ssl_certificates_request_resource = target_ssl_proxies_set_ssl_certificates_request_resource
    ...
    def set_ssl_policy_unary(self,
            request: Optional[Union[compute.SetSslPolicyTargetSslProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_ssl_proxy: Optional[str] = None,
