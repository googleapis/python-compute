...
class DiskTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListDiskTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListDiskTypesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_aggregated_list(self, response: compute.DiskTypeAggregatedList) -> compute.DiskTypeAggregatedList:
    ...
    def pre_get(self, request: compute.GetDiskTypeRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetDiskTypeRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListDiskTypesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListDiskTypesRequest, Sequence[Tuple[str, str]]]:
...
class DiskTypesRestTransport(DiskTypesTransport):
    ...
    """
    _STUBS: Dict[str, DiskTypesRestStub] = {}
    ...
    class _AggregatedList(DiskTypesRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.AggregatedListDiskTypesRequest.to_dict(request)
            ...
            query_params = json.loads(compute.AggregatedListDiskTypesRequest.to_json(
                compute.AggregatedListDiskTypesRequest(transcoded_request['query_params']),
            ...
            # Return the response
            resp = compute.DiskTypeAggregatedList.from_json(
                response.content,
    ...
    class _Get(DiskTypesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetDiskTypeRequest.to_json(
    ...
    class _List(DiskTypesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.ListDiskTypesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListDiskTypesRequest.to_json(
                compute.ListDiskTypesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = compute.DiskTypeList.from_json(
                response.content,
                ignore_unknown_fields=True
            )
