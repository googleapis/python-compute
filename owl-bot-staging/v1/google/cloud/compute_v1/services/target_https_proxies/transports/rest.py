...
class TargetHttpsProxiesRestTransport(TargetHttpsProxiesTransport):
    ...
    def set_quic_override(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_quic_override"] = self._SetQuicOverride(self._session, self._host)
    ...
    def set_ssl_certificates(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_ssl_certificates"] = self._SetSslCertificates(self._session, self._host)
    ...
    def set_ssl_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_ssl_policy"] = self._SetSslPolicy(self._session, self._host)
    ...
    def set_url_map(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_url_map"] = self._SetUrlMap(self._session, self._host)
