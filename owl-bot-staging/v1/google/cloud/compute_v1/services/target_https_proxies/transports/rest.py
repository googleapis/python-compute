...
class TargetHttpsProxiesRestTransport(TargetHttpsProxiesTransport):
    ...
    """
    _STUBS: Dict[str, TargetHttpsProxiesRestStub] = {}
    ...
    def set_quic_override(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_quic_override"] = self._SetQuicOverride(self._session, self._host, self._interceptor)
    ...
    def set_ssl_certificates(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_ssl_certificates"] = self._SetSslCertificates(self._session, self._host, self._interceptor)
    ...
    def set_ssl_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_ssl_policy"] = self._SetSslPolicy(self._session, self._host, self._interceptor)
