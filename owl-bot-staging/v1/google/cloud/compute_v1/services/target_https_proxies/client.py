...
class TargetHttpsProxiesClient(metaclass=TargetHttpsProxiesClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, TargetHttpsProxiesTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, TargetHttpsProxiesTransport]): The
        ...
        if isinstance(transport, TargetHttpsProxiesTransport):
    ...
    def aggregated_list(self,
            request: Optional[Union[compute.AggregatedListTargetHttpsProxiesRequest, dict]] = None,
            *,
        ...
        # in a compute.AggregatedListTargetHttpsProxiesRequest.
    ...
    def get(self,
        ...
        r"""Returns the specified TargetHttpsProxy resource. Gets
        a list of available target HTTPS proxies by making a
        list() request.
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetTargetHttpsProxyRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.ListTargetHttpsProxiesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def patch_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_https_proxy, target_https_proxy_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_certificate_map_unary(self,
            request: Optional[Union[compute.SetCertificateMapTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
            target_https_proxies_set_certificate_map_request_resource: Optional[compute.TargetHttpsProxiesSetCertificateMapRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_https_proxy, target_https_proxies_set_certificate_map_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')

        # Minor optimization to avoid making a copy if the user passes
        # in a compute.SetCertificateMapTargetHttpsProxyRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, compute.SetCertificateMapTargetHttpsProxyRequest):
            ...
            if target_https_proxies_set_certificate_map_request_resource is not None:
                request.target_https_proxies_set_certificate_map_request_resource = target_https_proxies_set_certificate_map_request_resource
    ...
    def set_quic_override_unary(self,
            request: Optional[Union[compute.SetQuicOverrideTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
            target_https_proxies_set_quic_override_request_resource: Optional[compute.TargetHttpsProxiesSetQuicOverrideRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_https_proxy, target_https_proxies_set_quic_override_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetQuicOverrideTargetHttpsProxyRequest):
            ...
            if target_https_proxies_set_quic_override_request_resource is not None:
                request.target_https_proxies_set_quic_override_request_resource = target_https_proxies_set_quic_override_request_resource
    ...
    def set_ssl_certificates_unary(self,
            request: Optional[Union[compute.SetSslCertificatesTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
            target_https_proxies_set_ssl_certificates_request_resource: Optional[compute.TargetHttpsProxiesSetSslCertificatesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_https_proxy, target_https_proxies_set_ssl_certificates_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.SetSslCertificatesTargetHttpsProxyRequest):
            ...
            if target_https_proxies_set_ssl_certificates_request_resource is not None:
                request.target_https_proxies_set_ssl_certificates_request_resource = target_https_proxies_set_ssl_certificates_request_resource
    ...
    def set_ssl_policy_unary(self,
            request: Optional[Union[compute.SetSslPolicyTargetHttpsProxyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            target_https_proxy: Optional[str] = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_https_proxy, ssl_policy_reference_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def set_url_map_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, target_https_proxy, url_map_reference_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
