...
class FirewallsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteFirewallRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteFirewallRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetFirewallRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetFirewallRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertFirewallRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertFirewallRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListFirewallsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListFirewallsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchFirewallRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchFirewallRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update(self, request: compute.UpdateFirewallRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.UpdateFirewallRequest, Sequence[Tuple[str, str]]]:
...
class FirewallsRestTransport(FirewallsTransport):
    ...
    class _Delete(FirewallsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteFirewallRequest.to_json(
    ...
    class _Get(FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetFirewallRequest.to_json(
    ...
    class _Insert(FirewallsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Firewall.to_json(
                compute.Firewall(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertFirewallRequest.to_json(
    ...
    class _List(FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListFirewallsRequest.to_json(
    ...
    class _Patch(FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchFirewallRequest.to_json(
    ...
    class _Update(FirewallsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.UpdateFirewallRequest.to_json(
