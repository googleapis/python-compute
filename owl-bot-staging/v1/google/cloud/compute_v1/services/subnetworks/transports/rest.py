...
class SubnetworksRestTransport(SubnetworksTransport):
    ...
    def expand_ip_cidr_range(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["expand_ip_cidr_range"] = self._ExpandIpCidrRange(self._session, self._host)
    ...
    def list_usable(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_usable"] = self._ListUsable(self._session, self._host)
    ...
    def set_private_ip_google_access(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_private_ip_google_access"] = self._SetPrivateIpGoogleAccess(self._session, self._host)
