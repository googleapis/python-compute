...
class SslPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListSslPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListSslPoliciesRequest, Sequence[Tuple[str, str]]]:
...
class SslPoliciesRestTransport(SslPoliciesTransport):
    ...
    class _AggregatedList(SslPoliciesRestStub):
        def __hash__(self):
