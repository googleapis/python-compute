...
class SslPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteSslPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteSslPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetSslPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetSslPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertSslPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertSslPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListSslPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListSslPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_available_features(self, request: compute.ListAvailableFeaturesSslPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListAvailableFeaturesSslPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchSslPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchSslPolicyRequest, Sequence[Tuple[str, str]]]:
...
class SslPoliciesRestTransport(SslPoliciesTransport):
    ...
    class _Delete(SslPoliciesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteSslPolicyRequest.to_json(
    ...
    class _Get(SslPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetSslPolicyRequest.to_json(
    ...
    class _Insert(SslPoliciesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.SslPolicy.to_json(
                compute.SslPolicy(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertSslPolicyRequest.to_json(
    ...
    class _List(SslPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListSslPoliciesRequest.to_json(
    ...
    class _ListAvailableFeatures(SslPoliciesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.ListAvailableFeaturesSslPoliciesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListAvailableFeaturesSslPoliciesRequest.to_json(
                compute.ListAvailableFeaturesSslPoliciesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Patch(SslPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchSslPolicyRequest.to_json(
    ...
    def list_available_features(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_available_features"] = self._ListAvailableFeatures(self._session, self._host, self._interceptor)
