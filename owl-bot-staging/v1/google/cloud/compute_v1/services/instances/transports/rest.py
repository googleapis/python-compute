...
class InstancesRestTransport(InstancesTransport):
    ...
    class _SetDiskAutoDelete(InstancesRestStub):
        ...
        __REQUIRED_FIELDS_DEFAULT_VALUES =  {
            "autoDelete" : False,            "deviceName" : "",            "instance" : "",            "project" : "",            "zone" : "",        }
    ...
    def add_access_config(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_access_config"] = self._AddAccessConfig(self._session, self._host)
    ...
    def add_resource_policies(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_resource_policies"] = self._AddResourcePolicies(self._session, self._host)
    ...
    def attach_disk(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["attach_disk"] = self._AttachDisk(self._session, self._host)
    ...
    def bulk_insert(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["bulk_insert"] = self._BulkInsert(self._session, self._host)
    ...
    def delete_access_config(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["delete_access_config"] = self._DeleteAccessConfig(self._session, self._host)
    ...
    def detach_disk(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["detach_disk"] = self._DetachDisk(self._session, self._host)
    ...
    def get_effective_firewalls(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_effective_firewalls"] = self._GetEffectiveFirewalls(self._session, self._host)
    ...
    def get_guest_attributes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_guest_attributes"] = self._GetGuestAttributes(self._session, self._host)
    ...
    def get_iam_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_iam_policy"] = self._GetIamPolicy(self._session, self._host)
    ...
    def get_screenshot(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_screenshot"] = self._GetScreenshot(self._session, self._host)
    ...
    def get_serial_port_output(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_serial_port_output"] = self._GetSerialPortOutput(self._session, self._host)
    ...
    def get_shielded_instance_identity(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_shielded_instance_identity"] = self._GetShieldedInstanceIdentity(self._session, self._host)
    ...
    def list_referrers(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_referrers"] = self._ListReferrers(self._session, self._host)
    ...
    def remove_resource_policies(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_resource_policies"] = self._RemoveResourcePolicies(self._session, self._host)
    ...
    def send_diagnostic_interrupt(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["send_diagnostic_interrupt"] = self._SendDiagnosticInterrupt(self._session, self._host)
    ...
    def set_deletion_protection(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_deletion_protection"] = self._SetDeletionProtection(self._session, self._host)
    ...
    def set_disk_auto_delete(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_disk_auto_delete"] = self._SetDiskAutoDelete(self._session, self._host)
    ...
    def set_iam_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_iam_policy"] = self._SetIamPolicy(self._session, self._host)
    ...
    def set_labels(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_labels"] = self._SetLabels(self._session, self._host)
    ...
    def set_machine_resources(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_machine_resources"] = self._SetMachineResources(self._session, self._host)
    ...
    def set_machine_type(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_machine_type"] = self._SetMachineType(self._session, self._host)
    ...
    def set_metadata(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_metadata"] = self._SetMetadata(self._session, self._host)
    ...
    def set_min_cpu_platform(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_min_cpu_platform"] = self._SetMinCpuPlatform(self._session, self._host)
    ...
    def set_scheduling(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_scheduling"] = self._SetScheduling(self._session, self._host)
    ...
    def set_service_account(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_service_account"] = self._SetServiceAccount(self._session, self._host)
    ...
    def set_shielded_instance_integrity_policy(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_shielded_instance_integrity_policy"] = self._SetShieldedInstanceIntegrityPolicy(self._session, self._host)
    ...
    def simulate_maintenance_event(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["simulate_maintenance_event"] = self._SimulateMaintenanceEvent(self._session, self._host)
    ...
    def start_with_encryption_key(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["start_with_encryption_key"] = self._StartWithEncryptionKey(self._session, self._host)
    ...
    def test_iam_permissions(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["test_iam_permissions"] = self._TestIamPermissions(self._session, self._host)
    ...
    def update_access_config(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["update_access_config"] = self._UpdateAccessConfig(self._session, self._host)
    ...
    def update_display_device(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["update_display_device"] = self._UpdateDisplayDevice(self._session, self._host)
    ...
    def update_network_interface(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["update_network_interface"] = self._UpdateNetworkInterface(self._session, self._host)
    ...
    def update_shielded_instance_config(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["update_shielded_instance_config"] = self._UpdateShieldedInstanceConfig(self._session, self._host)
