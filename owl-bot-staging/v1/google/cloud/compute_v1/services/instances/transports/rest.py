...
class InstancesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_set_min_cpu_platform(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_name(self, request: compute.SetNameInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetNameInstanceRequest, Sequence[Tuple[str, str]]]:
