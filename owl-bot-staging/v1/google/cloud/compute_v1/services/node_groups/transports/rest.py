...
class NodeGroupsRestTransport(NodeGroupsTransport):
    ...
    def add_nodes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_nodes"] = self._AddNodes(self._session, self._host, self._interceptor)
    ...
    def delete_nodes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["delete_nodes"] = self._DeleteNodes(self._session, self._host, self._interceptor)
    ...
    def list_nodes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_nodes"] = self._ListNodes(self._session, self._host, self._interceptor)
    ...
    def set_node_template(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_node_template"] = self._SetNodeTemplate(self._session, self._host, self._interceptor)
