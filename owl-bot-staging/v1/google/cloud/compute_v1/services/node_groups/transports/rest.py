...
class NodeGroupsRestTransport(NodeGroupsTransport):
    ...
    class _AddNodes(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NodeGroupsAddNodesRequest.to_json(
                compute.NodeGroupsAddNodesRequest(transcoded_request['body']),                including_default_value_fields=False,
            ...
            query_params = json.loads(compute.AddNodesNodeGroupRequest.to_json(
    ...
    class _AggregatedList(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.AggregatedListNodeGroupsRequest.to_json(
                compute.AggregatedListNodeGroupsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Delete(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteNodeGroupRequest.to_json(
    ...
    class _DeleteNodes(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NodeGroupsDeleteNodesRequest.to_json(
                compute.NodeGroupsDeleteNodesRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteNodesNodeGroupRequest.to_json(
    ...
    class _Get(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetNodeGroupRequest.to_json(
    ...
    class _GetIamPolicy(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyNodeGroupRequest.to_json(
                compute.GetIamPolicyNodeGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(NodeGroupsRestStub):
        ...
        __REQUIRED_FIELDS_DEFAULT_VALUES =  {
            "initialNodeCount" : 0,            "project" : "",            "zone" : "",        }
        ...
        def __call__(self,
            ...
            body = compute.NodeGroup.to_json(
                compute.NodeGroup(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertNodeGroupRequest.to_json(
    ...
    class _List(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListNodeGroupsRequest.to_json(
    ...
    class _ListNodes(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListNodesNodeGroupsRequest.to_json(
    ...
    class _Patch(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchNodeGroupRequest.to_json(
    ...
    class _SetIamPolicy(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyNodeGroupRequest.to_json(
                compute.SetIamPolicyNodeGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _SetNodeTemplate(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NodeGroupsSetNodeTemplateRequest.to_json(
                compute.NodeGroupsSetNodeTemplateRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetNodeTemplateNodeGroupRequest.to_json(
                compute.SetNodeTemplateNodeGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(NodeGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsNodeGroupRequest.to_json(
                compute.TestIamPermissionsNodeGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def delete_nodes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["delete_nodes"] = self._DeleteNodes(self._session, self._host)
    ...
    def list_nodes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_nodes"] = self._ListNodes(self._session, self._host)
    ...
    def set_node_template(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_node_template"] = self._SetNodeTemplate(self._session, self._host)
