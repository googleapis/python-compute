...
class NodeGroupsClient(metaclass=NodeGroupsClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, NodeGroupsTransport):
    ...
    def add_nodes_unary(self,
        ...
        has_flattened_params = any([project, zone, node_group, node_groups_add_nodes_request_resource])
    ...
    def delete_nodes_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, node_group, node_groups_delete_nodes_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def insert_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, initial_node_count, node_group_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def simulate_maintenance_event_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, node_group, node_groups_simulate_maintenance_event_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
