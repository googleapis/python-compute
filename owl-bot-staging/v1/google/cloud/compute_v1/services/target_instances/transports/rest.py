...
class TargetInstancesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListTargetInstancesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListTargetInstancesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteTargetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteTargetInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetTargetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetTargetInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertTargetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertTargetInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListTargetInstancesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListTargetInstancesRequest, Sequence[Tuple[str, str]]]:
