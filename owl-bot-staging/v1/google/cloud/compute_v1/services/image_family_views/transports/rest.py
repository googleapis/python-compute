...
from .base import ImageFamilyViewsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ImageFamilyViewsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetImageFamilyViewRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetImageFamilyViewRequest, Sequence[Tuple[str, str]]]:
...
class ImageFamilyViewsRestTransport(ImageFamilyViewsTransport):
    """REST backend transport for ImageFamilyViews.
    ...
    class _Get(ImageFamilyViewsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.GetImageFamilyViewRequest.to_json(
                compute.GetImageFamilyViewRequest(transcoded_request['query_params']),
