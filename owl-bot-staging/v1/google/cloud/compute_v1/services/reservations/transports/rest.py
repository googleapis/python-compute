...
class ReservationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListReservationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListReservationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetIamPolicyReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListReservationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListReservationsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_resize(self, request: compute.ResizeReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ResizeReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetIamPolicyReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsReservationRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update(self, request: compute.UpdateReservationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.UpdateReservationRequest, Sequence[Tuple[str, str]]]:
...
class ReservationsRestTransport(ReservationsTransport):
    ...
    class _AggregatedList(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListReservationsRequest.to_json(
                compute.AggregatedListReservationsRequest(transcoded_request['query_params']),
            ...
            # Return the response
            resp = compute.ReservationAggregatedList.from_json(
                response.content,
    ...
    class _Delete(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteReservationRequest.to_json(
                compute.DeleteReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Get(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetReservationRequest.to_json(
            ...
            # Return the response
            resp = compute.Reservation.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _GetIamPolicy(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyReservationRequest.to_json(
                compute.GetIamPolicyReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Reservation.to_json(
                compute.Reservation(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertReservationRequest.to_json(
                compute.InsertReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListReservationsRequest.to_json(
            ...
            # Return the response
            resp = compute.ReservationList.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _Resize(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.ReservationsResizeRequest.to_json(
                compute.ReservationsResizeRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ResizeReservationRequest.to_json(
                compute.ResizeReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _SetIamPolicy(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyReservationRequest.to_json(
                compute.SetIamPolicyReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(ReservationsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsReservationRequest.to_json(
                compute.TestIamPermissionsReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Update(ReservationsRestStub):
        def __hash__(self):
            return hash("Update")
        ...
        def __call__(self,
            ...
            request_kwargs = compute.UpdateReservationRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.UpdateReservationRequest.to_json(
                compute.UpdateReservationRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
