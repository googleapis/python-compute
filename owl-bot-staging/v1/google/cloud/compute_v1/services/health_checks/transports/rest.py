...
class HealthChecksRestTransport(HealthChecksTransport):
    ...
    class _AggregatedList(HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            # Return the response
            resp = compute.HealthChecksAggregatedList.from_json(
                response.content,
    ...
    class _Get(HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            # Return the response
            resp = compute.HealthCheck.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _Insert(HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            body = compute.HealthCheck.to_json(
                compute.HealthCheck(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _List(HealthChecksRestStub):
        ...
        def __call__(self,
            ...
            # Return the response
            resp = compute.HealthCheckList.from_json(
                response.content,
                ignore_unknown_fields=True
            )
