...
class DisksClient(metaclass=DisksClientMeta):
    ...
    def add_resource_policies_unary(self,
            ...
            *,
            ...
            disks_add_resource_policies_request_resource: Optional[compute.DisksAddResourcePoliciesRequest] = None,
        ...
        has_flattened_params = any([project, zone, disk, disks_add_resource_policies_request_resource])
        ...
        if not isinstance(request, compute.AddResourcePoliciesDiskRequest):
            ...
            if disks_add_resource_policies_request_resource is not None:
                request.disks_add_resource_policies_request_resource = disks_add_resource_policies_request_resource
    ...
    def remove_resource_policies_unary(self,
            request: Optional[Union[compute.RemoveResourcePoliciesDiskRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
            disk: Optional[str] = None,
            disks_remove_resource_policies_request_resource: Optional[compute.DisksRemoveResourcePoliciesRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, disk, disks_remove_resource_policies_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.RemoveResourcePoliciesDiskRequest):
            ...
            if disks_remove_resource_policies_request_resource is not None:
                request.disks_remove_resource_policies_request_resource = disks_remove_resource_policies_request_resource
    ...
    def start_async_replication_unary(self,
            ...
            *,
            ...
            zone: Optional[str] = None,
            disk: Optional[str] = None,
            disks_start_async_replication_request_resource: Optional[compute.DisksStartAsyncReplicationRequest] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
            ) -> compute.Operation:
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, disk, disks_start_async_replication_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        if not isinstance(request, compute.StartAsyncReplicationDiskRequest):
            ...
            if disks_start_async_replication_request_resource is not None:
                request.disks_start_async_replication_request_resource = disks_start_async_replication_request_resource
    ...
    def stop_group_async_replication_unary(self,
            request: Optional[Union[compute.StopGroupAsyncReplicationDiskRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            zone: Optional[str] = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, disks_stop_group_async_replication_resource_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
