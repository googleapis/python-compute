...
class ProjectsRestTransport(ProjectsTransport):
    ...
    def disable_xpn_host(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["disable_xpn_host"] = self._DisableXpnHost(self._session, self._host)
    ...
    def disable_xpn_resource(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["disable_xpn_resource"] = self._DisableXpnResource(self._session, self._host)
    ...
    def enable_xpn_host(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["enable_xpn_host"] = self._EnableXpnHost(self._session, self._host)
    ...
    def enable_xpn_resource(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["enable_xpn_resource"] = self._EnableXpnResource(self._session, self._host)
    ...
    def get_xpn_host(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_xpn_host"] = self._GetXpnHost(self._session, self._host)
    ...
    def get_xpn_resources(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_xpn_resources"] = self._GetXpnResources(self._session, self._host)
    ...
    def list_xpn_hosts(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_xpn_hosts"] = self._ListXpnHosts(self._session, self._host)
    ...
    def move_instance(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["move_instance"] = self._MoveInstance(self._session, self._host)
    ...
    def set_common_instance_metadata(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_common_instance_metadata"] = self._SetCommonInstanceMetadata(self._session, self._host)
    ...
    def set_default_network_tier(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_default_network_tier"] = self._SetDefaultNetworkTier(self._session, self._host)
    ...
    def set_usage_export_bucket(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_usage_export_bucket"] = self._SetUsageExportBucket(self._session, self._host)
