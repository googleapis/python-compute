...
class TargetPoolsRestTransport(TargetPoolsTransport):
    ...
    def add_health_check(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_health_check"] = self._AddHealthCheck(self._session, self._host)
    ...
    def add_instance(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_instance"] = self._AddInstance(self._session, self._host)
    ...
    def get_health(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_health"] = self._GetHealth(self._session, self._host)
    ...
    def remove_health_check(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_health_check"] = self._RemoveHealthCheck(self._session, self._host)
    ...
    def remove_instance(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_instance"] = self._RemoveInstance(self._session, self._host)
    ...
    def set_backup(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_backup"] = self._SetBackup(self._session, self._host)
