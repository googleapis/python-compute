...
class TargetPoolsRestTransport(TargetPoolsTransport):
    ...
    class _AddHealthCheck(TargetPoolsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetPoolsAddHealthCheckRequest.to_json(
                compute.TargetPoolsAddHealthCheckRequest(transcoded_request['body']),                including_default_value_fields=False,
    ...
    class _AddInstance(TargetPoolsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetPoolsAddInstanceRequest.to_json(
                compute.TargetPoolsAddInstanceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _GetHealth(TargetPoolsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InstanceReference.to_json(
                compute.InstanceReference(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _Insert(TargetPoolsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetPool.to_json(
                compute.TargetPool(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _RemoveHealthCheck(TargetPoolsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetPoolsRemoveHealthCheckRequest.to_json(
                compute.TargetPoolsRemoveHealthCheckRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _RemoveInstance(TargetPoolsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetPoolsRemoveInstanceRequest.to_json(
                compute.TargetPoolsRemoveInstanceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    def add_health_check(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_health_check"] = self._AddHealthCheck(self._session, self._host, self._interceptor)
    ...
    def add_instance(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_instance"] = self._AddInstance(self._session, self._host, self._interceptor)
    ...
    def remove_health_check(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_health_check"] = self._RemoveHealthCheck(self._session, self._host, self._interceptor)
    ...
    def remove_instance(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_instance"] = self._RemoveInstance(self._session, self._host, self._interceptor)
    ...
    def set_backup(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_backup"] = self._SetBackup(self._session, self._host, self._interceptor)
