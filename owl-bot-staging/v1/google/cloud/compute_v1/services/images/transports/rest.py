...
class ImagesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_deprecate(self, request: compute.DeprecateImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeprecateImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_from_family(self, request: compute.GetFromFamilyImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetFromFamilyImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetIamPolicyImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListImagesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListImagesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetIamPolicyImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_labels(self, request: compute.SetLabelsImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsImageRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsImageRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsImageRequest, Sequence[Tuple[str, str]]]:
...
class ImagesRestTransport(ImagesTransport):
    ...
    class _Delete(ImagesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteImageRequest.to_json(
    ...
    class _Deprecate(ImagesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.DeprecationStatus.to_json(
                compute.DeprecationStatus(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeprecateImageRequest.to_json(
    ...
    class _Get(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetImageRequest.to_json(
    ...
    class _GetFromFamily(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetFromFamilyImageRequest.to_json(
    ...
    class _GetIamPolicy(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyImageRequest.to_json(
    ...
    class _Insert(ImagesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Image.to_json(
                compute.Image(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertImageRequest.to_json(
    ...
    class _List(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListImagesRequest.to_json(
    ...
    class _Patch(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchImageRequest.to_json(
    ...
    class _SetIamPolicy(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyImageRequest.to_json(
    ...
    class _SetLabels(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetLabelsImageRequest.to_json(
    ...
    class _TestIamPermissions(ImagesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsImageRequest.to_json(
                compute.TestIamPermissionsImageRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def deprecate(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["deprecate"] = self._Deprecate(self._session, self._host, self._interceptor)
    ...
    def get_from_family(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["get_from_family"] = self._GetFromFamily(self._session, self._host, self._interceptor)
