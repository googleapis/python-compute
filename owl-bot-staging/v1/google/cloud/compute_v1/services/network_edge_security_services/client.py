...
class NetworkEdgeSecurityServicesClient(metaclass=NetworkEdgeSecurityServicesClientMeta):
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            transport (Union[str, NetworkEdgeSecurityServicesTransport]): The
        ...
        if isinstance(transport, NetworkEdgeSecurityServicesTransport):
    ...
    def aggregated_list(self,
            request: Union[compute.AggregatedListNetworkEdgeSecurityServicesRequest, dict] = None,
            *,
            project: str = None,
        ...
        # in a compute.AggregatedListNetworkEdgeSecurityServicesRequest.
    ...
    def get(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a compute.GetNetworkEdgeSecurityServiceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def insert_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, network_edge_security_service_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def patch_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, network_edge_security_service, network_edge_security_service_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
