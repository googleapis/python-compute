...
from .base import RegionSecurityPoliciesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RegionSecurityPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteRegionSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteRegionSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetRegionSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetRegionSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertRegionSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertRegionSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListRegionSecurityPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListRegionSecurityPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchRegionSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchRegionSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
...
class RegionSecurityPoliciesRestTransport(RegionSecurityPoliciesTransport):
    ...
    class _Delete(RegionSecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteRegionSecurityPolicyRequest.to_json(
                compute.DeleteRegionSecurityPolicyRequest(transcoded_request['query_params']),
    ...
    class _Get(RegionSecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetRegionSecurityPolicyRequest.to_json(
                compute.GetRegionSecurityPolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(RegionSecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertRegionSecurityPolicyRequest.to_json(
                compute.InsertRegionSecurityPolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(RegionSecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListRegionSecurityPoliciesRequest.to_json(
                compute.ListRegionSecurityPoliciesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Patch(RegionSecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchRegionSecurityPolicyRequest.to_json(
                compute.PatchRegionSecurityPolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
