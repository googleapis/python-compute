...
class RegionSecurityPoliciesClient(metaclass=RegionSecurityPoliciesClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, RegionSecurityPoliciesTransport):
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteRegionSecurityPolicyRequest, dict]] = None,
            *,
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertRegionSecurityPolicyRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
    ...
    def list(self,
            request: Optional[Union[compute.ListRegionSecurityPoliciesRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def patch_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, region, security_policy, security_policy_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
