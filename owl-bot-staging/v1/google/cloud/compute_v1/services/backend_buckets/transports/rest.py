...
class BackendBucketsRestTransport(BackendBucketsTransport):
    ...
    """
    _STUBS: Dict[str, BackendBucketsRestStub] = {}
    ...
    class _Insert(BackendBucketsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.BackendBucket.to_json(
                compute.BackendBucket(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _SetEdgeSecurityPolicy(BackendBucketsRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.SetEdgeSecurityPolicyBackendBucketRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetEdgeSecurityPolicyBackendBucketRequest.to_json(
                compute.SetEdgeSecurityPolicyBackendBucketRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
