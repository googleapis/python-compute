...
class BackendBucketsRestTransport(BackendBucketsTransport):
    ...
    def _add_signed_url_key_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__add_signed_url_key_required_fields_default_values.items() if k not in message_dict}
    ...
    def _add_signed_url_key(self,
        ...
        request_kwargs = compute.AddSignedUrlKeyBackendBucketRequest.to_dict(request)
        ...
        query_params = json.loads(compute.AddSignedUrlKeyBackendBucketRequest.to_json(
            compute.AddSignedUrlKeyBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__delete_required_fields_default_values.items() if k not in message_dict}
    ...
    def _delete(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.DeleteBackendBucketRequest.to_json(
            compute.DeleteBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _delete_signed_url_key_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__delete_signed_url_key_required_fields_default_values.items() if k not in message_dict}
    ...
    def _delete_signed_url_key(self,
        ...
        request_kwargs = compute.DeleteSignedUrlKeyBackendBucketRequest.to_dict(request)
        transcoded_request = path_template.transcode(
            http_options, **request_kwargs)
        ...
        # Jsonify the query params
        query_params = json.loads(compute.DeleteSignedUrlKeyBackendBucketRequest.to_json(
            compute.DeleteSignedUrlKeyBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _get_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__get_required_fields_default_values.items() if k not in message_dict}
    ...
    def _get(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.GetBackendBucketRequest.to_json(
            compute.GetBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__insert_required_fields_default_values.items() if k not in message_dict}
    ...
    def _insert(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.InsertBackendBucketRequest.to_json(
            compute.InsertBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.ListBackendBucketsRequest.to_json(
            compute.ListBackendBucketsRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__patch_required_fields_default_values.items() if k not in message_dict}
    ...
    def _patch(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.PatchBackendBucketRequest.to_json(
            compute.PatchBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _update_get_unset_required_fields(message_dict):
        return {k: v for k, v in BackendBucketsRestTransport.__update_required_fields_default_values.items() if k not in message_dict}
    ...
    def _update(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.UpdateBackendBucketRequest.to_json(
            compute.UpdateBackendBucketRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
