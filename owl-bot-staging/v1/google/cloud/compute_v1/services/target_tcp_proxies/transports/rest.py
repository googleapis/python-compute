    ...
    class _Insert(TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetTcpProxy.to_json(
                compute.TargetTcpProxy(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _SetBackendService(TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetTcpProxiesSetBackendServiceRequest.to_json(
                compute.TargetTcpProxiesSetBackendServiceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _SetProxyHeader(TargetTcpProxiesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.TargetTcpProxiesSetProxyHeaderRequest.to_json(
                compute.TargetTcpProxiesSetProxyHeaderRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
