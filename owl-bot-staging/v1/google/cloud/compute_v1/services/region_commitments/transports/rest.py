...
from .base import RegionCommitmentsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class RegionCommitmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListRegionCommitmentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListRegionCommitmentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetRegionCommitmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetRegionCommitmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertRegionCommitmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertRegionCommitmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListRegionCommitmentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListRegionCommitmentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update(self, request: compute.UpdateRegionCommitmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.UpdateRegionCommitmentRequest, Sequence[Tuple[str, str]]]:
...
class RegionCommitmentsRestTransport(RegionCommitmentsTransport):
    ...
    class _AggregatedList(RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListRegionCommitmentsRequest.to_json(
                compute.AggregatedListRegionCommitmentsRequest(transcoded_request['query_params']),
    ...
    class _Get(RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetRegionCommitmentRequest.to_json(
    ...
    class _Insert(RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Commitment.to_json(
                compute.Commitment(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertRegionCommitmentRequest.to_json(
                compute.InsertRegionCommitmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListRegionCommitmentsRequest.to_json(
                compute.ListRegionCommitmentsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Update(RegionCommitmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.UpdateRegionCommitmentRequest.to_json(
                compute.UpdateRegionCommitmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
