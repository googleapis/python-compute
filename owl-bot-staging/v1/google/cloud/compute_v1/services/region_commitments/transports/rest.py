...
class RegionCommitmentsRestTransport(RegionCommitmentsTransport):
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionCommitmentsRestTransport.__aggregated_list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _get_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionCommitmentsRestTransport.__get_required_fields_default_values.items() if k not in message_dict}
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionCommitmentsRestTransport.__insert_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionCommitmentsRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
