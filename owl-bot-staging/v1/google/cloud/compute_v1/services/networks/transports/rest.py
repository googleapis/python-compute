...
class NetworksRestTransport(NetworksTransport):
    ...
    def add_peering(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_peering"] = self._AddPeering(self._session, self._host)
    ...
    def list_peering_routes(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_peering_routes"] = self._ListPeeringRoutes(self._session, self._host)
    ...
    def remove_peering(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_peering"] = self._RemovePeering(self._session, self._host)
    ...
    def switch_to_custom_mode(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["switch_to_custom_mode"] = self._SwitchToCustomMode(self._session, self._host)
    ...
    def update_peering(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["update_peering"] = self._UpdatePeering(self._session, self._host)
