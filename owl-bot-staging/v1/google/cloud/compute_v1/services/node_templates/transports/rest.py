...
from .base import NodeTemplatesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class NodeTemplatesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListNodeTemplatesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListNodeTemplatesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteNodeTemplateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteNodeTemplateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetNodeTemplateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetNodeTemplateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyNodeTemplateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetIamPolicyNodeTemplateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertNodeTemplateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertNodeTemplateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListNodeTemplatesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListNodeTemplatesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyNodeTemplateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetIamPolicyNodeTemplateRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsNodeTemplateRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsNodeTemplateRequest, Sequence[Tuple[str, str]]]:
...
class NodeTemplatesRestTransport(NodeTemplatesTransport):
    ...
    """
    _STUBS: Dict[str, NodeTemplatesRestStub] = {}
    ...
    class _AggregatedList(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListNodeTemplatesRequest.to_json(
                compute.AggregatedListNodeTemplatesRequest(transcoded_request['query_params']),
    ...
    class _Delete(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteNodeTemplateRequest.to_json(
    ...
    class _Get(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetNodeTemplateRequest.to_json(
    ...
    class _GetIamPolicy(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyNodeTemplateRequest.to_json(
                compute.GetIamPolicyNodeTemplateRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NodeTemplate.to_json(
                compute.NodeTemplate(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertNodeTemplateRequest.to_json(
    ...
    class _List(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListNodeTemplatesRequest.to_json(
    ...
    class _SetIamPolicy(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyNodeTemplateRequest.to_json(
                compute.SetIamPolicyNodeTemplateRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(NodeTemplatesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsNodeTemplateRequest.to_json(
                compute.TestIamPermissionsNodeTemplateRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
