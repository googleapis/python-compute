...
from .base import ExternalVpnGatewaysTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ExternalVpnGatewaysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteExternalVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetExternalVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertExternalVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListExternalVpnGatewaysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListExternalVpnGatewaysRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_labels(self, request: compute.SetLabelsExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsExternalVpnGatewayRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsExternalVpnGatewayRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsExternalVpnGatewayRequest, Sequence[Tuple[str, str]]]:
...
class ExternalVpnGatewaysRestTransport(ExternalVpnGatewaysTransport):
    ...
    class _Delete(ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteExternalVpnGatewayRequest.to_json(
                compute.DeleteExternalVpnGatewayRequest(transcoded_request['query_params']),
    ...
    class _Get(ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetExternalVpnGatewayRequest.to_json(
                compute.GetExternalVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            body = compute.ExternalVpnGateway.to_json(
                compute.ExternalVpnGateway(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertExternalVpnGatewayRequest.to_json(
                compute.InsertExternalVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListExternalVpnGatewaysRequest.to_json(
                compute.ListExternalVpnGatewaysRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _SetLabels(ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetLabelsExternalVpnGatewayRequest.to_json(
                compute.SetLabelsExternalVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(ExternalVpnGatewaysRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.TestIamPermissionsExternalVpnGatewayRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsExternalVpnGatewayRequest.to_json(
                compute.TestIamPermissionsExternalVpnGatewayRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
