...
class AddressesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListAddressesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListAddressesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListAddressesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListAddressesRequest, Sequence[Tuple[str, str]]]:
...
class AddressesRestTransport(AddressesTransport):
    ...
    class _AggregatedList(AddressesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListAddressesRequest.to_json(
                compute.AggregatedListAddressesRequest(transcoded_request['query_params']),
    ...
    class _Delete(AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteAddressRequest.to_json(
    ...
    class _Get(AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetAddressRequest.to_json(
    ...
    class _Insert(AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertAddressRequest.to_json(
    ...
    class _List(AddressesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListAddressesRequest.to_json(
