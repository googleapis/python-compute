...
class AddressesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_list(self, response: compute.AddressList) -> compute.AddressList:
        ...
        """
        return response
    def pre_move(self, request: compute.MoveAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.MoveAddressRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_move(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_labels(self, request: compute.SetLabelsAddressRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsAddressRequest, Sequence[Tuple[str, str]]]:
