...
class SecurityPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_remove_rule(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_labels(self, request: compute.SetLabelsSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
