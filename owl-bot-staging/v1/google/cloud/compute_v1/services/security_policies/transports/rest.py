...
class SecurityPoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_add_rule(self, request: compute.AddRuleSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AddRuleSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_aggregated_list(self, request: compute.AggregatedListSecurityPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListSecurityPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_rule(self, request: compute.GetRuleSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetRuleSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListSecurityPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListSecurityPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_preconfigured_expression_sets(self, request: compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_preconfigured_expression_sets(self, response: compute.SecurityPoliciesListPreconfiguredExpressionSetsResponse) -> compute.SecurityPoliciesListPreconfiguredExpressionSetsResponse:
    ...
    def pre_patch(self, request: compute.PatchSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch_rule(self, request: compute.PatchRuleSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchRuleSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_remove_rule(self, request: compute.RemoveRuleSecurityPolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.RemoveRuleSecurityPolicyRequest, Sequence[Tuple[str, str]]]:
...
class SecurityPoliciesRestTransport(SecurityPoliciesTransport):
    ...
    class _AddRule(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.SecurityPolicyRule.to_json(
                compute.SecurityPolicyRule(transcoded_request['body']),                including_default_value_fields=False,
            ...
            query_params = json.loads(compute.AddRuleSecurityPolicyRequest.to_json(
                compute.AddRuleSecurityPolicyRequest(transcoded_request['query_params']),
    ...
    class _AggregatedList(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.AggregatedListSecurityPoliciesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.AggregatedListSecurityPoliciesRequest.to_json(
                compute.AggregatedListSecurityPoliciesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Delete(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteSecurityPolicyRequest.to_json(
    ...
    class _Get(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetSecurityPolicyRequest.to_json(
    ...
    class _GetRule(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetRuleSecurityPolicyRequest.to_json(
                compute.GetRuleSecurityPolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.SecurityPolicy.to_json(
                compute.SecurityPolicy(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertSecurityPolicyRequest.to_json(
    ...
    class _List(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListSecurityPoliciesRequest.to_json(
    ...
    class _ListPreconfiguredExpressionSets(SecurityPoliciesRestStub):
        ...
        expression sets method over HTTP.
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest.to_json(
                compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Patch(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchSecurityPolicyRequest.to_json(
    ...
    class _PatchRule(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchRuleSecurityPolicyRequest.to_json(
                compute.PatchRuleSecurityPolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _RemoveRule(SecurityPoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.RemoveRuleSecurityPolicyRequest.to_json(
                compute.RemoveRuleSecurityPolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    @property
    def list_preconfigured_expression_sets(self) -> Callable[
            [compute.ListPreconfiguredExpressionSetsSecurityPoliciesRequest],
            compute.SecurityPoliciesListPreconfiguredExpressionSetsResponse]:
        stub = self._STUBS.get("list_preconfigured_expression_sets")
        if not stub:
            stub = self._STUBS["list_preconfigured_expression_sets"] = self._ListPreconfiguredExpressionSets(self._session, self._host, self._interceptor)
