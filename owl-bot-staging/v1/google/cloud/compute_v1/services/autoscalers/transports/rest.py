...
class AutoscalersRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListAutoscalersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListAutoscalersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteAutoscalerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteAutoscalerRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetAutoscalerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetAutoscalerRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertAutoscalerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertAutoscalerRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListAutoscalersRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListAutoscalersRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchAutoscalerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchAutoscalerRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_update(self, request: compute.UpdateAutoscalerRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.UpdateAutoscalerRequest, Sequence[Tuple[str, str]]]:
...
class AutoscalersRestTransport(AutoscalersTransport):
    ...
    class _AggregatedList(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListAutoscalersRequest.to_json(
                compute.AggregatedListAutoscalersRequest(transcoded_request['query_params']),
    ...
    class _Delete(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteAutoscalerRequest.to_json(
    ...
    class _Get(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetAutoscalerRequest.to_json(
    ...
    class _Insert(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Autoscaler.to_json(
                compute.Autoscaler(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertAutoscalerRequest.to_json(
    ...
    class _List(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListAutoscalersRequest.to_json(
    ...
    class _Patch(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchAutoscalerRequest.to_json(
    ...
    class _Update(AutoscalersRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.UpdateAutoscalerRequest.to_json(
