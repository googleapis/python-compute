...
class InterconnectsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_patch(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_labels(self, request: compute.SetLabelsInterconnectRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsInterconnectRequest, Sequence[Tuple[str, str]]]:
...
class InterconnectsRestTransport(InterconnectsTransport):
    ...
    class _SetLabels(InterconnectsRestStub):
        def __hash__(self):
