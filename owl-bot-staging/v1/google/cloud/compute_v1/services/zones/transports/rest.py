...
class ZonesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get(self, request: compute.GetZoneRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetZoneRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListZonesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListZonesRequest, Sequence[Tuple[str, str]]]:
...
class ZonesRestTransport(ZonesTransport):
    ...
    class _Get(ZonesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.GetZoneRequest.to_json(
    ...
    class _List(ZonesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListZonesRequest.to_json(
                compute.ListZonesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = compute.ZoneList.from_json(
                response.content,
                ignore_unknown_fields=True
            )
