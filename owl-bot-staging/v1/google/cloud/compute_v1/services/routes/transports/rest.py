...
class RoutesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete(self, request: compute.DeleteRouteRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteRouteRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetRouteRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetRouteRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertRouteRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertRouteRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListRoutesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListRoutesRequest, Sequence[Tuple[str, str]]]:
...
class RoutesRestTransport(RoutesTransport):
    ...
    class _Delete(RoutesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.DeleteRouteRequest.to_json(
                compute.DeleteRouteRequest(transcoded_request['query_params']),
    ...
    class _Get(RoutesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetRouteRequest.to_json(
                compute.GetRouteRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(RoutesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.Route.to_json(
                compute.Route(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertRouteRequest.to_json(
                compute.InsertRouteRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(RoutesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListRoutesRequest.to_json(
                compute.ListRoutesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = compute.RouteList.from_json(
                response.content,
                ignore_unknown_fields=True
            )
