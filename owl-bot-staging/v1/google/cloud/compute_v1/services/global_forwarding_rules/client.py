...
class GlobalForwardingRulesClient(metaclass=GlobalForwardingRulesClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, GlobalForwardingRulesTransport):
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteGlobalForwardingRuleRequest, dict]] = None,
            *,
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertGlobalForwardingRuleRequest, dict]] = None,
            *,
            project: Optional[str] = None,
    ...
    def set_labels_unary(self,
            request: Optional[Union[compute.SetLabelsGlobalForwardingRuleRequest, dict]] = None,
            *,
            project: Optional[str] = None,
    ...
    def set_target_unary(self,
            request: Optional[Union[compute.SetTargetGlobalForwardingRuleRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            forwarding_rule: Optional[str] = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, forwarding_rule, target_reference_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
