...
from .base import ServiceAttachmentsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ServiceAttachmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListServiceAttachmentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListServiceAttachmentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetIamPolicyServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListServiceAttachmentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListServiceAttachmentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetIamPolicyServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsServiceAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsServiceAttachmentRequest, Sequence[Tuple[str, str]]]:
...
class ServiceAttachmentsRestTransport(ServiceAttachmentsTransport):
    """REST backend transport for ServiceAttachments.
    ...
    """
    _STUBS: Dict[str, ServiceAttachmentsRestStub] = {}
    ...
    class _AggregatedList(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.AggregatedListServiceAttachmentsRequest.to_dict(request)
            ...
            query_params = json.loads(compute.AggregatedListServiceAttachmentsRequest.to_json(
                compute.AggregatedListServiceAttachmentsRequest(transcoded_request['query_params']),
    ...
    class _Delete(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteServiceAttachmentRequest.to_json(
                compute.DeleteServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Get(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetServiceAttachmentRequest.to_json(
                compute.GetServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _GetIamPolicy(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyServiceAttachmentRequest.to_json(
                compute.GetIamPolicyServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.ServiceAttachment.to_json(
                compute.ServiceAttachment(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertServiceAttachmentRequest.to_json(
                compute.InsertServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListServiceAttachmentsRequest.to_json(
                compute.ListServiceAttachmentsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Patch(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.PatchServiceAttachmentRequest.to_json(
                compute.PatchServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _SetIamPolicy(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyServiceAttachmentRequest.to_json(
                compute.SetIamPolicyServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(ServiceAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.TestIamPermissionsServiceAttachmentRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsServiceAttachmentRequest.to_json(
                compute.TestIamPermissionsServiceAttachmentRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
