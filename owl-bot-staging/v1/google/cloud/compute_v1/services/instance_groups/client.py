...
class InstanceGroupsClient(metaclass=InstanceGroupsClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, InstanceGroupsTransport]] = None,
    ...
    def add_instances_unary(self,
        ...
        has_flattened_params = any([project, zone, instance_group, instance_groups_add_instances_request_resource])
    ...
    def list_instances(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, instance_group, instance_groups_list_instances_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def remove_instances_unary(self,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, instance_group, instance_groups_remove_instances_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
