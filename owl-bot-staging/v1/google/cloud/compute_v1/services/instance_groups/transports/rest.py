...
class InstanceGroupsRestTransport(InstanceGroupsTransport):
    ...
    def add_instances(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_instances"] = self._AddInstances(self._session, self._host, self._interceptor)
    ...
    def remove_instances(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_instances"] = self._RemoveInstances(self._session, self._host, self._interceptor)
