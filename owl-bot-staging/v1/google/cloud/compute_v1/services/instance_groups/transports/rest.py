...
class InstanceGroupsRestTransport(InstanceGroupsTransport):
    ...
    __add_instances_required_fields_default_values =  {
        "instanceGroup" : ""        "project" : ""        "zone" : ""    }

    @staticmethod
    def _add_instances_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__add_instances_required_fields_default_values.items() if k not in message_dict}
    ...
    def _add_instances(self,
        ...
        query_params = json.loads(compute.AddInstancesInstanceGroupRequest.to_json(
            compute.AddInstancesInstanceGroupRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))

        query_params.update(self._add_instances_get_unset_required_fields(query_params))
    ...
    def _aggregated_list_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__aggregated_list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _aggregated_list(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.AggregatedListInstanceGroupsRequest.to_json(
            compute.AggregatedListInstanceGroupsRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__delete_required_fields_default_values.items() if k not in message_dict}
    ...
    def _delete(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.DeleteInstanceGroupRequest.to_json(
    ...
    def _get_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__get_required_fields_default_values.items() if k not in message_dict}
    ...
    def _get(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.GetInstanceGroupRequest.to_json(
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__insert_required_fields_default_values.items() if k not in message_dict}
    ...
    def _insert(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.InsertInstanceGroupRequest.to_json(
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.ListInstanceGroupsRequest.to_json(
    ...
    def _list_instances_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__list_instances_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list_instances(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.ListInstancesInstanceGroupsRequest.to_json(
            compute.ListInstancesInstanceGroupsRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))

        query_params.update(self._list_instances_get_unset_required_fields(query_params))
    ...
    __remove_instances_required_fields_default_values =  {
        "instanceGroup" : ""        "project" : ""        "zone" : ""    }

    @staticmethod
    def _remove_instances_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__remove_instances_required_fields_default_values.items() if k not in message_dict}
    ...
    def _remove_instances(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.RemoveInstancesInstanceGroupRequest.to_json(
            compute.RemoveInstancesInstanceGroupRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))

        query_params.update(self._remove_instances_get_unset_required_fields(query_params))
    ...
    def _set_named_ports_get_unset_required_fields(message_dict):
        return {k: v for k, v in InstanceGroupsRestTransport.__set_named_ports_required_fields_default_values.items() if k not in message_dict}

    def _set_named_ports(self,
        ...
        # Jsonify the query params
        query_params = json.loads(compute.SetNamedPortsInstanceGroupRequest.to_json(
            compute.SetNamedPortsInstanceGroupRequest(transcoded_request['query_params']),
            including_default_value_fields=False,
            use_integers_for_enums=False
        ))

        query_params.update(self._set_named_ports_get_unset_required_fields(query_params))
