...
class InstanceGroupsRestTransport(InstanceGroupsTransport):
    ...
    class _AddInstances(InstanceGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InstanceGroupsAddInstancesRequest.to_json(
                compute.InstanceGroupsAddInstancesRequest(transcoded_request['body']),                including_default_value_fields=False,
    ...
    class _Insert(InstanceGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InstanceGroup.to_json(
                compute.InstanceGroup(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _ListInstances(InstanceGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InstanceGroupsListInstancesRequest.to_json(
                compute.InstanceGroupsListInstancesRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _RemoveInstances(InstanceGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InstanceGroupsRemoveInstancesRequest.to_json(
                compute.InstanceGroupsRemoveInstancesRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _SetNamedPorts(InstanceGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InstanceGroupsSetNamedPortsRequest.to_json(
                compute.InstanceGroupsSetNamedPortsRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    def add_instances(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["add_instances"] = self._AddInstances(self._session, self._host)
    ...
    def list_instances(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_instances"] = self._ListInstances(self._session, self._host)
    ...
    def remove_instances(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["remove_instances"] = self._RemoveInstances(self._session, self._host)
    ...
    def set_named_ports(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["set_named_ports"] = self._SetNamedPorts(self._session, self._host)
