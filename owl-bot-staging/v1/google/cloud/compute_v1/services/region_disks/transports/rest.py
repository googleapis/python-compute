...
class RegionDisksRestTransport(RegionDisksTransport):
    ...
    class _AddResourcePolicies(RegionDisksRestStub):
        ...
        def __call__(self,
            ...
            body = compute.RegionDisksAddResourcePoliciesRequest.to_json(
                compute.RegionDisksAddResourcePoliciesRequest(transcoded_request['body']),                including_default_value_fields=False,
    ...
    class _RemoveResourcePolicies(RegionDisksRestStub):
        ...
        def __call__(self,
            ...
            body = compute.RegionDisksRemoveResourcePoliciesRequest.to_json(
                compute.RegionDisksRemoveResourcePoliciesRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    class _Resize(RegionDisksRestStub):
        ...
        def __call__(self,
            ...
            body = compute.RegionDisksResizeRequest.to_json(
                compute.RegionDisksResizeRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
    ...
    def create_snapshot(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["create_snapshot"] = self._CreateSnapshot(self._session, self._host)
