...
class GlobalNetworkEndpointGroupsClient(metaclass=GlobalNetworkEndpointGroupsClientMeta):
    ...
    def attach_network_endpoints_unary(self,
            request: Union[compute.AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest, dict] = None,
            *,
            project: str = None,
    ...
    def detach_network_endpoints_unary(self,
            request: Union[compute.DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest, dict] = None,
            *,
            project: str = None,
            network_endpoint_group: str = None,
    ...
    def list_network_endpoints(self,
            request: Union[compute.ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest, dict] = None,
            *,
            project: str = None,
            network_endpoint_group: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
