...
class NetworkEndpointGroupsRestTransport(NetworkEndpointGroupsTransport):
    ...
    class _AggregatedList(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListNetworkEndpointGroupsRequest.to_json(
                compute.AggregatedListNetworkEndpointGroupsRequest(transcoded_request['query_params']),
    ...
    class _AttachNetworkEndpoints(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NetworkEndpointGroupsAttachEndpointsRequest.to_json(
                compute.NetworkEndpointGroupsAttachEndpointsRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.AttachNetworkEndpointsNetworkEndpointGroupRequest.to_json(
                compute.AttachNetworkEndpointsNetworkEndpointGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Delete(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteNetworkEndpointGroupRequest.to_json(
                compute.DeleteNetworkEndpointGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _DetachNetworkEndpoints(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NetworkEndpointGroupsDetachEndpointsRequest.to_json(
                compute.NetworkEndpointGroupsDetachEndpointsRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DetachNetworkEndpointsNetworkEndpointGroupRequest.to_json(
                compute.DetachNetworkEndpointsNetworkEndpointGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Get(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetNetworkEndpointGroupRequest.to_json(
                compute.GetNetworkEndpointGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertNetworkEndpointGroupRequest.to_json(
                compute.InsertNetworkEndpointGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _List(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListNetworkEndpointGroupsRequest.to_json(
                compute.ListNetworkEndpointGroupsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _ListNetworkEndpoints(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.NetworkEndpointGroupsListEndpointsRequest.to_json(
                compute.NetworkEndpointGroupsListEndpointsRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListNetworkEndpointsNetworkEndpointGroupsRequest.to_json(
                compute.ListNetworkEndpointsNetworkEndpointGroupsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(NetworkEndpointGroupsRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsNetworkEndpointGroupRequest.to_json(
                compute.TestIamPermissionsNetworkEndpointGroupRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
