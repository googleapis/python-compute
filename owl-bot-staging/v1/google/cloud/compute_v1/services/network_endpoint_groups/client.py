...
class NetworkEndpointGroupsClient(metaclass=NetworkEndpointGroupsClientMeta):
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, NetworkEndpointGroupsTransport):
    ...
    def aggregated_list(self,
            request: Union[compute.AggregatedListNetworkEndpointGroupsRequest, dict] = None,
            *,
            project: str = None,
    ...
    def attach_network_endpoints_unary(self,
            request: Union[compute.AttachNetworkEndpointsNetworkEndpointGroupRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
    ...
    def detach_network_endpoints_unary(self,
            request: Union[compute.DetachNetworkEndpointsNetworkEndpointGroupRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            network_endpoint_group: str = None,
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([project, zone, network_endpoint_group, network_endpoint_groups_detach_endpoints_request_resource])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
    ...
    def list(self,
            request: Union[compute.ListNetworkEndpointGroupsRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def list_network_endpoints(self,
            request: Union[compute.ListNetworkEndpointsNetworkEndpointGroupsRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            network_endpoint_group: str = None,
            network_endpoint_groups_list_endpoints_request_resource: compute.NetworkEndpointGroupsListEndpointsRequest = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def test_iam_permissions(self,
            request: Union[compute.TestIamPermissionsNetworkEndpointGroupRequest, dict] = None,
            *,
            project: str = None,
            zone: str = None,
            resource: str = None,
