...
from .transports.base import RegionInstanceTemplatesTransport, DEFAULT_CLIENT_INFO
...
class RegionInstanceTemplatesClient(metaclass=RegionInstanceTemplatesClientMeta):
    ...
    def delete_unary(self,
            request: Optional[Union[compute.DeleteRegionInstanceTemplateRequest, dict]] = None,
            *,
    ...
    def insert_unary(self,
            request: Optional[Union[compute.InsertRegionInstanceTemplateRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
    ...
    def list(self,
            request: Optional[Union[compute.ListRegionInstanceTemplatesRequest, dict]] = None,
            *,
            project: Optional[str] = None,
            region: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
