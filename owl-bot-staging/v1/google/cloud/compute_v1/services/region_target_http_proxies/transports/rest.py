...
class RegionTargetHttpProxiesRestTransport(RegionTargetHttpProxiesTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionTargetHttpProxiesRestTransport.__delete_required_fields_default_values.items() if k not in message_dict}
    ...
    def _get_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionTargetHttpProxiesRestTransport.__get_required_fields_default_values.items() if k not in message_dict}
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionTargetHttpProxiesRestTransport.__insert_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionTargetHttpProxiesRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _set_url_map_get_unset_required_fields(message_dict):
        return {k: v for k, v in RegionTargetHttpProxiesRestTransport.__set_url_map_required_fields_default_values.items() if k not in message_dict}
