...
class InterconnectAttachmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_patch(self, response: compute.Operation) -> compute.Operation:
        ...
        """
        return response
    def pre_set_labels(self, request: compute.SetLabelsInterconnectAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetLabelsInterconnectAttachmentRequest, Sequence[Tuple[str, str]]]:
