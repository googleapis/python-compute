...
class InterconnectAttachmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListInterconnectAttachmentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListInterconnectAttachmentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteInterconnectAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteInterconnectAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetInterconnectAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetInterconnectAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertInterconnectAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertInterconnectAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListInterconnectAttachmentsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListInterconnectAttachmentsRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_patch(self, request: compute.PatchInterconnectAttachmentRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.PatchInterconnectAttachmentRequest, Sequence[Tuple[str, str]]]:
    ...
    class _Insert(InterconnectAttachmentsRestStub):
        ...
        def __call__(self,
            ...
            body = compute.InterconnectAttachment.to_json(
                compute.InterconnectAttachment(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
