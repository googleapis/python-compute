...
from .base import ResourcePoliciesTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ResourcePoliciesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_aggregated_list(self, request: compute.AggregatedListResourcePoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.AggregatedListResourcePoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete(self, request: compute.DeleteResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.DeleteResourcePolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get(self, request: compute.GetResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetResourcePolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_iam_policy(self, request: compute.GetIamPolicyResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.GetIamPolicyResourcePolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_insert(self, request: compute.InsertResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.InsertResourcePolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list(self, request: compute.ListResourcePoliciesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.ListResourcePoliciesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_set_iam_policy(self, request: compute.SetIamPolicyResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.SetIamPolicyResourcePolicyRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_test_iam_permissions(self, request: compute.TestIamPermissionsResourcePolicyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[compute.TestIamPermissionsResourcePolicyRequest, Sequence[Tuple[str, str]]]:
...
class ResourcePoliciesRestTransport(ResourcePoliciesTransport):
    ...
    class _AggregatedList(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            query_params = json.loads(compute.AggregatedListResourcePoliciesRequest.to_json(
                compute.AggregatedListResourcePoliciesRequest(transcoded_request['query_params']),
    ...
    class _Delete(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.DeleteResourcePolicyRequest.to_json(
    ...
    class _Get(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetResourcePolicyRequest.to_json(
    ...
    class _GetIamPolicy(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.GetIamPolicyResourcePolicyRequest.to_json(
                compute.GetIamPolicyResourcePolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _Insert(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            body = compute.ResourcePolicy.to_json(
                compute.ResourcePolicy(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(compute.InsertResourcePolicyRequest.to_json(
    ...
    class _List(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.ListResourcePoliciesRequest.to_json(
    ...
    class _SetIamPolicy(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            # Jsonify the query params
            query_params = json.loads(compute.SetIamPolicyResourcePolicyRequest.to_json(
                compute.SetIamPolicyResourcePolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _TestIamPermissions(ResourcePoliciesRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = compute.TestIamPermissionsResourcePolicyRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(compute.TestIamPermissionsResourcePolicyRequest.to_json(
                compute.TestIamPermissionsResourcePolicyRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
