...
class PublicAdvertisedPrefixesRestTransport(PublicAdvertisedPrefixesTransport):
    ...
    def _delete_get_unset_required_fields(message_dict):
        return {k: v for k, v in PublicAdvertisedPrefixesRestTransport.__delete_required_fields_default_values.items() if k not in message_dict}
    ...
    def _get_get_unset_required_fields(message_dict):
        return {k: v for k, v in PublicAdvertisedPrefixesRestTransport.__get_required_fields_default_values.items() if k not in message_dict}
    ...
    def _insert_get_unset_required_fields(message_dict):
        return {k: v for k, v in PublicAdvertisedPrefixesRestTransport.__insert_required_fields_default_values.items() if k not in message_dict}
    ...
    def _list_get_unset_required_fields(message_dict):
        return {k: v for k, v in PublicAdvertisedPrefixesRestTransport.__list_required_fields_default_values.items() if k not in message_dict}
    ...
    def _patch_get_unset_required_fields(message_dict):
        return {k: v for k, v in PublicAdvertisedPrefixesRestTransport.__patch_required_fields_default_values.items() if k not in message_dict}
