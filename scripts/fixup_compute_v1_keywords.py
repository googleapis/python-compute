...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('forwarding_rule', 'project', 'region', 'request_id', ),
    ...
    'get': ('forwarding_rule', 'project', 'region', ),
    ...
    'insert': ('forwarding_rule_resource', 'project', 'region', 'request_id', ),
    ...
    'patch': ('forwarding_rule', 'forwarding_rule_resource', 'project', 'region', 'request_id', ),
    ...
    'resize': ('instance_group_manager', 'project', 'region', 'size', 'request_id', ),
    ...
    'update': ('project', 'region', 'url_map', 'url_map_resource', 'request_id', ),
