...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('address', 'project', 'request_id', ),
    ...
    'insert': ('address_resource', 'project', 'request_id', ),
    ...
    'patch': ('instance_group_manager', 'instance_group_manager_resource', 'project', 'zone', 'request_id', ),
