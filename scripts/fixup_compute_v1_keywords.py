...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('node_template', 'project', 'region', 'request_id', ),
    ...
    'get': ('node_template', 'project', 'region', ),
    ...
    'insert': ('node_template_resource', 'project', 'region', 'request_id', ),
    ...
    'patch': ('health_check', 'health_check_resource', 'project', 'request_id', ),
