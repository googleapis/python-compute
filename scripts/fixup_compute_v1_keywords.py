...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('interconnect_attachment', 'project', 'region', 'request_id', ),
    ...
    'get': ('interconnect_attachment', 'project', 'region', ),
    ...
    'get_health': ('instance_reference_resource', 'project', 'region', 'target_pool', ),
    ...
    'insert': ('interconnect_attachment_resource', 'project', 'region', 'request_id', 'validate_only', ),
    ...
    'patch': ('interconnect_attachment', 'interconnect_attachment_resource', 'project', 'region', 'request_id', ),
    ...
    'resize': ('instance_group_manager', 'project', 'size', 'zone', 'request_id', ),
    ...
    'set_iam_policy': ('global_set_policy_request_resource', 'project', 'resource', ),
    ...
    'update': ('instance', 'instance_resource', 'project', 'zone', 'minimal_action', 'most_disruptive_allowed_action', 'request_id', ),
