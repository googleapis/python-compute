...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('interconnect', 'project', 'request_id', ),
    ...
    'insert': ('interconnect_resource', 'project', 'request_id', ),
    ...
    'patch': ('interconnect', 'interconnect_resource', 'project', 'request_id', ),
    ...
    'update': ('backend_service', 'backend_service_resource', 'project', 'region', 'request_id', ),
