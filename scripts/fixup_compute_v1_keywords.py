...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('project', 'snapshot', 'request_id', ),
    ...
    'insert': ('backend_bucket_resource', 'project', 'request_id', ),
    ...
    'patch': ('backend_bucket', 'backend_bucket_resource', 'project', 'request_id', ),
    ...
    'update': ('backend_bucket', 'backend_bucket_resource', 'project', 'request_id', ),
