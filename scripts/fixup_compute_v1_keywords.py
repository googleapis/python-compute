...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'add_resource_policies': ('disk', 'project', 'region', 'region_disks_add_resource_policies_request_resource', 'request_id', ),
    ...
    'delete': ('autoscaler', 'project', 'region', 'request_id', ),
    ...
    'insert': ('autoscaler_resource', 'project', 'region', 'request_id', ),
    'invalidate_cache': ('cache_invalidation_rule_resource', 'project', 'url_map', 'request_id', ),
    'list': ('project', 'region', 'filter', 'max_results', 'order_by', 'page_token', 'return_partial_success', ),
    ...
    'patch': ('autoscaler_resource', 'project', 'region', 'autoscaler', 'request_id', ),
    ...
    'remove_resource_policies': ('disk', 'project', 'region', 'region_disks_remove_resource_policies_request_resource', 'request_id', ),
    ...
    'set_labels': ('global_set_labels_request_resource', 'project', 'resource', ),
    ...
    'set_url_map': ('project', 'region', 'target_https_proxy', 'url_map_reference_resource', 'request_id', ),
    ...
    'update': ('autoscaler_resource', 'project', 'region', 'autoscaler', 'request_id', ),
