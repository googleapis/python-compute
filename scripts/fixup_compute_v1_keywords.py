...
class computeCallTransformer(cst.CSTTransformer):
    ...
    'delete': ('license_', 'project', 'request_id', ),
    ...
    'insert': ('license_resource', 'project', 'request_id', ),
    ...
    'patch': ('project', 'region', 'subnetwork', 'subnetwork_resource', 'drain_timeout_seconds', 'request_id', ),
